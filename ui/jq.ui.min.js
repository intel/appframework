...
this.saveEventInfo(b);this.saveFirstEventInfo(b);b=this.getCSSMatrix(this.el);a.top=numOnly(b.f)-numOnly(this.container.scrollTop);a.left=numOnly(b.e)-numOnly(this.container.scrollLeft);this.container.scrollTop=this.container.scrollLeft=0;this.currentScrollingObject=this.el;this.refresh&&0==a.top?(this.refreshContainer.style.display="block",this.refreshHeight=this.refreshContainer.firstChild.clientHeight,this.refreshContainer.firstChild.style.top=-this.refreshHeight+"px",this.refreshContainer.style.overflow=
"visible",this.preventPullToRefresh=!1):0>a.top&&(this.preventPullToRefresh=!0,this.refresh&&(this.refreshContainer.style.overflow="hidden"));a.x=a.left;a.y=a.top;this.setVScrollBar(a,0,0)&&(this.container.clientWidth>window.innerWidth?this.vscrollBar.style.left=window.innerWidth-3*numOnly(this.vscrollBar.style.width)+"px":this.vscrollBar.style.right="0px",this.vscrollBar.style[c.feat.cssPrefix+"Transition"]="");this.setHScrollBar(a,0,0)&&(this.container.clientHeight>window.innerHeight?this.hscrollBar.style.top=
...
a.absSpeedY/0.0012,a.speedY=a.deltaY/a.duration,a.absSpeedY=Math.abs(a.speedY),0.12>a.absSpeedY||5>a.absDeltaY)a.deltaY=a.absDeltaY=a.duration=a.speedY=a.absSpeedY=0}else if(a.absDeltaX){if(a.deltaX=(0>a.deltaX?-1:1)*a.absSpeedX*a.absSpeedX/0.0024,a.absDeltaX=Math.abs(a.deltaX),a.duration=a.absSpeedX/0.0012,a.speedX=a.deltaX/a.duration,a.absSpeedX=Math.abs(a.speedX),0.12>a.absSpeedX||5>a.absDeltaX)a.deltaX=a.absDeltaX=a.duration=a.speedX=a.absSpeedX=0}else a.duration=0};d.prototype.onTouchEnd=function(a){if(null!=
this.currentScrollingObject&&this.moved){this.finishScrollingObject=this.currentScrollingObject;this.currentScrollingObject=null;a=this.calculateMovement(this.lastEventInfo,!0);this.androidFormsMode||this.setMomentum(a);this.calculateTarget(a);var d=this.getCSSMatrix(this.el);a.top=numOnly(d.f);a.left=numOnly(d.e);this.checkYboundary(a);this.elementInfo.hasHorScroll&&this.checkXboundary(a);d=!this.preventPullToRefresh&&(a.top>this.refreshHeight||a.y>this.refreshHeight);this.fireRefreshRelease(d,0<
a.top);if(this.refresh&&d)a.y=this.refreshHeight,a.duration=75;else if(0<=a.y)a.y=0,0<=a.top&&(a.duration=75);else if(-a.y>this.elementInfo.maxTop||0==this.elementInfo.maxTop)a.y=-this.elementInfo.maxTop,-a.top>this.elementInfo.maxTop&&(a.duration=75);this.androidFormsMode&&(a.duration=0);this.scrollerMoveCSS(a,a.duration,"cubic-bezier(0.33,0.66,0.66,1)");this.setVScrollBar(a,a.duration,"cubic-bezier(0.33,0.66,0.66,1)");this.setHScrollBar(a,a.duration,"cubic-bezier(0.33,0.66,0.66,1)");this.setFinishCalback(a.duration);
this.infinite&&!this.infiniteTriggered&&Math.abs(a.y)>=this.el.clientHeight-this.container.clientHeight&&(this.infiniteTriggered=!0,c.trigger(this,"infinite-scroll"))}};d.prototype.setFinishCalback=function(a){var d=this;this.scrollingFinishCB=setTimeout(function(){d.hideScrollbars();c.trigger(c.touchLayer,"scrollend",[d.el]);c.trigger(d,"scrollend",[d.el]);d.isScrolling=!1;d.elementInfo=null;d.infinite&&c.trigger(d,"infinite-scroll-end")},a)};d.prototype.startFormsMode=function(){if(!this.blockFormsFix){var a=
...
"Transform"]="translate"+a+b.x+"px,"+b.y+"px"+e,this.el.style[c.feat.cssPrefix+"TransitionDuration"]=d+"ms",this.el.style[c.feat.cssPrefix+"TransitionTimingFunction"]=n)),this.logPos(b.x,b.y))};d.prototype.logPos=function(a,d){var c=this.elementInfo?{h:this.elementInfo.bottomMargin,w:this.elementInfo.rightMargin}:this.getViewportSize();this.loggedPcentX=this.divide(a,this.el.clientWidth-c.w);this.loggedPcentY=this.divide(d,this.el.clientHeight-c.h);this.scrollTop=d;this.scrollLeft=a};d.prototype.scrollbarMoveCSS=
function(b,d,n,f){n||(n=0);f||(f="linear");b&&b.style&&(this.androidFormsMode?(b.style.marginTop=Math.round(d.y)+"px",b.style.marginLeft=Math.round(d.x)+"px"):(b.style[c.feat.cssPrefix+"Transform"]="translate"+a+d.x+"px,"+d.y+"px"+e,b.style[c.feat.cssPrefix+"TransitionDuration"]=n+"ms",b.style[c.feat.cssPrefix+"TransitionTimingFunction"]=f))};d.prototype.scrollTo=function(a,d){d||(d=0);this.scrollerMoveCSS(a,d)};d.prototype.scrollBy=function(a,d){var c=this.getCSSMatrix(this.el),e=numOnly(c.f),c=
numOnly(c.e);this.scrollTo({y:e-a.y,x:c-a.x},d)};d.prototype.scrollToBottom=function(a){this.scrollTo({y:-1*(this.el.clientHeight-this.container.clientHeight),x:0},a)};d.prototype.scrollToTop=function(a){this.scrollTo({x:0,y:0},a)};return function(a,e){if(!h&&c.touchLayer&&c.isObject(c.touchLayer))k();else if(!c.touchLayer||!c.isObject(c.touchLayer))c.touchLayer={};var f="string"==typeof a||a instanceof String?document.getElementById(a):a;if(f)return jq.os.desktop?new u(f,e):e.useJsScroll?new d(f,
e):new n(f,e);alert("Could not find element for scroller "+a)}}()})(jq);
...
this.isFocused_?window.innerHeight+"px":window.outerHeight/window.devicePixelRatio+"px";that=this;var e=a+1;this.reHideAddressBarTimeout_=setTimeout(this.retestAndFixUIProxy_,250*e,[e,c])}else this.isFocused_||(document.documentElement.style.height="5000px",window.scrollTo(0,0),document.documentElement.style.height=window.innerHeight+"px",this.layer.style.height=window.innerHeight+"px")},getReferenceHeight:function(){return jq.os.android?Math.ceil(window.outerHeight/window.devicePixelRatio):window.innerHeight},
getCurrentHeight:function(){return jq.os.android?window.innerHeight:numOnly(document.documentElement.style.height)},onOrientationChange:function(a){!this.holdingReshapeType_&&this.reshapeTimeout_?this.fireReshapeEvent("orientationchange"):this.previewReshapeEvent("orientationchange")},onResize:function(a){this.ignoreNextResize_?this.ignoreNextResize_=!1:this.launchFixUI()&&this.reshapeAction()},onClick:function(a){var e=a.target&&void 0!=a.target.tagName?a.target.tagName.toLowerCase():"";if(-1!==
g.indexOf(e)&&(!this.isFocused_||!a.target==this.focusedElement)){e=a.target&&void 0!=a.target.type?a.target.type.toLowerCase():"";if(-1===k.indexOf(e)){this.isFocused_&&this.focusedElement.removeEventListener("blur",this,!1);this.focusedElement=a.target;this.focusedElement.addEventListener("blur",this,!1);if(!this.isFocused_&&!this.justBlurred_)if(c.trigger(this,"enter-edit",[a.target]),c.os.ios){var h=this;setTimeout(function(){h.fireReshapeEvent("enter-edit")},300)}else this.previewReshapeEvent("enter-edit");
this.isFocused_=!0}else this.isFocused_=!1;this.justBlurred_=!1;this.allowDocumentScroll_=!0;f&&a.target.focus()}else c.os.blackberry10&&this.isFocused_&&this.focusedElement.blur()},previewReshapeEvent:function(a){that=this;this.reshapeTimeout_=setTimeout(function(){that.fireReshapeEvent(a);that.reshapeTimeout_=null;that.holdingReshapeType_=null},750);this.holdingReshapeType_=a},fireReshapeEvent:function(a){c.trigger(this,"reshape");c.trigger(this,a?a+"-reshape":"unknown-reshape")},reshapeAction:function(){this.reshapeTimeout_?
(clearTimeout(this.reshapeTimeout_),this.fireReshapeEvent(this.holdingReshapeType_),this.reshapeTimeout_=this.holdingReshapeType_=null):this.previewReshapeEvent()},onFocusIn:function(a){if(!this.isFocused_)this.onClick(a)},onBlur:function(a){jq.os.android&&a.target==window||(this.isFocused_=!1,this.focusedElement&&this.focusedElement.removeEventListener("blur",this,!1),this.focusedElement=null,this.justBlurred_=!0,c.asap(this.exitEditProxy_,this,[a.target]))},exitExit:function(a){this.justBlurred_=
...
this.lastTimestamp=a.timeStamp;this.lastTouchStartX=this.lastTouchStartY=null;(p||c.feat.nativeTouchScroll)&&this.checkDOMTree(a.target,this.layer);this.isScrolling&&(null!=this.scrollTimeout_?(clearTimeout(this.scrollTimeout_),this.scrollTimeout_=null,this.scrollTimeoutEl_!=this.scrollingEl_?this.scrollEnded(!1):this.blockPossibleClick_=!0):this.scrollTimeoutEl_&&(this.scrollEnded(!0),this.blockPossibleClick_=!0));if(jq.os.android&&a&&a.target&&a.target.getAttribute&&"ignore"==a.target.getAttribute("data-touchlayer")||
this.isFocused_&&!c.os.blackberry10)this.allowDocumentScroll_=this.requiresNativeTap=!0;else if(q&&a.target&&void 0!=a.target.tagName){var e=a.target.tagName.toLowerCase();-1!==g.indexOf(e)&&("select"!=e&&c.trigger(this,"pre-enter-edit",[a.target]),this.requiresNativeTap=!0)}else a.target&&(void 0!==a.target.tagName&&"input"==a.target.tagName.toLowerCase()&&"range"==a.target.type)&&(this.requiresNativeTap=!0);!this.isPanning_&&!this.requiresNativeTap?(this.isScrolling&&!c.feat.nativeTouchScroll||
