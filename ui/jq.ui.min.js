...
a.length;e++){if(h(e,a[e])===!1)break}else if(m.isObject(a))for(e in a)if(a.hasOwnProperty(e)&&h(e,a[e])===!1)break;return a};m.extend=function(a){a==o&&(a=this);if(arguments.length===1){for(var h in a)this[h]=a[h];return this}else s.call(arguments,1).forEach(function(e){for(var h in e)a[h]=e[h]});return a};m.isArray=function(a){return a!=o&&a instanceof Array&&a.push!=o};m.isFunction=function(a){return a!=o&&typeof a==="function"};m.isObject=function(a){return a!=o&&typeof a==="object"};m.fn=x.prototype=
{constructor:x,forEach:r.forEach,reduce:r.reduce,push:r.push,indexOf:r.indexOf,concat:r.concat,selector:function(a,h){var e;try{if(a=a.trim(),a[0]==="#"&&a.indexOf(" ")===-1&&a.indexOf(">")===-1)e=h==p?h.getElementById(a.replace("#","")):[].slice.call(h.querySelectorAll(a));else if(a[0]==="<"&&a[a.length-1]===">"){var b=p.createElement("div");b.innerHTML=a.trim();e=[].slice.call(b.childNodes)}else e=[].slice.call(h.querySelectorAll(a))}catch(g){}return e},oldElement:o,slice:r.slice,setupOld:function(a){if(a==
o)return m();a.oldElement=this;return a},map:function(a){return m.map(this,function(h,e){return a.call(h,e,h)})},each:function(a){this.forEach(function(h,e){a.call(h,e,h)});return this},ready:function(a){(p.readyState==="complete"||p.readyState==="loaded")&&a();p.addEventListener("DOMContentLoaded",a,!1);return this},find:function(a){if(this.length===0)return o;for(var h=[],e,b=0;b<this.length;b++){e=m(a,this[b]);for(var g=0;g<e.length;g++)h.push(e[g])}return m(d(h))},html:function(a){if(this.length===
0)return o;if(a===o)return this[0].innerHTML;for(var h=0;h<this.length;h++)this[h].innerHTML=a;return this},text:function(a){if(this.length===0)return o;if(a===o)return this[0].textContent;for(var h=0;h<this.length;h++)this[h].textContent=a;return this},css:function(a,h,e){e=e!=o?e:this[0];if(this.length===0)return o;if(h==o&&typeof a==="string")return k.getComputedStyle(e),e.style[a]?e.style[a]:k.getComputedStyle(e)[a];for(e=0;e<this.length;e++)if(m.isObject(a))for(var b in a)this[e].style[b]=a[b];
else this[e].style[a]=h;return this},empty:function(){for(var a=0;a<this.length;a++)this[a].innerHTML="";return this},hide:function(){if(this.length===0)return this;for(var a=0;a<this.length;a++)if(this.css("display",null,this[a])!="none")this[a].setAttribute("jqmOldStyle",this.css("display",null,this[a])),this[a].style.display="none";return this},show:function(){if(this.length===0)return this;for(var a=0;a<this.length;a++)if(this.css("display",null,this[a])=="none")this[a].style.display=this[a].getAttribute("jqmOldStyle")?
