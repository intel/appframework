...
var b=a.getPanelId(l),d=b=="#"+a.firstDiv.id;0<b.length&&a.loadDefaultHash&&!d?a.loadContent(l,!0,!1,"none"):(k="#"+a.firstDiv.id,a.firstDiv.style.display="block",a.parsePanelFunctions(a.firstDiv),a.loadContentData(a.firstDiv),c.query("#header #backButton").css("visibility","hidden"),("true"==a.firstDiv.getAttribute("data-modal")||"true"==a.firstDiv.getAttribute("modal"))&&a.showModal(a.firstDiv.id));a.launchCompleted=!0;c(document).trigger("afui:ready");c.query("#afui #splashscreen").remove()},E)c(document).one("defer:loaded",
