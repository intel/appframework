...
if(a.getAttribute("js-scrolling")&&("yes"==a.getAttribute("js-scrolling").toLowerCase()||"true"==a.getAttribute("js-scrolling").toLowerCase()))g=b=!0;h=a.getAttribute("data-title")||a.title;a.title="";a.setAttribute("data-title",h);a.getAttribute("scrolling")&&"no"==a.getAttribute("scrolling")&&(b=g=!1,a.removeAttribute("js-scrolling"));if(!b||c.os.desktop)e.appendChild(a),h=a,a.style["-webkit-overflow-scrolling"]="none";else{h=a.cloneNode(!1);a.title=null;a.id=null;var k=c(a);k.removeAttr("data-footer data-aside data-nav data-header selected data-load data-unload data-tab data-crc title data-title");
