...
",0)":")";b.os.android&&!b.os.webkit&&(b.os.android=!1)}function h(b){return b._afmid||(b._afmid=N++)}function e(c,a,u,d){a=b(a);if(a.ns)var f=RegExp("(?:^| )"+a.ns.replace(" "," .* ?")+"(?: |$)");return(x[h(c)]||[]).filter(function(b){return b&&(!a.e||b.e==a.e)&&(!a.ns||f.test(b.ns))&&(!u||b.fn==u||"function"===typeof b.fn&&"function"===typeof u&&b.fn===u)&&(!d||b.sel==d)})}function b(b){b=(""+b).split(".");return{e:b[0],ns:b.slice(1).sort().join(" ")}}function f(b,c,a){m.isObject(b)?m.each(b,a):
b.split(/\s/).forEach(function(b){a(b,c)})}function s(c,a,u,d,e){var s=h(c),g=x[s]||(x[s]=[]);f(a,u,function(a,u){var w=e&&e(u,a),f=w||u,h=function(b){var a=f.apply(c,[b].concat(b.data));!1===a&&b.preventDefault();return a},w=m.extend(b(a),{fn:u,proxy:h,sel:d,del:w,i:g.length});g.push(w);c.addEventListener(w.e,h,!1)})}function F(b,c,a,d){var s=h(b);f(c||"",a,function(c,a){e(b,c,a,d).forEach(function(c){delete x[s][c.i];b.removeEventListener(c.e,c.proxy,!1)})})}function O(b){var c=m.extend({originalEvent:b},
b);m.each(P,function(a,d){c[a]=function(){this[d]=Q;if("stopImmediatePropagation"==a||"stopPropagation"==a)if(b.cancelBubble=!0,!b[a])return;return b[a].apply(b,arguments)};c[d]=R});return c}function D(b,c,a,d,f){s(b,c,a,d,function(c){return function(a){var u,w=m(a.target).closest(d,b).get(0);if(w)return u=m.extend(O(a),{currentTarget:w,liveFired:b,data:f}),c.apply(w,[u].concat([].slice.call(arguments,1)))}})}function E(b,c){if(c&&b.dispatchEvent){var a=m.Event("destroy",{bubbles:!1});b.dispatchEvent(a)}if((a=
h(b))&&x[a]){for(var d in x[a])b.removeEventListener(x[a][d].e,x[a][d].proxy,!1);delete x[a]}}function z(b,c){if(b){var a=b.childNodes;if(a&&0<a.length)for(var d;d<a.length;d++)z(a[d],c);E(b,c)}}var p,t=c.document,A=[],I=A.slice,G={},S=1,T=/<(\w+)[^>]*>/,y={},B={},J={columncount:!0,fontweight:!0,lineheight:!0,"column-count":!0,"font-weight":!0,"line-height":!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,"z-index":!0,zoom:!0},C="object"===typeof MSApp,v=function(b,c){this.length=0;if(b){if(b instanceof
...
c){return new v(b,c)};m.is$=function(b){return b instanceof v};m.map=function(b,c){var a,d=[],f;if(m.isArray(b))for(f=0;f<b.length;f++)a=c.apply(b[f],[f,b[f]]),a!==p&&d.push(a);else if(m.isObject(b))for(f in b)b.hasOwnProperty(f)&&"length"!=f&&(a=c(b[f],[f,b[f]]),a!==p&&d.push(a));return af(d)};m.each=function(b,c){var a;if(m.isArray(b))for(a=0;a<b.length&&!1!==c(a,b[a]);a++);else if(m.isObject(b))for(a in b)if(b.hasOwnProperty(a)&&"length"!=a&&!1===c(a,b[a]))break;return b};m.extend=function(b){b==
...
this.parent().children().indexOf(this[0])},is:function(b){return!!b&&0<this.filter(b).length}};m.ajaxSettings={type:"GET",beforeSend:a,success:a,error:a,complete:a,context:void 0,timeout:0,crossDomain:null};m.jsonP=function(b){if(C)return b.type="get",b.dataType=null,m.get(b);var a="jsonp_callback"+ ++S,d="",f=t.createElement("script");c[a]=function(e){clearTimeout(d);m(f).remove();delete c[a];b.success.call(void 0,e)};f.src=b.url.replace(/=\?/,"="+a);b.error&&(f.onerror=function(){clearTimeout(d);
b.error.call(void 0,"","error")});m("head").append(f);0<b.timeout&&(d=setTimeout(function(){b.error.call(void 0,"","timeout")},b.timeout));return{}};m.ajax=function(b){var d;try{var f=b||{},e;for(e in m.ajaxSettings)"undefined"==typeof f[e]&&(f[e]=m.ajaxSettings[e]);f.url||(f.url=c.location);f.contentType||(f.contentType="application/x-www-form-urlencoded");f.headers||(f.headers={});if(!("async"in f)||!1!==f.async)f.async=!0;if(f.dataType)switch(f.dataType){case "script":f.dataType="text/javascript, application/javascript";
break;case "json":f.dataType="application/json";break;case "xml":f.dataType="application/xml, text/xml";break;case "html":f.dataType="text/html";break;case "text":f.dataType="text/plain";break;default:f.dataType="text/html";break;case "jsonp":return m.jsonP(b)}else f.dataType="text/html";m.isObject(f.data)&&(f.data=m.param(f.data));"get"===f.type.toLowerCase()&&f.data&&(-1===f.url.indexOf("?")?f.url+="?"+f.data:f.url+="&"+f.data);if(/=\?/.test(f.url))return m.jsonP(f);null===f.crossDomain&&(f.crossDomain=
/^([\w-]+:)?\/\/([^\/]+)/.test(f.url)&&RegExp.$2!=c.location.host);f.crossDomain||(f.headers=m.extend({"X-Requested-With":"XMLHttpRequest"},f.headers));var h,s=f.context,g=/^([\w-]+:)\/\//.test(f.url)?RegExp.$1:c.location.protocol;d=new c.XMLHttpRequest;d.onreadystatechange=function(){var b=f.dataType;if(4===d.readyState){clearTimeout(h);var c,a=!1;if(200<=d.status&&300>d.status||0===d.status&&"file:"==g){if("application/json"===b&&!/^\s*$/.test(d.responseText))try{c=JSON.parse(d.responseText)}catch(e){a=
e}else"application/xml, text/xml"===b?c=d.responseXML:"text/html"==b?(c=d.responseText,m.parseJS(c)):c=d.responseText;0===d.status&&0===c.length&&(a=!0);a?f.error.call(s,d,"parsererror",a):f.success.call(s,c,"success",d)}else a=!0,f.error.call(s,d,"error");f.complete.call(s,d,a?"error":"success")}};d.open(f.type,f.url,f.async);f.withCredentials&&(d.withCredentials=!0);f.contentType&&(f.headers["Content-Type"]=f.contentType);for(var q in f.headers)"string"===typeof f.headers[q]&&d.setRequestHeader(q,
f.headers[q]);if(!1===f.beforeSend.call(s,d,f))return d.abort(),!1;0<f.timeout&&(h=setTimeout(function(){d.onreadystatechange=a;d.abort();f.error.call(s,d,"timeout")},f.timeout));d.send(f.data)}catch(k){console.log(k),f.error.call(s,d,"error",k)}return d};m.get=function(b,c){return this.ajax({url:b,success:c})};m.post=function(b,c,a,d){"function"===typeof c&&(a=c,c={});d===p&&(d="html");return this.ajax({url:b,type:"POST",data:c,dataType:d,success:a})};m.getJSON=function(b,c,a){"function"===typeof c&&
(a=c,c={});return this.ajax({url:b,data:c,success:a,dataType:"json"})};m.param=function(b,c){var a=[];if(b instanceof v)b.each(function(){a.push((c?c+"["+this.id+"]":this.id)+"="+encodeURIComponent(this.value))});else for(var d in b)if(!m.isFunction(b[d])){var f=c?c+"["+d+"]":d,e=b[d];a.push(m.isObject(e)?m.param(e,f):f+"="+encodeURIComponent(e))}return a.join("&")};m.parseJSON=function(b){return JSON.parse(b)};m.parseXML=function(b){if(C)MSApp.execUnsafeLocalFunction(function(){return(new DOMParser).parseFromString(b,
...
return this};m.Event=function(b,c){var a=t.createEvent("Events"),d=!0;if(c)for(var f in c)"bubbles"==f?d=!!c[f]:a[f]=c[f];a.initEvent(b,d,!0,null,null,null,null,null,null,null,null,null,null,null,null);return a};m.bind=function(b,c,a){if(b){b.__events||(b.__events={});m.isArray(c)||(c=[c]);for(var d=0;d<c.length;d++)b.__events[c[d]]||(b.__events[c[d]]=[]),b.__events[c[d]].push(a)}};m.trigger=function(b,c,a){if(b){var d=!0;if(!b.__events)return d;m.isArray(c)||(c=[c]);m.isArray(a)||(a=[]);for(var f=
0;f<c.length;f++)if(b.__events[c[f]])for(var e=b.__events[c[f]].slice(0),h=0;h<e.length;h++)m.isFunction(e[h])&&!1===e[h].apply(b,a)&&(d=!1);return d}};m.unbind=function(b,c,a){if(b.__events){m.isArray(c)||(c=[c]);for(var d=0;d<c.length;d++)if(b.__events[c[d]])for(var f=b.__events[c[d]],e=0;e<f.length;e++)if(a==p&&delete f[e],f[e]==a){f.splice(e,1);break}}};m.proxy=function(b,c,a){return function(){return a?b.apply(c,a):b.apply(c,arguments)}};var U=function(b,c){for(var a=0;a<b.length;a++)z(b[a],
...
typeof b){var a=t.createElement("div");C?MSApp.execUnsafeLocalFunction(function(){a.innerHTML=b}):a.innerHTML=b;b=a}var d=b.getElementsByTagName("script");b=null;for(var f=0;f<d.length;f++)if(0<d[f].src.length&&!M[d[f].src]&&!C){var e=t.createElement("script");e.type=d[f].type;e.src=d[f].src;t.getElementsByTagName("head")[0].appendChild(e);M[d[f].src]=1;e=null}else c.eval(d[f].innerHTML)}};"click keydown keyup keypress submit load resize change select error".split(" ").forEach(function(b){m.fn[b]=
...
a[d];var e=this,h=function(){(e.eventsActive||!c.feath.nativeTouchScroll)&&e.adjustScroll()};this.afEl.bind("destroy",function(){e.disable(!0);var b=e.el.afScrollerId;l[b]&&delete l[b];c.unbind(c.touchLayer,"orientationchange-reshape",h)});c.bind(c.touchLayer,"orientationchange-reshape",h);c(window).bind("resize",h)},needsFormsFix:function(b){return this.useJsScroll&&this.isEnabled()&&"none"!=this.el.style.display&&0<c(b).closest(this.afEl).size()},handleEvent:function(b){if(!this.scrollingLocked)switch(b.type){case "touchstart":clearInterval(this.scrollTopInterval);
...
{};if(g="string"==typeof b||b instanceof String?document.getElementById(b):b)return af.os.desktop?new e(g,a):a.useJsScroll?new d(g,a):new h(g,a);alert("Could not find element for scroller "+b)}}()})(af);
...
typeof g){a=c('<div id="af_actionsheet"><div style="width:100%"></div></div>');q=c(a.children().get(0));g.push({text:"Cancel",cssClasses:"cancel"});for(var d=0;d<g.length;d++){var h=c('<a href="javascript:;" >'+(g[d].text||"TEXT NOT ENTERED")+"</a>");h[0].onclick=g[d].handler||function(){};g[d].cssClasses&&0<g[d].cssClasses.length&&h.addClass(g[d].cssClasses);q.append(h)}}c(k).find("#af_actionsheet").remove();c(k).find("#af_action_mask").remove();actionsheetEl=c(k).append(a);a.vendorCss("Transition",
...
(function(c){c.touchLayer=function(a){c.touchLayer=new h(a);return c.touchLayer};var n=["input","select","textarea"],l=["button","radio","checkbox","range","date"],k=c.os.ios,g=c.os.blackberry,q=c.os.blackberry||c.os.fennec||c.os.android&&!c.os.chrome,r=c.os.ios,a=!1,d=!1,h=function(a){this.clearTouchVars();a.addEventListener("touchstart",this,!1);a.addEventListener("touchmove",this,!1);a.addEventListener("touchend",this,!1);a.addEventListener("click",this,!1);a.addEventListener("focusin",this,!1);
...
30)),this.requiresNativeTap&&(this.isFocused_||c.trigger(this,"cancel-enter-edit",[a.target])));c.os.blackberry10&&(this.lastTouchStartX=this.dX,this.lastTouchStartY=this.dY);this.clearTouchVars()},clearTouchVars:function(){this.speedY=this.lastY=this.cY=this.cX=this.dX=this.dY=0;this.trackingClick=this.blockPossibleClick_=this.requiresNativeTap=this.isScrollingVertical_=this.isScrolling=this.isPanning_=this.moved=!1},fireEvent:function(a,b,d,h,g,k){var l=document.createEvent(a);l.initEvent(b,h,!0);
l.target=d;k&&c.each(k,function(a,b){l[a]=b});g&&(l.mouseToTouch=!0);d.dispatchEvent(l)}}})(af);
(function(c){var n=window.location.pathname+window.location.search,l=window.location.hash,k=l,g=function(){function a(e){"afui"===e.target.id&&(d(),c(document).unbind("DOMNodeInserted",a))}function d(){h.useOSThemes&&(c.os.android?c("#afui").addClass("android"):c.os.ie?(c("#afui").addClass("win8"),c("head").append(c.create("script",{src:"plugins/af.8tiles.js"}))):c.os.blackberry||c.os.blackberry10||c.os.playbook?(c("#afui").addClass("bb"),h.backButtonText="Back"):c.os.ios7?c("#afui").addClass("ios7"):
c.os.ios&&c("#afui").addClass("ios"));c.os.blackberry||c.os.blackberry10||c.os.playbook?(c("head").find("#bb10VisibilityHack").remove(),c("head").append("<style id='bb10VisibilityHack'>#afui .panel {-webkit-backface-visibility:visible  !important}</style>")):c.os.ios7&&(c("head").find("#ios7BlurrHack").remove(),c("head").append("<style id='ios7BlurrHack'>#afui .panel {-webkit-perspective:0  !important}</style>"))}var h=this;this.availableTransitions={};this.availableTransitions["default"]=this.availableTransitions.none=
this.noTransition;c(document).ready(function(){var a=document.getElementById("afui");if(null===a){a=document.createElement("div");a.id="afui";for(var b=document.body;b.firstChild;)a.appendChild(b.firstChild);c(document.body).prepend(a)}c.os.supportsTouch&&c.touchLayer(a);d()});1===c("#afui").length?d():c(document).bind("DOMNodeInserted",a);if("AppMobi"in window)document.addEventListener("appMobi.device.ready",function(){h.autoBoot()});else if("complete"==document.readyState||"loaded"==document.readyState)if(h.init)h.autoBoot();
else c(window).one("afui:init",function(){h.autoBoot()});else c(document).ready(function(){if(h.init)h.autoBoot();else c(window).one("afui:init",function(){h.autoBoot()})},!1);"AppMobi"in window||(window.AppMobi={},window.AppMobi.webRoot="");window.addEventListener("popstate",function(){var a=h.getPanelId(document.location.hash);"#"!=document.location.href.replace(document.location.origin+"/","")&&(""===a&&1===h.history.length&&(a="#"+h.firstDiv.id),""!==a&&0!==af(a).filter(".panel").length&&a!="#"+
h.activeDiv.id&&h.goBack())},!1)};g.prototype={init:!1,transitionTime:"230ms",showLoading:!0,loadingText:"Loading Content",loadContentQueue:[],isIntel:!1,titlebar:"",navbar:"",header:"",viewportContainer:"",remotePages:{},history:[],homeDiv:"",screenWidth:"",content:"",modalWindow:"",customFooter:!1,defaultFooter:"",defaultHeader:null,customMenu:!1,defaultMenu:"",_readyFunc:null,doingTransition:!1,passwordBox:c.passwordBox?new c.passwordBox:!1,selectBox:c.selectBox?c.selectBox:!1,ajaxUrl:"",transitionType:"slide",
scrollingDivs:{},firstDiv:"",hasLaunched:!1,launchCompleted:!1,activeDiv:"",customClickHandler:"",menuAnimation:null,togglingSideMenu:!1,sideMenuWidth:"200px",trimBackButtonText:!0,useOSThemes:!0,lockPageBounce:!1,animateHeaders:!0,useAutoPressed:!0,horizontalScroll:!1,_currentHeaderID:"defaultHeader",useInteralRouting:!0,autoBoot:function(){this.hasLaunched=!0;this.autoLaunch&&this.launch()},css3animate:function(a,d){a=c(a);return a.css3Animate(d)},setSideMenuWidth:function(a){this.sideMenuWidth=
a;a=(a+"").replace("px","")+"px";c("head").find("#styleWidth").remove();c("head").append("<style id='styleWidth'>#afui #menu {width:"+a+"  !important}</style>")},disableNativeScrolling:function(){c.feat.nativeTouchScroll=!1},manageHistory:!0,loadDefaultHash:!0,useAjaxCacheBuster:!1,actionsheet:function(a){return c.query("#afui").actionsheet(a)},popup:function(a){return c.query("#afui").popup(a)},blockUI:function(a){c.blockUI(a)},unblockUI:function(){c.unblockUI()},removeFooterMenu:function(){c.query("#navbar").hide();
c.query("#content").css("bottom","0px");this.showNavMenu=!1},showNavMenu:!0,autoLaunch:!0,showBackbutton:!0,showBackButton:!0,backButtonText:"",resetScrollers:!0,ready:function(a){if(this.launchCompleted)a();else c(document).on("afui:ready",function(c){a()})},setBackButtonStyle:function(a){c.query("#backButton").replaceClass(null,a)},goBack:function(a){if(a=Math.min(Math.abs(~~a||1),this.history.length))a=this.history.splice(-a).shift(),this.loadContent(a.target+"",0,1,a.transition),this.transitionType=
a.transition,this.updateHash(a.target)},clearHistory:function(){this.history=[];this.setBackButtonVisibility(!1)},pushHistory:function(a,d,h,e){this.history.push({target:a,transition:h});try{this.manageHistory&&(window.history.pushState(d,d,n+"#"+d+e),c(window).trigger("hashchange",null,{newUrl:n+"#"+d+e,oldURL:n+a}))}catch(b){}},updateHash:function(a){if(this.manageHistory){k=a=-1==a.indexOf("#")?"#"+a:a;var d=window.location.hash,h=this.getPanelId(a).substring(1);try{window.history.replaceState(h,
h,n+a),c(window).trigger("hashchange",null,{newUrl:n+a,oldUrl:n+d})}catch(e){}}},getPanelId:function(a){var c=a.indexOf("/");return-1==c?a:a.substring(0,c)},updateBadge:function(a,d,h,e){void 0===h&&(h="");a=c(a);var b=a.find("span.af-badge");0===b.length?("absolute"!=a.css("position")&&a.css("position","relative"),b=c.create("span",{className:"af-badge "+h,html:d}),a.append(b)):b.html(d);b.removeClass("tl bl br tr");b.addClass(h);void 0===e&&(e="red");c.isObject(e)?b.css(e):e&&b.css("background",
e);b.data("ignore-pressed","true")},removeBadge:function(a){c(a).find("span.af-badge").remove()},toggleNavMenu:function(a){if(this.showNavMenu)if("none"!=c.query("#navbar").css("display")&&(void 0!==a&&!0!==a||void 0===a))c.query("#content").css("bottom","0px"),c.query("#navbar").hide();else if(void 0===a||void 0!==a&&!0===a)c.query("#navbar").show(),c.query("#content").css("bottom",c.query("#navbar").css("height"))},toggleHeaderMenu:function(a){if("none"!=c.query("#header").css("display")&&(void 0!==
a&&!0!==a||void 0===a))c.query("#content").css("top","0px"),c.query("#header").hide();else if(void 0===a||void 0!==a&&!0===a)c.query("#header").show(),c.query("#content").css("top",c.query("#header").css("height"))},toggleSideMenu:function(a,d,h){if(this.isSideMenuEnabled()&&!this.togglingSideMenu){var e=this,b=c.query("#menu"),f=c.query("#content,  #header, #navbar");h=h||this.transitionTime;var g=this.isSideMenuOn();if(2===a||!g&&(void 0!==a&&!1!==a||void 0===a))this.togglingSideMenu=!0,b.show(),
e.css3animate(f,{x:e.sideMenuWidth,time:h,complete:function(a){e.togglingSideMenu=!1;f.vendorCss("Transition","");d&&d(a)}});else if(void 0===a||void 0!==a&&!1===a)this.togglingSideMenu=!0,e.css3animate(f,{x:"0px",time:h,complete:function(a){f.vendorCss("Transition","");f.vendorCss("Transform","");e.togglingSideMenu=!1;d&&d(a);b.hide()}})}},disableSideMenu:function(){var a=c.query("#content, #header, #navbar");this.isSideMenuOn()?this.toggleSideMenu(!1,function(c){c||a.removeClass("hasMenu")}):a.removeClass("hasMenu");
c.query("#menu").removeClass("tabletMenu")},enableSideMenu:function(){c.query("#content, #header, #navbar").addClass("hasMenu");c.query("#menu").addClass("tabletMenu")},isSideMenuEnabled:function(){return c.query("#content").hasClass("hasMenu")},isSideMenuOn:function(){var a=1<parseInt(c.getCssMatrix(c("#content")).e)?!0:!1;return this.isSideMenuEnabled()&&a},prevFooter:null,updateNavbarElements:function(a){this.prevFooter&&(this.prevFooter.data("parent")?this.prevFooter.appendTo("#"+this.prevFooter.data("parent")):
this.prevFooter.appendTo("#afui"));c.is$(a)||(a=c.query("#"+a));c.query("#navbar").append(a);this.prevFooter=a;a=c.query("#navbar a");if(0<a.length){a.data("ignore-pressed","true").data("resetHistory","true");var d=parseFloat(100/a.length);a.css("width",d+"%")}a=c.query("#navbar footer");if(0!==a.length){a=a.get(0).childNodes;for(d=0;d<a.length;d++)3===a[d].nodeType&&a[d].parentNode.removeChild(a[d])}},prevHeader:null,updateHeaderElements:function(a,d){var h=this;c.is$(a)||(a=c.query("#"+a));if(a!=
this.prevHeader)if(this._currentHeaderID=a.prop("id"),this.prevHeader)if(c.query("#header").append(a),c.ui.animateHeaders){var e=d?"100px":"-100px",b=d?"-100px":"100px";h.prevHeader.addClass("ignore");h.css3animate(a,{x:b,opacity:0.3,time:"1ms"});h.css3animate(h.prevHeader,{x:e,y:0,opacity:0.3,time:h.transitionTime,delay:numOnly(h.transitionTime)/5+"ms",complete:function(){h.prevHeader.data("parent")?h.prevHeader.appendTo("#"+h.prevHeader.data("parent")):h.prevHeader.appendTo("#afui");h.prevHeader.removeClass("ignore");
h.css3animate(h.prevHeader,{x:b,opacity:1,time:"1ms"});h.prevHeader=a}});h.css3animate(a,{x:"0px",opacity:1,time:h.transitionTime})}else h.prevHeader.data("parent")?h.prevHeader.appendTo("#"+h.prevHeader.data("parent")):h.prevHeader.appendTo("#afui"),h.prevHeader=a;else c.query("#header").append(a),this.prevHeader=a},updateSideMenu:function(a){return this.updateSideMenuElements(a)},updateSideMenuElements:function(a){if(!(void 0===a||null===a)){var d=c.query("#menu_scroller");this.prevMenu&&(this.prevMenu.insertBefore("#afui #menu"),
this.prevMenu=null);c.is$(a)||(a=c.query("#"+a));d.html("");d.append(a);this.prevMenu=a;this.scrollingDivs.menu_scroller.hideScrollbars();this.scrollingDivs.menu_scroller.scrollToTop()}},setTitle:function(a){"defaultHeader"===this._currentHeaderID&&c.query("#header header:not(.ignore)  #pageTitle").html(a)},setBackButtonText:function(a){"defaultHeader"===this._currentHeaderID&&(this.trimBackButtonText&&(a=a.substring(0,5)+"..."),0<this.backButtonText.length?c.query("#header header:not(.ignore) #backButton").html(this.backButtonText):
c.query("#header header:not(.ignore)  #backButton").html(a))},setBackButtonVisibility:function(a){a?c.query("#header #backButton").css("visibility","visible"):c.query("#header #backButton").css("visibility","hidden")},showMask:function(a){a||(a=this.loadingText||"");c.query("#afui_mask>h1").html(a);c.query("#afui_mask").show()},hideMask:function(){c.query("#afui_mask").hide()},showModal:function(a,d){this.modalTransition=d||"up";var h=c.query("#modalContainer");"string"===typeof a&&(a="#"+a.replace("#",
""));var e=c.query(a);if(e.length){var b=this.scrollingDivs.hasOwnProperty(e.attr("id"));h.html(c.feat.nativeTouchScroll||!b?c.query(a).html():c.query(a).get(0).childNodes[0].innerHTML+"",!0);h.append("<a onclick='$.ui.hideModal();' class='closebutton modalbutton'></a>");this.modalWindow.style.display="block";this.runTransition(this.modalTransition,this.modalTransContainer,this.modalWindow,!1);b?this.scrollingDivs.modal_container.enable(this.resetScrollers):this.scrollingDivs.modal_container.disable();
this.scrollToTop("modal");h.data("panel",a);h=e.get(0);b=h.getAttribute("data-load");if("string"==typeof b&&window[b])window[b](h);e.trigger("loadpanel")}},hideModal:function(){c.query("#modalContainer").html("",!0);this.runTransition(this.modalTransition,this.modalWindow,this.modalTransContainer,!0);this.scrollingDivs.modal_container.disable();var a=c.query(c.query("#modalContainer").data("panel")),d=a.data("unload");if("string"==typeof d&&window[d])window[d](a.get(0));a.trigger("unloadpanel")},
updatePanel:function(a,d){a="#"+a.replace("#","");var h=c.query(a).get(0);if(h){var e=c.create("div",{html:d}),e=e.children(".panel")&&0<e.children(".panel").length?e.children(".panel").get(0):e.get(0);h.getAttribute("js-scrolling")&&("yes"==h.getAttribute("js-scrolling").toLowerCase()||"true"==h.getAttribute("js-scrolling").toLowerCase())?(c.cleanUpContent(h.childNodes[0],!1,!0),c(h.childNodes[0]).html(d)):(c.cleanUpContent(h,!1,!0),c(h).html(d));e.getAttribute("data-title")&&h.setAttribute("data-title",
e.getAttribute("data-title"))}},updateContentDiv:function(a,c){return this.updatePanel(a,c)},addContentDiv:function(a,d,h,e,b){a="string"!==typeof a?a:-1==a.indexOf("#")?"#"+a:a;var f=c.query(a).get(0);f?d=f:(d=c.create("div",{html:d}),d=d.children(".panel")&&0<d.children(".panel").length?d.children(".panel").get(0):d.get(0),!d.getAttribute("data-title")&&h&&d.setAttribute("data-title",h),h=d.id?d.id:a.replace("#",""),d.id=h,d.id!=a&&d.setAttribute("data-crc",a.replace("#","")));d.className="panel";
h=d.id;this.addDivAndScroll(d,e,b);return h},addDivAndScroll:function(a,d,h,e){var b=!1,f,g=a.style.overflow,g="hidden"!=g&&"visible"!=g;e=e||this.content;!c.feat.nativeTouchScroll&&g&&a.setAttribute("js-scrolling","true");if(a.getAttribute("js-scrolling")&&("yes"==a.getAttribute("js-scrolling").toLowerCase()||"true"==a.getAttribute("js-scrolling").toLowerCase()))g=b=!0;f=a.title;a.title="";a.setAttribute("data-title",f);a.getAttribute("scrolling")&&"no"==a.getAttribute("scrolling")&&(b=g=!1,a.removeAttribute("js-scrolling"));
if(!b||c.os.desktop)e.appendChild(a),f=a,a.style["-webkit-overflow-scrolling"]="none";else{f=a.cloneNode(!1);a.title=null;a.id=null;var k=c(a);k.removeAttr("data-footer data-aside data-nav data-header selected data-load data-unload data-tab data-crc title data-title");k.replaceClass("panel","afScrollPanel");f.appendChild(a);e.appendChild(f);!1!==this.selectBox&&this.selectBox.getOldSelects(f.id);!1!==this.passwordBox&&this.passwordBox.getOldPasswords(f.id)}g&&(this.scrollingDivs[f.id]=c(a).scroller({scrollBars:!0,
verticalScroll:!0,horizontalScroll:this.horizontalScroll,vScrollCSS:"afScrollbar",refresh:d,useJsScroll:b,noParent:!b,lockBounce:this.lockPageBounce,autoEnable:!1}),h&&c.bind(this.scrollingDivs[f.id],"refresh-release",function(a){a&&h()}));f=a=null},scrollToTop:function(a,c){c=c||"300ms";a=a.replace("#","");this.scrollingDivs[a]&&this.scrollingDivs[a].scrollToTop(c)},scrollToBottom:function(a,c){a=a.replace("#","");this.scrollingDivs[a]&&this.scrollingDivs[a].scrollToBottom(c)},parsePanelFunctions:function(a,
d,h){var e=this,b=a.getAttribute("data-footer"),f=a.getAttribute("data-header");b&&"none"==b.toLowerCase()?(e.toggleNavMenu(!1),b=!1):e.toggleNavMenu(!0);b&&e.customFooter!=b?(e.customFooter=b,e.updateNavbarElements(b)):b!=e.customFooter&&(e.customFooter&&e.updateNavbarElements(e.defaultFooter),e.customFooter=!1);f&&"none"==f.toLowerCase()?(e.toggleHeaderMenu(!1),f=!1):e.toggleHeaderMenu(!0);f&&e.customHeader!=f?(e.customHeader=f,e.updateHeaderElements(f,h)):f!=e.customHeader&&(e.customHeader&&e.updateHeaderElements(e.defaultHeader,
h),e.customHeader=!1);b=c(a).find("footer");0<b.length&&(e.customFooter=a.id,b.data("parent",a.id),e.updateNavbarElements(b));b=c(a).find("header");0<b.length&&(e.customHeader=a.id,b.data("parent",a.id),e.updateHeaderElements(b,h));a.getAttribute("data-tab")&&(c.query("#navbar a").removeClass("pressed"),c.query("#navbar #"+a.getAttribute("data-tab")).addClass("pressed"));(h=a.getAttribute("data-nav"))&&this.customMenu!=h?(this.customMenu=h,this.updateSideMenuElements(h)):h!=this.customMenu&&(this.customMenu&&
this.updateSideMenuElements(this.defaultMenu),this.customMenu=!1);if(d){h=d.getAttribute("data-unload");if("string"==typeof h&&window[h])window[h](d);c(d).trigger("unloadpanel")}h=a.getAttribute("data-load");if("string"==typeof h&&window[h])window[h](a);c(a).trigger("loadpanel");this.isSideMenuOn()&&this.toggleSideMenu(!1)},parseScriptTags:function(a){a&&c.parseJS(a)},loadContent:function(a,d,h,e,b){if(this.doingTransition)this.loadContentQueue.push([a,d,h,e,b]);else if(0!==a.length){var f=!0;b=b||
document.createElement("a");if(-1==a.indexOf("#")){var g="url"+r(a),k=c.query("div.panel[data-crc='"+g+"']");0<c.query("#"+a).length?f=!1:0<k.length?(f=!1,"true"===b.getAttribute("data-refresh-ajax")||b.refresh&&!0===b.refresh||this.isAjaxApp?f=!0:a="#"+k.get(0).id):0<c.query("#"+g).length&&(f=!1,"true"===b.getAttribute("data-refresh-ajax")||b.refresh&&!0===b.refresh||this.isAjaxApp?f=!0:a="#"+g)}-1==a.indexOf("#")&&f?this.loadAjax(a,d,h,e,b):this.loadDiv(a,d,h,e)}},loadDiv:function(a,d,h,e){var b=
this,f=a.replace("#",""),g=f.indexOf("/"),l="";-1!=g&&(l=f.substr(g),f=f.substr(0,g));if(f=c.query("#"+f).get(0))if(f==this.activeDiv&&!h)this.isSideMenuOn()&&this.toggleSideMenu(!1);else{this.transitionType=e;var n=this.activeDiv;a=f;if("true"==f.getAttribute("data-modal")||"true"==f.getAttribute("modal"))return this.showModal(f.id);n!=a&&(d?(this.clearHistory(),this.pushHistory("#"+this.firstDiv.id,f.id,e,l)):h||this.pushHistory(k,f.id,e,l),k="#"+f.id+l,this.doingTransition=!0,n.style.display="block",
a.style.display="block",this.runTransition(e,n,a,h),this.parsePanelFunctions(f,n,h),this.loadContentData(f,d,h,e),setTimeout(function(){b.scrollingDivs[n.id]&&b.scrollingDivs[n.id].disable()},numOnly(b.transitionTime)+50))}else c(document).trigger("missingpanel",null,{missingTarget:a})},loadContentData:function(a,d,h,e){h?0<this.history.length&&(h=this.history[this.history.length-1],e=h.target.indexOf("/"),h=-1!=e?h.target.substr(0,e):h.target,(h=c.query(h).get(0))?this.setBackButtonText(h.getAttribute("data-title")):
this.setBackButtonText("Back")):this.activeDiv.getAttribute("data-title")?this.setBackButtonText(this.activeDiv.getAttribute("data-title")):this.setBackButtonText("Back");a.getAttribute("data-title")&&this.setTitle(a.getAttribute("data-title"));d&&(this.setBackButtonText(this.firstDiv.getAttribute("data-title")),a==this.firstDiv&&(this.history.length=0));c("#header #menubadge").css("float","right");0===this.history.length?(this.setBackButtonVisibility(!1),this.history=[],c("#header #menubadge").css("float",
"left")):this.showBackButton&&this.showBackbutton&&this.setBackButtonVisibility(!0);this.activeDiv=a;this.scrollingDivs[this.activeDiv.id]&&this.scrollingDivs[this.activeDiv.id].enable(this.resetScrollers)},loadAjax:function(a,d,h,e,b){if(!("afui_ajax"==this.activeDiv.id&&a==this.ajaxUrl)){var f="url"+r(a),g=this;-1==a.indexOf("http")&&(a=AppMobi.webRoot+a);var k=new XMLHttpRequest;b&&"object"!==typeof b&&(b=document.createElement("a"),b.setAttribute("data-persist-ajax",!0));b=b||document.createElement("a");
k.onreadystatechange=function(){if(4==k.readyState&&200==k.status){this.doingTransition=!1;var l,n=!1;l=c.query("#"+f);if(0<l.length)g.updatePanel(f,k.responseText),l.get(0).setAttribute("data-title",b.title?b.title:a);else if(b.getAttribute("data-persist-ajax")||g.isAjaxApp){var q="true"===b.getAttribute("data-pull-scroller")?!0:!1;l=q?function(){b.refresh=!0;g.loadContent(a,d,h,e,b);b.refresh=!1}:null;var p=c(k.responseText);p.hasClass("panel")?(f=p.attr("id"),p=p.get(0).innerHTML):p=p.html();0<
c("#"+f).length?g.updatePanel("#"+f,p):0<c("div.panel[data-crc='"+f+"']").length?(g.updatePanel(c("div.panel[data-crc='"+f+"']").get(0).id,p),f=c("div.panel[data-crc='"+f+"']").get(0).id):f=g.addContentDiv(f,k.responseText,b.title?b.title:a,q,l)}else g.updatePanel("afui_ajax",k.responseText),c.query("#afui_ajax").get(0).setAttribute("data-title",b.title?b.title:a),g.loadContent("#afui_ajax",d,h,e),n=!0;l=document.createElement("div");c(l).html(k.responseText);g.parseScriptTags(l);if(n)g.showLoading&&
g.hideMask();else return g.loadContent("#"+f,d,h,e),g.showLoading&&g.hideMask(),null}};this.ajaxUrl=a;var l=this.useAjaxCacheBuster?a+(a.split("?")[1]?"&":"?")+"cache="+1E16*Math.random():a;k.open("GET",l,!0);k.setRequestHeader("X-Requested-With","XMLHttpRequest");k.send();this.showLoading&&this.showMask()}},runTransition:function(a,c,h,e){this.availableTransitions[a]||(a="default");this.availableTransitions[a].call(this,c,h,e)},launch:function(){if(!1===this.hasLaunched||this.launchCompleted)this.hasLaunched=
!0;else{var a=this;this.isIntel=window.AppMobi&&"object"==typeof AppMobi&&void 0!==AppMobi.app?!0:!1;this.viewportContainer=af.query("#afui");this.navbar=af.query("#navbar").get(0);this.content=af.query("#content").get(0);this.header=af.query("#header").get(0);this.menu=af.query("#menu").get(0);this.viewportContainer.on("click","a",function(b){a.useInteralRouting&&q(b,b.currentTarget)});var d=null;c.bind(c.touchLayer,"enter-edit",function(a){d=a});c.bind(c.touchLayer,"enter-edit-reshape",function(){var b=
c(d),e=b.closest(a.activeDiv);if(e&&0<e.size())if(c.os.ios||c.os.chrome){var f;f=document.body.scrollTop?document.body.scrollTop-e.offset().top:0;b=e.offset().bottom-b.offset().bottom;a.scrollingDivs[a.activeDiv.id].setPaddings(f,b)}else if(c.os.android||c.os.blackberry)f=b.offset(),e=e.offset(),f.bottom>e.bottom&&f.height<e.height&&a.scrollingDivs[a.activeDiv.id].scrollToItem(b,"bottom")});c.os.ios&&c.bind(c.touchLayer,"exit-edit-reshape",function(){a.activeDiv&&(a.activeDiv.id&&a.scrollingDivs.hasOwnProperty(a.activeDiv.id))&&
a.scrollingDivs[a.activeDiv.id].setPaddings(0,0)});this.navbar||(this.navbar=c.create("div",{id:"navbar"}).get(0),this.viewportContainer.append(this.navbar));this.header||(this.header=c.create("div",{id:"header"}).get(0),this.viewportContainer.prepend(this.header));this.menu||(this.menu=c.create("div",{id:"menu",html:'<div id="menu_scroller"></div>'}).get(0),this.viewportContainer.append(this.menu),this.menu.style.overflow="hidden",this.scrollingDivs.menu_scroller=c.query("#menu_scroller").scroller({scrollBars:!0,
verticalScroll:!0,vScrollCSS:"afScrollbar",useJsScroll:!c.feat.nativeTouchScroll,noParent:c.feat.nativeTouchScroll,autoEnable:!0,lockBounce:this.lockPageBounce}),c.feat.nativeTouchScroll&&c.query("#menu_scroller").css("height","100%"),this.asideMenu=c.create("div",{id:"aside_menu",html:'<div id="aside_menu_scroller"></div>'}).get(0),this.viewportContainer.append(this.asideMenu),this.asideMenu.style.overflow="hidden",this.scrollingDivs.menu_scroller=c.query("#aside_menu_scroller").scroller({scrollBars:!0,
verticalScroll:!0,vScrollCSS:"afScrollbar",useJsScroll:!c.feat.nativeTouchScroll,noParent:c.feat.nativeTouchScroll,autoEnable:!0,lockBounce:this.lockPageBounce}),c.feat.nativeTouchScroll&&c.query("#aside_menu_scroller").css("height","100%"));this.content||(this.content=c.create("div",{id:"content"}).get(0),this.viewportContainer.append(this.content));c(this.header).html('<a id="backButton" class="button"></a> <h1 id="pageTitle"></h1>'+header.innerHTML);this.backButton=c.query("#header #backButton").css("visibility",
"hidden");c(document).on("click","#header #backButton",function(b){b.preventDefault();a.goBack()});this.titleBar=c.query("#header #pageTitle").get(0);this.addContentDiv("afui_ajax","");var h=c.create("div",{id:"afui_mask",className:"ui-loader",html:"<span class='ui-icon ui-icon-loading spin'></span><h1>Loading Content</h1>"}).css({"z-index":2E4,display:"none"});document.body.appendChild(h.get(0));h=c.create("div",{id:"afui_modal"}).get(0);h.appendChild(c.create("div",{id:"modalContainer"}).get(0));
this.modalTransContainer=c.create("div",{id:"modalTransContainer"}).appendTo(h).get(0);this.viewportContainer.append(h);this.scrollingDivs.modal_container=c.query("#modalContainer").scroller({scrollBars:!0,vertical:!0,vScrollCSS:"afScrollbar",noParent:!0,lockBounce:this.lockPageBounce});this.modalWindow=h;for(var e={},h=this.viewportContainer.get(0).querySelectorAll(".panel"),b=0;b<h.length;b++){var f=h[b],g=f,n,r=f.previousSibling;f.parentNode&&"content"!=f.parentNode.id?(f.parentNode.removeChild(f),
n=f.id,g.getAttribute("selected")&&(this.firstDiv=c.query("#"+n).get(0)),this.addDivAndScroll(g),c.query("#"+n).insertAfter(r)):f.parsedContent||(f.parsedContent=1,f.parentNode.removeChild(f),n=f.id,g.getAttribute("selected")&&(this.firstDiv=c.query("#"+n).get(0)),this.addDivAndScroll(g),c.query("#"+n).insertAfter(r));f.getAttribute("data-defer")&&(e[n]=f.getAttribute("data-defer"));this.firstDiv||(this.firstDiv=c.query("#"+n).get(0));f=null}var h=null,D=!1,E=Object.keys(e).length;if(0<E){var D=!0,
z=0,p;for(p in e)(function(b){c.ajax({url:AppMobi.webRoot+e[b],success:function(d){0<d.length&&(a.updatePanel(b,d),a.parseScriptTags(c.query("#"+b).get(0)));z++;z>=E&&(D=!1,c(document).trigger("defer:loaded"))},error:function(a){console.log("Error with deferred load "+AppMobi.webRoot+e[b]);z++;z>=E&&(D=!1,c(document).trigger("defer:loaded"))}})})(p)}if(this.firstDiv)if(this.activeDiv=this.firstDiv,this.scrollingDivs[this.activeDiv.id]&&this.scrollingDivs[this.activeDiv.id].enable(),n=function(){c.query("#navbar").append(c.create("footer",
{id:"defaultNav"}).append(c.query("#navbar").children()));a.defaultFooter="defaultNav";a.prevFooter=c.query("#defaultNav");a.updateNavbarElements(a.prevFooter);var b=c.query("nav").get(0);b&&(a.defaultMenu=c(b),a.updateSideMenuElements(a.defaultMenu),a.prevMenu=a.defaultMenu);a.defaultHeader="defaultHeader";c.query("#header").append(c.create("header",{id:"defaultHeader"}).append(c.query("#header").children()));a.prevHeader=c.query("#defaultHeader");c.query("#navbar").on("click","a",function(a){c.query("#navbar a").not(a.currentTarget).removeClass("pressed");
...
("function"==typeof c.ui.customClickHandler?c.ui.customClickHandler:!1)&&c.ui.customClickHandler(d,a))return a.preventDefault();if(!(-1!==d.href.toLowerCase().indexOf("javascript:")||d.getAttribute("data-ignore"))){if(0===d.href.indexOf("tel:"))return!1;if(-1===d.hash.indexOf("#")&&0<d.target.length)0!==d.href.toLowerCase().indexOf("javascript:")&&(c.ui.isIntel?(a.preventDefault(),AppMobi.device.launchExternal(d.href)):c.os.desktop||(a.target.target="_blank"));else{var h=d.href,e=location.protocol+
"//"+location.hostname+":"+location.port+location.pathname;0===h.indexOf(e)&&(h=h.substring(e.length));if("#"==h||h.indexOf("#")===h.length-1||0===h.length&&0===d.hash.length)return a.preventDefault();a.preventDefault();var e=d.getAttribute("data-transition"),b=d.getAttribute("data-resetHistory"),b=b&&"true"==b.toLowerCase()?!0:!1,h=0<d.hash.length?d.hash:h;c.ui.loadContent(h,b,0,e,d)}}}}},r=function(a,c){void 0===c&&(c=0);var h=0,h=0;c^=-1;for(var e=0,b=a.length;e<b;e++)h=(c^a.charCodeAt(e))&255,
...
h,8),c=c>>>8^h;return c^-1};c.ui=new g;c.ui.init=!0;c(window).trigger("afui:preinit");c(window).trigger("afui:init")})(af);
...
c.query("#afui #navbar footer").append("<a id='metroMenu' onclick='$.ui.toggleSideMenu()'>\u2022\u2022\u2022</a>")};c.ui.isSideMenuOn=function(){var g=0>parseInt(c.getCssMatrix(c("#navbar")).f)?!0:!1;return this.isSideMenuEnabled()&&g};c.ui.toggleSideMenu=function(g,k){if(this.isSideMenuEnabled()&&!this.togglingSideMenu){this.togglingSideMenu=!0;var a=this,d=c.query("#menu"),h=c.query("#navbar"),e=this.isSideMenuOn();if(2===g||!e&&(void 0!==g&&!1!==g||void 0===g))d.show(),a.css3animate(h,{y:"-150px",
time:c.ui.transitionTime,complete:function(b){a.togglingSideMenu=!1;k&&k(!0)}}),a.css3animate(d,{y:"0px",time:c.ui.transitionTime});else if(void 0===g||void 0!==g&&!1===g)a.css3animate(h,{y:"0",time:c.ui.transitionTime,complete:function(b){a.togglingSideMenu=!1;k&&k(!0);d.hide()}}),a.css3animate(d,{y:"150px",time:c.ui.transitionTime})}}})}if(!c)throw"This plugin requires jqUi";c.ui?n():c(document).ready(function(){n()})})(af);
