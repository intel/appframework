...
c){return new v(b,c)};m.is$=function(b){return b instanceof v};m.map=function(b,c){var a,d=[],h;if(m.isArray(b))for(h=0;h<b.length;h++)a=c(b[h],h),a!==p&&d.push(a);else if(m.isObject(b))for(h in b)b.hasOwnProperty(h)&&"length"!=h&&(a=c(b[h],h),a!==p&&d.push(a));return af([d])};m.each=function(b,c){var a;if(m.isArray(b))for(a=0;a<b.length&&!1!==c(a,b[a]);a++);else if(m.isObject(b))for(a in b)if(b.hasOwnProperty(a)&&"length"!=a&&!1===c(a,b[a]))break;return b};m.extend=function(b){b==p&&(b=this);if(1===
arguments.length){for(var c in b)this[c]=b[c];return this}I.call(arguments,1).forEach(function(c){for(var a in c)b[a]=c[a]});return b};m.isArray=function(b){return b instanceof Array&&b.push!=p};m.isFunction=function(b){return"function"===typeof b&&!(b instanceof RegExp)};m.isObject=function(b){return"object"===typeof b&&null!==b};m.fn=v.prototype={constructor:v,forEach:A.forEach,reduce:A.reduce,push:A.push,indexOf:A.indexOf,concat:A.concat,selector:function(b,c){b=b.trim();if("#"===b[0]&&-1==b.indexOf(".")&&
-1==b.indexOf(",")&&-1===b.indexOf(" ")&&-1===b.indexOf(">"))c==t?r(c.getElementById(b.replace("#","")),this):r(q(b,c),this);else if("<"===b[0]&&">"===b[b.length-1]||-1!==b.indexOf("<")&&-1!==b.indexOf(">")){var a=t.createElement("div");C?MSApp.execUnsafeLocalFunction(function(){a.innerHTML=b.trim()}):a.innerHTML=b.trim();r(a.childNodes,this)}else r(q(b,c),this);return this},oldElement:void 0,slice:A.slice,length:0,setupOld:function(b){if(b==p)return m();b.oldElement=this;return b},map:function(b){var c,
a=[],d;for(d=0;d<this.length;d++)c=b(d,this[d]),c!==p&&a.push(c);return m([a])},each:function(b){this.forEach(function(c,a){b.call(c,a,c)});return this},ready:function(b){"complete"===t.readyState||"loaded"===t.readyState||!m.os.ie&&"interactive"===t.readyState?b():t.addEventListener("DOMContentLoaded",b,!1);return this},find:function(b){if(0===this.length)return this;for(var c=[],a,d=0;d<this.length;d++){a=m(b,this[d]);for(var h=0;h<a.length;h++)c.push(a[h])}return m(k(c))},html:function(b,c){if(0===
this.length)return this;if(b===p)return this[0].innerHTML;for(var a=0;a<this.length;a++)if(!1!==c&&m.cleanUpContent(this[a],!1,!0),C){var d=this[a];MSApp.execUnsafeLocalFunction(function(){d.innerHTML=b})}else this[a].innerHTML=b;return this},text:function(b){if(0===this.length)return this;if(b===p)return this[0].textContent;for(var c=0;c<this.length;c++)this[c].textContent=b;return this},css:function(b,a,d){d=d!=p?d:this[0];if(0===this.length)return this;if(a==p&&"string"===typeof b)return c.getComputedStyle(d),
d.style[b]?d.style[b]:c.getComputedStyle(d)[b];for(d=0;d<this.length;d++)if(m.isObject(b))for(var h in b)this[d].style[h]="number"===typeof b[h]&&!J[h.toLowerCase()]?b[h]+"px":b[h];else this[d].style[b]="number"===typeof a&&!J[b.toLowerCase()]?a+"px":a;return this},vendorCss:function(b,c,a){return this.css(m.feat.cssPrefix+b,c,a)},cssTranslate:function(b){return this.vendorCss("Transform","translate"+m.feat.cssTransformStart+b+m.feat.cssTransformEnd)},computedStyle:function(b){if(!(0===this.length||
b==p))return c.getComputedStyle(this[0],"")[b]},empty:function(){for(var b=0;b<this.length;b++)m.cleanUpContent(this[b],!1,!0),this[b].textContent="";return this},hide:function(){if(0===this.length)return this;for(var b=0;b<this.length;b++)"none"!=this.css("display",null,this[b])&&(this[b].setAttribute("afmOldStyle",this.css("display",null,this[b])),this[b].style.display="none");return this},show:function(){if(0===this.length)return this;for(var b=0;b<this.length;b++)"none"==this.css("display",null,
this[b])&&(this[b].style.display=this[b].getAttribute("afmOldStyle")?this[b].getAttribute("afmOldStyle"):"block",this[b].removeAttribute("afmOldStyle"));return this},toggle:function(b){if(0===this.length)return this;for(var c=!0===b,a=0;a<this.length;a++)if("none"!=this.css("display",null,this[a])&&(b==p||!1===c))this[a].setAttribute("afmOldStyle",this.css("display",null,this[a])),this[a].style.display="none";else if("none"==this.css("display",null,this[a])&&(b==p||!0===c))this[a].style.display=this[a].getAttribute("afmOldStyle")?
this[a].getAttribute("afmOldStyle"):"block",this[a].removeAttribute("afmOldStyle");return this},val:function(b){if(0===this.length)return b===p?void 0:this;if(b==p)return this[0].value;for(var c=0;c<this.length;c++)this[c].value=b;return this},attr:function(b,c){if(0===this.length)return c===p?void 0:this;if(c===p&&!m.isObject(b))return this[0].afmCacheId&&y[this[0].afmCacheId][b]?this[0].afmCacheId&&y[this[0].afmCacheId][b]:this[0].getAttribute(b);for(var a=0;a<this.length;a++)if(m.isObject(b))for(var d in b)m(this[a]).attr(d,
b[d]);else m.isArray(c)||m.isObject(c)||m.isFunction(c)?(this[a].afmCacheId||(this[a].afmCacheId=m.uuid()),y[this[a].afmCacheId]||(y[this[a].afmCacheId]={}),y[this[a].afmCacheId][b]=c):null===c?(this[a].removeAttribute(b),this[a].afmCacheId&&y[this[a].afmCacheId][b]&&delete y[this[a].afmCacheId][b]):this[a].setAttribute(b,c);return this},removeAttr:function(b){for(var c=this,a=0;a<this.length;a++)b.split(/\s+/g).forEach(function(d){c[a].removeAttribute(d);c[a].afmCacheId&&y[c[a].afmCacheId][b]&&delete y[c[a].afmCacheId][b]});
return this},prop:function(b,c){if(0===this.length)return c===p?void 0:this;if(c===p&&!m.isObject(b)){var a;return this[0].afmCacheId&&B[this[0].afmCacheId][b]?this[0].afmCacheId&&B[this[0].afmCacheId][b]:!(a=this[0][b])&&b in this[0]?this[0][b]:a}for(a=0;a<this.length;a++)if(m.isObject(b))for(var d in b)m(this[a]).prop(d,b[d]);else m.isArray(c)||m.isObject(c)||m.isFunction(c)?(this[a].afmCacheId||(this[a].afmCacheId=m.uuid()),B[this[a].afmCacheId]||(B[this[a].afmCacheId]={}),B[this[a].afmCacheId][b]=
...
c||(c=this[0]);return l(b).test(c.className)},append:function(b,a){if(b&&b.length!=p&&0===b.length)return this;if(m.isArray(b)||m.isObject(b))b=m(b);var d;for(d=0;d<this.length;d++)if(b.length&&"string"!=typeof b)b=m(b),n(b,this[d],a);else{var h=T.test(b)?m(b):void 0;if(h==p||0===h.length)h=t.createTextNode(b);h.nodeName!=p&&"script"==h.nodeName.toLowerCase()&&(!h.type||"text/javascript"===h.type.toLowerCase())?c.eval(h.innerHTML):h instanceof v?n(h,this[d],a):a!=p?this[d].insertBefore(h,this[d].firstChild):
this[d].appendChild(h)}return this},appendTo:function(b,c){m(b).append(this);return this},prependTo:function(b){m(b).append(this,!0);return this},prepend:function(b){return this.append(b,1)},insertBefore:function(b,c){if(0===this.length)return this;b=m(b).get(0);if(!b)return this;for(var a=0;a<this.length;a++)c?b.parentNode.insertBefore(this[a],b.nextSibling):b.parentNode.insertBefore(this[a],b);return this},insertAfter:function(b){this.insertBefore(b,!0)},get:function(b){b=b==p?0:b;0>b&&(b+=this.length);
...
this[0].DOCUMENT_NODE?this[0].documentElement.offsetheight:(b=this.css("height").replace("px",""))?b:this.offset().height},width:function(b){return 0===this.length?this:b!=p?this.css("width",b):this[0]==this[0].window?c.innerWidth:this[0].nodeType==this[0].DOCUMENT_NODE?this[0].documentElement.offsetwidth:(b=this.css("width").replace("px",""))?b:this.offset().width},parent:function(b,c){if(0===this.length)return this;for(var a=[],d=0;d<this.length;d++)for(var h=this[d];h.parentNode&&h.parentNode!=
t&&!(a.push(h.parentNode),h.parentNode&&(h=h.parentNode),!c););return this.setupOld(m(k(a)).filter(b))},parents:function(b){return this.parent(b,!0)},children:function(b){if(0===this.length)return this;for(var c=[],a=0;a<this.length;a++)c=c.concat(g(this[a].firstChild));return this.setupOld(m(c).filter(b))},siblings:function(b){if(0===this.length)return this;for(var c=[],a=0;a<this.length;a++)this[a].parentNode&&(c=c.concat(g(this[a].parentNode.firstChild,this[a])));return this.setupOld(m(c).filter(b))},
...
c){for(var a=0;a<this.length;a++)s(this[a],b,c);return this};m.fn.unbind=function(b,c){for(var a=0;a<this.length;a++)F(this[a],b,c);return this};m.fn.one=function(b,c){return this.each(function(a,d){s(this,b,c,null,function(b,c){return function(){F(d,c,b);return b.apply(d,arguments)}})})};var Q=function(){return!0},R=function(){return!1},P={preventDefault:"isDefaultPrevented",stopImmediatePropagation:"isImmediatePropagationStopped",stopPropagation:"isPropagationStopped"};m.fn.delegate=function(b,
c,a){for(var d=0;d<this.length;d++)D(this[d],c,a,b);return this};m.fn.undelegate=function(b,c,a){for(var d=0;d<this.length;d++)F(this[d],c,a,b);return this};m.fn.on=function(b,c,a){return c===p||m.isFunction(c)?this.bind(b,c):this.delegate(c,b,a)};m.fn.off=function(b,c,a){return c===p||m.isFunction(c)?this.unbind(b,c):this.undelegate(c,b,a)};m.fn.trigger=function(b,c,a){"string"==typeof b&&(b=m.Event(b,a));b.data=c;for(c=0;c<this.length;c++)this[c].dispatchEvent(b);return this};m.Event=function(b,
c){var a=t.createEvent("Events"),d=!0;if(c)for(var h in c)"bubbles"==h?d=!!c[h]:a[h]=c[h];a.initEvent(b,d,!0,null,null,null,null,null,null,null,null,null,null,null,null);return a};m.bind=function(b,c,a){if(b){b.__events||(b.__events={});m.isArray(c)||(c=[c]);for(var d=0;d<c.length;d++)b.__events[c[d]]||(b.__events[c[d]]=[]),b.__events[c[d]].push(a)}};m.trigger=function(b,c,a){if(b){var d=!0;if(!b.__events)return d;m.isArray(c)||(c=[c]);m.isArray(a)||(a=[]);for(var h=0;h<c.length;h++)if(b.__events[c[h]])for(var e=
...
function(c){a()})},setBackButtonStyle:function(a){c.query("#backButton").replaceClass(null,a)},goBack:function(a){if(a=Math.min(Math.abs(~~a||1),this.history.length))a=this.history.splice(-a).shift(),this.loadContent(a.target+"",0,1,a.transition),this.transitionType=a.transition,this.updateHash(a.target)},clearHistory:function(){this.history=[];this.setBackButtonVisibility(!1)},pushHistory:function(a,d,f,e){this.history.push({target:a,transition:f});try{this.manageHistory&&(window.history.pushState(d,
d,n+"#"+d+e),c(window).trigger("hashchange",null,{newUrl:n+"#"+d+e,oldURL:n+a}))}catch(b){}},updateHash:function(a){if(this.manageHistory){k=a=-1==a.indexOf("#")?"#"+a:a;var d=window.location.hash,f=this.getPanelId(a).substring(1);try{window.history.replaceState(f,f,n+a),c(window).trigger("hashchange",null,{newUrl:n+a,oldUrl:n+d})}catch(e){}}},getPanelId:function(a){var c=a.indexOf("/");return-1==c?a:a.substring(0,c)},updateBadge:function(a,d,f,e){void 0===f&&(f="");a=c(a);var b=a.find("span.af-badge");
0===b.length?("absolute"!=a.css("position")&&a.css("position","relative"),b=c.create("span",{className:"af-badge "+f,html:d}),a.append(b)):b.html(d);b.removeClass("tl bl br tr");b.addClass(f);void 0===e&&(e="red");c.isObject(e)?b.css(e):e&&b.css("background",e);b.data("ignore-pressed","true")},removeBadge:function(a){c(a).find("span.af-badge").remove()},toggleNavMenu:function(a){if(this.showNavMenu)if("none"!=c.query("#navbar").css("display")&&(void 0!==a&&!0!==a||void 0===a))c.query("#content").css("bottom",
"0px"),c.query("#navbar").hide();else if(void 0===a||void 0!==a&&!0===a)c.query("#navbar").show(),c.query("#content").css("bottom",c.query("#navbar").css("height"))},toggleHeaderMenu:function(a){if("none"!=c.query("#header").css("display")&&(void 0!==a&&!0!==a||void 0===a))c.query("#content").css("top","0px"),c.query("#header").hide();else if(void 0===a||void 0!==a&&!0===a)c.query("#header").show(),c.query("#content").css("top",c.query("#header").css("height"))},toggleSideMenu:function(a,d,f){if(this.isSideMenuEnabled()&&
!this.togglingSideMenu){var e=this,b=c.query("#menu"),h=c.query("#content,  #header, #navbar");f=f||this.transitionTime;var g=this.isSideMenuOn();if(2===a||!g&&(void 0!==a&&!1!==a||void 0===a))this.togglingSideMenu=!0,b.show(),e.css3animate(h,{x:e.sideMenuWidth,time:f,complete:function(a){e.togglingSideMenu=!1;h.vendorCss("Transition","");d&&d(a)}});else if(void 0===a||void 0!==a&&!1===a)this.togglingSideMenu=!0,e.css3animate(h,{x:"0px",time:f,complete:function(a){h.vendorCss("Transition","");h.vendorCss("Transform",
"");e.togglingSideMenu=!1;d&&d(a);b.hide()}})}},disableSideMenu:function(){var a=c.query("#content, #header, #navbar");this.isSideMenuOn()?this.toggleSideMenu(!1,function(c){c||a.removeClass("hasMenu")}):a.removeClass("hasMenu");c.query("#menu").removeClass("tabletMenu")},enableSideMenu:function(){c.query("#content, #header, #navbar").addClass("hasMenu");c.query("#menu").addClass("tabletMenu")},isSideMenuEnabled:function(){return c.query("#content").hasClass("hasMenu")},isSideMenuOn:function(){var a=
...
"hidden")},showMask:function(a){a||(a=this.loadingText||"");c.query("#afui_mask>h1").html(a);c.query("#afui_mask").show()},hideMask:function(){c.query("#afui_mask").hide()},showModal:function(a,d){this.modalTransition=d||"up";var f=c.query("#modalContainer");"string"===typeof a&&(a="#"+a.replace("#",""));var e=c.query(a);if(e.length){var b=this.scrollingDivs.hasOwnProperty(e.attr("id"));f.html(c.feat.nativeTouchScroll||!b?c.query(a).html():c.query(a).get(0).childNodes[0].innerHTML+"",!0);f.append("<a onclick='$.ui.hideModal();' class='closebutton modalbutton'></a>");
this.modalWindow.style.display="block";this.runTransition(this.modalTransition,this.modalTransContainer,this.modalWindow,!1);b?this.scrollingDivs.modal_container.enable(this.resetScrollers):this.scrollingDivs.modal_container.disable();this.scrollToTop("modal");f.data("panel",a);f=e.get(0);b=f.getAttribute("data-load");if("string"==typeof b&&window[b])window[b](f);e.trigger("loadpanel")}},hideModal:function(){c.query("#modalContainer").html("",!0);this.runTransition(this.modalTransition,this.modalWindow,
this.modalTransContainer,!0);this.scrollingDivs.modal_container.disable();var a=c.query(c.query("#modalContainer").data("panel")),d=a.data("unload");if("string"==typeof d&&window[d])window[d](a.get(0));a.trigger("unloadpanel")},updatePanel:function(a,d){a="#"+a.replace("#","");var f=c.query(a).get(0);if(f){var e=c.create("div",{html:d}),e=e.children(".panel")&&0<e.children(".panel").length?e.children(".panel").get(0):e.get(0);f.getAttribute("js-scrolling")&&("yes"==f.getAttribute("js-scrolling").toLowerCase()||
"true"==f.getAttribute("js-scrolling").toLowerCase())?(c.cleanUpContent(f.childNodes[0],!1,!0),c(f.childNodes[0]).html(d)):(c.cleanUpContent(f,!1,!0),c(f).html(d));e.getAttribute("data-title")&&f.setAttribute("data-title",e.getAttribute("data-title"))}},updateContentDiv:function(a,c){return this.updatePanel(a,c)},addContentDiv:function(a,d,f,e,b){a="string"!==typeof a?a:-1==a.indexOf("#")?"#"+a:a;var h=c.query(a).get(0);h?d=h:(d=c.create("div",{html:d}),d=d.children(".panel")&&0<d.children(".panel").length?
d.children(".panel").get(0):d.get(0),!d.getAttribute("data-title")&&f&&d.setAttribute("data-title",f),f=d.id?d.id:a.replace("#",""),d.id=f,d.id!=a&&d.setAttribute("data-crc",a.replace("#","")));d.className="panel";f=d.id;this.addDivAndScroll(d,e,b);return f},addDivAndScroll:function(a,d,f,e){var b=!1,h,g=a.style.overflow,g="hidden"!=g&&"visible"!=g;e=e||this.content;!c.feat.nativeTouchScroll&&g&&a.setAttribute("js-scrolling","true");if(a.getAttribute("js-scrolling")&&("yes"==a.getAttribute("js-scrolling").toLowerCase()||
"true"==a.getAttribute("js-scrolling").toLowerCase()))g=b=!0;h=a.title;a.title="";a.setAttribute("data-title",h);a.getAttribute("scrolling")&&"no"==a.getAttribute("scrolling")&&(b=g=!1,a.removeAttribute("js-scrolling"));if(b){h=a.cloneNode(!1);a.title=null;a.id=null;var k=c(a);k.removeAttr("data-footer data-aside data-nav data-header selected data-load data-unload data-tab data-crc title data-title");k.replaceClass("panel","afScrollPanel");h.appendChild(a);e.appendChild(h);!1!==this.selectBox&&this.selectBox.getOldSelects(h.id);
!1!==this.passwordBox&&this.passwordBox.getOldPasswords(h.id)}else e.appendChild(a),h=a,a.style["-webkit-overflow-scrolling"]="none";g&&(this.scrollingDivs[h.id]=c(a).scroller({scrollBars:!0,verticalScroll:!0,horizontalScroll:this.horizontalScroll,vScrollCSS:"afScrollbar",refresh:d,useJsScroll:b,noParent:!b,lockBounce:this.lockPageBounce,autoEnable:!1}),f&&c.bind(this.scrollingDivs[h.id],"refresh-release",function(a){a&&f()}));h=a=null},scrollToTop:function(a,c){c=c||"300ms";a=a.replace("#","");this.scrollingDivs[a]&&
...
f.appendChild(c.create("div",{id:"modalContainer"}).get(0));this.modalTransContainer=c.create("div",{id:"modalTransContainer"}).appendTo(f).get(0);this.viewportContainer.append(f);this.scrollingDivs.modal_container=c.query("#modalContainer").scroller({scrollBars:!0,vertical:!0,vScrollCSS:"afScrollbar",noParent:!0,lockBounce:this.lockPageBounce});this.modalWindow=f;for(var e={},f=this.viewportContainer.get(0).querySelectorAll(".panel"),b=0;b<f.length;b++){var h=f[b],g=h,n,r=h.previousSibling;h.parentNode&&
"content"!=h.parentNode.id?(h.parentNode.removeChild(h),n=h.id,g.getAttribute("selected")&&(this.firstDiv=c.query("#"+n).get(0)),this.addDivAndScroll(g),c.query("#"+n).insertAfter(r)):h.parsedContent||(h.parsedContent=1,h.parentNode.removeChild(h),n=h.id,g.getAttribute("selected")&&(this.firstDiv=c.query("#"+n).get(0)),this.addDivAndScroll(g),c.query("#"+n).insertAfter(r));h.getAttribute("data-defer")&&(e[n]=h.getAttribute("data-defer"));this.firstDiv||(this.firstDiv=c.query("#"+n).get(0));h=null}var f=
null,D=!1,E=Object.keys(e).length;if(0<E){var D=!0,z=0,p;for(p in e)(function(b){c.ajax({url:AppMobi.webRoot+e[b],success:function(d){0!==d.length&&(a.updatePanel(b,d),a.parseScriptTags(c.query("#"+b).get(0)),z++,z>=E&&(c(document).trigger("defer:loaded"),D=!1))},error:function(a){console.log("Error with deferred load "+AppMobi.webRoot+e[b]);z++;z>=E&&(c(document).trigger("defer:loaded"),D=!1)}})})(p)}if(this.firstDiv)if(this.activeDiv=this.firstDiv,this.scrollingDivs[this.activeDiv.id]&&this.scrollingDivs[this.activeDiv.id].enable(),
...
!d?a.loadContent(l,!0,!1,"none"):(k="#"+a.firstDiv.id,a.firstDiv.style.display="block",a.parsePanelFunctions(a.firstDiv),a.loadContentData(a.firstDiv),c.query("#header #backButton").css("visibility","hidden"),("true"==a.firstDiv.getAttribute("data-modal")||"true"==a.firstDiv.getAttribute("modal"))&&a.showModal(a.firstDiv.id));a.launchCompleted=!0;c(document).trigger("afui:ready");c.query("#afui #splashscreen").remove()},D)c(document).one("defer:loaded",n);else n();c.bind(a,"content-loaded",function(){if(0<
