...
!1)})})}function P(b){var c=m.extend({originalEvent:b},b);m.each(Q,function(a,d){c[a]=function(){this[d]=R;if("stopImmediatePropagation"==a||"stopPropagation"==a)if(b.cancelBubble=!0,!b[a])return;return b[a].apply(b,arguments)};c[d]=S});return c}function E(b,c,a,d,h){s(b,c,a,d,function(c){return function(a){var v,x=m(a.target).closest(d,b).get(0);if(x)return v=m.extend(P(a),{currentTarget:x,liveFired:b,data:h}),c.apply(x,[v].concat([].slice.call(arguments,1)))}})}function F(b,c){if(c&&b.dispatchEvent){var a=
m.Event("destroy",{bubbles:!1});b.dispatchEvent(a)}if((a=f(b))&&y[a]){for(var d in y[a])b.removeEventListener(y[a][d].e,y[a][d].proxy,!1);delete y[a]}}function A(b,c){if(b){var a=b.childNodes;if(a&&0<a.length)for(var d;d<a.length;d++)A(a[d],c);F(b,c)}}var p,t=c.document,B=[],J=B.slice,H={},T=1,U=/<(\w+)[^>]*>/,z={},C={},K={columncount:!0,fontweight:!0,lineheight:!0,"column-count":!0,"font-weight":!0,"line-height":!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,"z-index":!0,zoom:!0},D="object"===typeof MSApp,
w=function(b,c){this.length=0;if(b){if(b instanceof w&&c==p)return b;if(af.isFunction(b))return af(t).ready(b);if(af.isArray(b)&&b.length!=p){for(var a=0;a<b.length;a++)this[this.length++]=b[a];return this}if(af.isObject(b)&&af.isObject(c)){if(b.length==p)b.parentNode==c&&(this[this.length++]=b);else for(a=0;a<b.length;a++)b[a].parentNode==c&&(this[this.length++]=b[a]);return this}if(af.isObject(b)&&c==p)return this[this.length++]=b,this;if(c!==p){if(c instanceof w)return c.find(b)}else c=t}else return this;
return this.selector(b,c)},m=function(b,c){return new w(b,c)};m.is$=function(b){return b instanceof w};m.map=function(b,c){var a,d=[],h;if(m.isArray(b))for(h=0;h<b.length;h++)a=c.apply(b[h],[h,b[h]]),a!==p&&d.push(a);else if(m.isObject(b))for(h in b)b.hasOwnProperty(h)&&"length"!=h&&(a=c(b[h],[h,b[h]]),a!==p&&d.push(a));return af(d)};m.each=function(b,c){var a;if(m.isArray(b))for(a=0;a<b.length&&!1!==c(a,b[a]);a++);else if(m.isObject(b))for(a in b)if(b.hasOwnProperty(a)&&"length"!=a&&!1===c(a,b[a]))break;
return b};m.extend=function(b){b==p&&(b=this);if(1===arguments.length){for(var c in b)this[c]=b[c];return this}J.call(arguments,1).forEach(function(c){for(var a in c)b[a]=c[a]});return b};m.isArray=function(b){return b instanceof Array&&b.push!=p};m.isFunction=function(b){return"function"===typeof b&&!(b instanceof RegExp)};m.isObject=function(b){return"object"===typeof b&&null!==b};m.fn=w.prototype={namepsace:"appframework",constructor:w,forEach:B.forEach,reduce:B.reduce,push:B.push,indexOf:B.indexOf,
concat:B.concat,selector:function(b,c){b=b.trim();if("#"===b[0]&&-1==b.indexOf(".")&&-1==b.indexOf(",")&&-1===b.indexOf(" ")&&-1===b.indexOf(">"))c==t?r(c.getElementById(b.replace("#","")),this):r(q(b,c),this);else if("<"===b[0]&&">"===b[b.length-1]||-1!==b.indexOf("<")&&-1!==b.indexOf(">")){var a=t.createElement("div");D?MSApp.execUnsafeLocalFunction(function(){a.innerHTML=b.trim()}):a.innerHTML=b.trim();r(a.childNodes,this)}else r(q(b,c),this);return this},oldElement:void 0,slice:B.slice,length:0,
setupOld:function(b){if(b==p)return m();b.oldElement=this;return b},map:function(b){var c,a=[],d;for(d=0;d<this.length;d++)c=b.apply(this[d],[d,this[d]]),c!==p&&a.push(c);return m(a)},each:function(b){this.forEach(function(c,a){b.call(c,a,c)});return this},ready:function(b){"complete"===t.readyState||"loaded"===t.readyState||!m.os.ie&&"interactive"===t.readyState?b():t.addEventListener("DOMContentLoaded",b,!1);return this},find:function(b){if(0===this.length)return this;for(var c=[],a,d=0;d<this.length;d++){a=
m(b,this[d]);for(var h=0;h<a.length;h++)c.push(a[h])}return m(k(c))},html:function(b,c){if(0===this.length)return this;if(b===p)return this[0].innerHTML;for(var a=0;a<this.length;a++)if(!1!==c&&m.cleanUpContent(this[a],!1,!0),D){var d=this[a];MSApp.execUnsafeLocalFunction(function(){d.innerHTML=b})}else this[a].innerHTML=b;return this},text:function(b){if(0===this.length)return this;if(b===p)return this[0].textContent;for(var c=0;c<this.length;c++)this[c].textContent=b;return this},css:function(b,
a,d){d=d!=p?d:this[0];if(0===this.length)return this;if(a==p&&"string"===typeof b)return c.getComputedStyle(d),d.style[b]?d.style[b]:c.getComputedStyle(d)[b];for(d=0;d<this.length;d++)if(m.isObject(b))for(var h in b)this[d].style[h]="number"===typeof b[h]&&!K[h.toLowerCase()]?b[h]+"px":b[h];else this[d].style[b]="number"===typeof a&&!K[b.toLowerCase()]?a+"px":a;return this},vendorCss:function(b,c,a){return this.css(m.feat.cssPrefix+b,c,a)},cssTranslate:function(b){return this.vendorCss("Transform",
...
if(a.getAttribute("js-scrolling")&&("yes"==a.getAttribute("js-scrolling").toLowerCase()||"true"==a.getAttribute("js-scrolling").toLowerCase()))g=b=!0;h=a.title;a.title="";a.setAttribute("data-title",h);a.getAttribute("scrolling")&&"no"==a.getAttribute("scrolling")&&(b=g=!1,a.removeAttribute("js-scrolling"));if(!b||c.os.desktop)e.appendChild(a),h=a,a.style["-webkit-overflow-scrolling"]="none";else{h=a.cloneNode(!1);a.title=null;a.id=null;var k=c(a);k.removeAttr("data-footer data-aside data-nav data-header selected data-load data-unload data-tab data-crc title data-title");
...
var b=a.getPanelId(l),d=b=="#"+a.firstDiv.id;0<b.length&&a.loadDefaultHash&&!d?a.loadContent(l,!0,!1,"none"):(k="#"+a.firstDiv.id,a.firstDiv.style.display="block",a.parsePanelFunctions(a.firstDiv),a.loadContentData(a.firstDiv),c.query("#header #backButton").css("visibility","hidden"),("true"==a.firstDiv.getAttribute("data-modal")||"true"==a.firstDiv.getAttribute("modal"))&&a.showModal(a.firstDiv.id));a.launchCompleted=!0;c.query("#afui #splashscreen").remove();c(document).trigger("afui:ready")},E)c(document).one("defer:loaded",
