...
(function(c){c(document).one("intel.xdk.device.ready",function(){console.log("called");c.ui.isIntel=!0;setTimeout(function(){document.getElementById("afui").style.height="100%";document.body.style.height="100%";document.documentElement.style.minHeight=window.innerHeight},300);c.ui.ready(function(){c.ui.blockPageScroll()})});c.feat.nativeTouchScroll&&document.addEventListener("orientationchange",function(n){if(c.ui.scrollingDivs[c.ui.activeDiv.id]){var l=c.ui.scrollingDivs[c.ui.activeDiv.id];0===l.el.scrollTop&&
(l.disable(),setTimeout(function(){l.enable()},300))}})})(af);
