...
toggleSideMenu:function(a,d,f){if(this.isSideMenuEnabled()&&!this.togglingSideMenu){var e=this,b=c.query("#menu"),h=c.query("#content,  #header, #navbar");f=f||this.transitionTime;var g=this.isSideMenuOn();if(2===a||!g&&(void 0!==a&&!1!==a||void 0===a))this.togglingSideMenu=!0,b.show(),e.css3animate(h,{x:e.sideMenuWidth,time:f,complete:function(a){e.togglingSideMenu=!1;h.vendorCss("Transition","");d&&d(a)}});else if(void 0===a||void 0!==a&&!1===a)this.togglingSideMenu=!0,e.css3animate(h,{x:"0px",
time:f,complete:function(a){h.vendorCss("Transition","");h.vendorCss("Transform","");e.togglingSideMenu=!1;d&&d(a);b.hide()}})}},disableSideMenu:function(){var a=c.query("#content, #header, #navbar");this.isSideMenuOn()?this.toggleSideMenu(!1,function(c){c||a.removeClass("hasMenu")}):a.removeClass("hasMenu");c.query("#menu").removeClass("tabletMenu")},enableSideMenu:function(){c.query("#content, #header, #navbar").addClass("hasMenu");c.query("#menu").addClass("tabletMenu")},isSideMenuEnabled:function(){return c.query("#content").hasClass("hasMenu")},
...
if(a.getAttribute("js-scrolling")&&("yes"==a.getAttribute("js-scrolling").toLowerCase()||"true"==a.getAttribute("js-scrolling").toLowerCase()))g=b=!0;h=a.title;a.title="";a.setAttribute("data-title",h);a.getAttribute("scrolling")&&"no"==a.getAttribute("scrolling")&&(b=g=!1,a.removeAttribute("js-scrolling"));if(b){h=a.cloneNode(!1);a.title=null;a.id=null;var k=c(a);k.removeAttr("data-footer data-aside data-nav data-header selected data-load data-unload data-tab data-crc title data-title");k.replaceClass("panel",
"afScrollPanel");h.appendChild(a);e.appendChild(h);!1!==this.selectBox&&this.selectBox.getOldSelects(h.id);!1!==this.passwordBox&&this.passwordBox.getOldPasswords(h.id)}else e.appendChild(a),h=a,a.style["-webkit-overflow-scrolling"]="none";g&&(this.scrollingDivs[h.id]=c(a).scroller({scrollBars:!0,verticalScroll:!0,horizontalScroll:this.horizontalScroll,vScrollCSS:"afScrollbar",refresh:d,useJsScroll:b,noParent:!b,lockBounce:this.lockPageBounce,autoEnable:!1}),f&&c.bind(this.scrollingDivs[h.id],"refresh-release",
...
a.id),e.updateHeaderElements(b,f));a.getAttribute("data-tab")&&(c.query("#navbar a").removeClass("pressed"),c.query("#navbar #"+a.getAttribute("data-tab")).addClass("pressed"));(f=a.getAttribute("data-nav"))&&this.customMenu!=f?(this.customMenu=f,this.updateSideMenuElements(f)):f!=this.customMenu&&(this.customMenu&&this.updateSideMenuElements(this.defaultMenu),this.customMenu=!1);if(d){f=d.getAttribute("data-unload");if("string"==typeof f&&window[f])window[f](d);c(d).trigger("unloadpanel")}f=a.getAttribute("data-load");
if("string"==typeof f&&window[f])window[f](a);c(a).trigger("loadpanel");this.isSideMenuOn()&&this.toggleSideMenu(!1)},parseScriptTags:function(a){a&&c.parseJS(a)},loadContent:function(a,d,f,e,b){if(this.doingTransition)this.loadContentQueue.push([a,d,f,e,b]);else if(0!==a.length){var h=!0;b=b||document.createElement("a");if(-1==a.indexOf("#")){var g="url"+r(a),k=c.query("div.panel[data-crc='"+g+"']");0<c.query("#"+a).length?h=!1:0<k.length?(h=!1,"true"===b.getAttribute("data-refresh-ajax")||b.refresh&&
!0===b.refresh||this.isAjaxApp?h=!0:a="#"+k.get(0).id):0<c.query("#"+g).length&&(h=!1,"true"===b.getAttribute("data-refresh-ajax")||b.refresh&&!0===b.refresh||this.isAjaxApp?h=!0:a="#"+g)}-1==a.indexOf("#")&&h?this.loadAjax(a,d,f,e,b):this.loadDiv(a,d,f,e)}},loadDiv:function(a,d,f,e){var b=this,h=a.replace("#",""),g=h.indexOf("/"),l="";-1!=g&&(l=h.substr(g),h=h.substr(0,g));if(h=c.query("#"+h).get(0))if(h==this.activeDiv&&!f)this.isSideMenuOn()&&this.toggleSideMenu(!1);else{this.transitionType=e;
var n=this.activeDiv;a=h;if("true"==h.getAttribute("data-modal")||"true"==h.getAttribute("modal"))return this.showModal(h.id);n!=a&&(d?(this.clearHistory(),this.pushHistory("#"+this.firstDiv.id,h.id,e,l)):f||this.pushHistory(k,h.id,e,l),k="#"+h.id+l,this.doingTransition=!0,n.style.display="block",a.style.display="block",this.runTransition(e,n,a,f),this.parsePanelFunctions(h,n,f),this.loadContentData(h,d,f,e),setTimeout(function(){b.scrollingDivs[n.id]&&b.scrollingDivs[n.id].disable()},numOnly(b.transitionTime)+
50))}else c(document).trigger("missingpanel",null,{missingTarget:a})},loadContentData:function(a,d,f,e){f?0<this.history.length&&(f=this.history[this.history.length-1],e=f.target.indexOf("/"),f=-1!=e?f.target.substr(0,e):f.target,(f=c.query(f).get(0))?this.setBackButtonText(f.getAttribute("data-title")):this.setBackButtonText("Back")):this.activeDiv.getAttribute("data-title")?this.setBackButtonText(this.activeDiv.getAttribute("data-title")):this.setBackButtonText("Back");a.getAttribute("data-title")&&
this.setTitle(a.getAttribute("data-title"));d&&(this.setBackButtonText(this.firstDiv.getAttribute("data-title")),a==this.firstDiv&&(this.history.length=0));c("#header #menubadge").css("float","right");0===this.history.length?(this.setBackButtonVisibility(!1),this.history=[],c("#header #menubadge").css("float","left")):this.showBackButton&&this.showBackbutton&&this.setBackButtonVisibility(!0);this.activeDiv=a;this.scrollingDivs[this.activeDiv.id]&&this.scrollingDivs[this.activeDiv.id].enable(this.resetScrollers)},
loadAjax:function(a,d,f,e,b){if(!("afui_ajax"==this.activeDiv.id&&a==this.ajaxUrl)){var h="url"+r(a),g=this;-1==a.indexOf("http")&&(a=AppMobi.webRoot+a);var k=new XMLHttpRequest;b&&"object"!==typeof b&&(b=document.createElement("a"),b.setAttribute("data-persist-ajax",!0));b=b||document.createElement("a");k.onreadystatechange=function(){if(4==k.readyState&&200==k.status){this.doingTransition=!1;var l,n=!1;l=c.query("#"+h);if(0<l.length)g.updatePanel(h,k.responseText),l.get(0).setAttribute("data-title",
b.title?b.title:a);else if(b.getAttribute("data-persist-ajax")||g.isAjaxApp){var q="true"===b.getAttribute("data-pull-scroller")?!0:!1;l=q?function(){b.refresh=!0;g.loadContent(a,d,f,e,b);b.refresh=!1}:null;var p=c(k.responseText);p.hasClass("panel")?(h=p.attr("id"),p=p.get(0).innerHTML):p=p.html();0<c("#"+h).length?g.updatePanel("#"+h,p):0<c("div.panel[data-crc='"+h+"']").length?(g.updatePanel(c("div.panel[data-crc='"+h+"']").get(0).id,p),h=c("div.panel[data-crc='"+h+"']").get(0).id):h=g.addContentDiv(h,
k.responseText,b.title?b.title:a,q,l)}else g.updatePanel("afui_ajax",k.responseText),c.query("#afui_ajax").get(0).setAttribute("data-title",b.title?b.title:a),g.loadContent("#afui_ajax",d,f),n=!0;l=document.createElement("div");c(l).html(k.responseText);g.parseScriptTags(l);if(n)g.showLoading&&g.hideMask();else return g.loadContent("#"+h),g.showLoading&&g.hideMask(),null}};this.ajaxUrl=a;var l=this.useAjaxCacheBuster?a+(a.split("?")[1]?"&":"?")+"cache="+1E16*Math.random():a;k.open("GET",l,!0);k.setRequestHeader("X-Requested-With",
"XMLHttpRequest");k.send();this.showLoading&&this.showMask()}},runTransition:function(a,c,f,e){this.availableTransitions[a]||(a="default");this.availableTransitions[a].call(this,c,f,e)},launch:function(){if(!1===this.hasLaunched||this.launchCompleted)this.hasLaunched=!0;else{var a=this;this.isIntel=window.AppMobi&&"object"==typeof AppMobi&&void 0!==AppMobi.app?!0:!1;this.viewportContainer=af.query("#afui");this.navbar=af.query("#navbar").get(0);this.content=af.query("#content").get(0);this.header=
af.query("#header").get(0);this.menu=af.query("#menu").get(0);this.viewportContainer.on("click","a",function(a){q(a,a.currentTarget)});var d=null;c.bind(c.touchLayer,"enter-edit",function(a){d=a});c.bind(c.touchLayer,"enter-edit-reshape",function(){var b=c(d),e=b.closest(a.activeDiv);if(e&&0<e.size())if(c.os.ios||c.os.chrome){var f;f=document.body.scrollTop?document.body.scrollTop-e.offset().top:0;b=e.offset().bottom-b.offset().bottom;a.scrollingDivs[a.activeDiv.id].setPaddings(f,b)}else if(c.os.android||
c.os.blackberry)f=b.offset(),e=e.offset(),f.bottom>e.bottom&&f.height<e.height&&a.scrollingDivs[a.activeDiv.id].scrollToItem(b,"bottom")});c.os.ios&&c.bind(c.touchLayer,"exit-edit-reshape",function(){a.activeDiv&&(a.activeDiv.id&&a.scrollingDivs.hasOwnProperty(a.activeDiv.id))&&a.scrollingDivs[a.activeDiv.id].setPaddings(0,0)});this.navbar||(this.navbar=c.create("div",{id:"navbar"}).get(0),this.viewportContainer.append(this.navbar));this.header||(this.header=c.create("div",{id:"header"}).get(0),this.viewportContainer.prepend(this.header));
this.menu||(this.menu=c.create("div",{id:"menu",html:'<div id="menu_scroller"></div>'}).get(0),this.viewportContainer.append(this.menu),this.menu.style.overflow="hidden",this.scrollingDivs.menu_scroller=c.query("#menu_scroller").scroller({scrollBars:!0,verticalScroll:!0,vScrollCSS:"afScrollbar",useJsScroll:!c.feat.nativeTouchScroll,noParent:c.feat.nativeTouchScroll,autoEnable:!0,lockBounce:this.lockPageBounce}),c.feat.nativeTouchScroll&&c.query("#menu_scroller").css("height","100%"),this.asideMenu=
c.create("div",{id:"aside_menu",html:'<div id="aside_menu_scroller"></div>'}).get(0),this.viewportContainer.append(this.asideMenu),this.asideMenu.style.overflow="hidden",this.scrollingDivs.menu_scroller=c.query("#aside_menu_scroller").scroller({scrollBars:!0,verticalScroll:!0,vScrollCSS:"afScrollbar",useJsScroll:!c.feat.nativeTouchScroll,noParent:c.feat.nativeTouchScroll,autoEnable:!0,lockBounce:this.lockPageBounce}),c.feat.nativeTouchScroll&&c.query("#aside_menu_scroller").css("height","100%"));
this.content||(this.content=c.create("div",{id:"content"}).get(0),this.viewportContainer.append(this.content));c(this.header).html('<a id="backButton" class="button"></a> <h1 id="pageTitle"></h1>'+header.innerHTML);this.backButton=c.query("#header #backButton").css("visibility","hidden");c(document).on("click","#header #backButton",function(b){b.preventDefault();a.goBack()});this.titleBar=c.query("#header #pageTitle").get(0);this.addContentDiv("afui_ajax","");var f=c.create("div",{id:"afui_mask",
className:"ui-loader",html:"<span class='ui-icon ui-icon-loading spin'></span><h1>Loading Content</h1>"}).css({"z-index":2E4,display:"none"});document.body.appendChild(f.get(0));f=c.create("div",{id:"afui_modal"}).get(0);f.appendChild(c.create("div",{id:"modalContainer"}).get(0));this.modalTransContainer=c.create("div",{id:"modalTransContainer"}).appendTo(f).get(0);this.viewportContainer.append(f);this.scrollingDivs.modal_container=c.query("#modalContainer").scroller({scrollBars:!0,vertical:!0,vScrollCSS:"afScrollbar",
noParent:!0,lockBounce:this.lockPageBounce});this.modalWindow=f;for(var e={},f=this.viewportContainer.get(0).querySelectorAll(".panel"),b=0;b<f.length;b++){var h=f[b],g=h,n,r=h.previousSibling;h.parentNode&&"content"!=h.parentNode.id?(h.parentNode.removeChild(h),n=h.id,g.getAttribute("selected")&&(this.firstDiv=c.query("#"+n).get(0)),this.addDivAndScroll(g),c.query("#"+n).insertAfter(r)):h.parsedContent||(h.parsedContent=1,h.parentNode.removeChild(h),n=h.id,g.getAttribute("selected")&&(this.firstDiv=
c.query("#"+n).get(0)),this.addDivAndScroll(g),c.query("#"+n).insertAfter(r));h.getAttribute("data-defer")&&(e[n]=h.getAttribute("data-defer"));this.firstDiv||(this.firstDiv=c.query("#"+n).get(0));h=null}var f=null,D=!1,E=Object.keys(e).length;if(0<E){var D=!0,z=0,p;for(p in e)(function(b){c.ajax({url:AppMobi.webRoot+e[b],success:function(d){0!==d.length&&(a.updatePanel(b,d),a.parseScriptTags(c.query("#"+b).get(0)),z++,z>=E&&(c(document).trigger("defer:loaded"),D=!1))},error:function(a){console.log("Error with deferred load "+
AppMobi.webRoot+e[b]);z++;z>=E&&(c(document).trigger("defer:loaded"),D=!1)}})})(p)}if(this.firstDiv)if(this.activeDiv=this.firstDiv,this.scrollingDivs[this.activeDiv.id]&&this.scrollingDivs[this.activeDiv.id].enable(),n=function(){c.query("#navbar").append(c.create("footer",{id:"defaultNav"}).append(c.query("#navbar").children()));a.defaultFooter="defaultNav";a.prevFooter=c.query("#defaultNav");a.updateNavbarElements(a.prevFooter);var b=c.query("nav").get(0);b&&(a.defaultMenu=c(b),a.updateSideMenuElements(a.defaultMenu),
...
c.query("#afui #navbar").addClass("hasMenu"),c.query("#afui #menu").addClass("tabletMenu"));var b=a.getPanelId(l),d=b=="#"+a.firstDiv.id;0<b.length&&a.loadDefaultHash&&!d?a.loadContent(l,!0,!1,"none"):(k="#"+a.firstDiv.id,a.firstDiv.style.display="block",a.parsePanelFunctions(a.firstDiv),a.loadContentData(a.firstDiv),c.query("#header #backButton").css("visibility","hidden"),("true"==a.firstDiv.getAttribute("data-modal")||"true"==a.firstDiv.getAttribute("modal"))&&a.showModal(a.firstDiv.id));a.launchCompleted=
!0;c(document).trigger("afui:ready");c.query("#afui #splashscreen").remove()},D)c(document).one("defer:loaded",n);else n();c.bind(a,"content-loaded",function(){if(0<a.loadContentQueue.length){var b=a.loadContentQueue.splice(0,1)[0];a.loadContent(b[0],b[1],b[2],b[3],b[4])}});(window.navigator.standalone||this.isIntel)&&this.blockPageScroll();this.topClickScroll()}},topClickScroll:function(){var a=this;document.getElementById("header").addEventListener("click",function(c){15>=c.clientY&&"h1"==c.target.nodeName.toLowerCase()&&
