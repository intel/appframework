...
error:a,complete:a,context:void 0,timeout:0,crossDomain:null};m.jsonP=function(b){if(C)return b.type="get",b.dataType=null,m.get(b);var a="jsonp_callback"+ ++S,d="",h=t.createElement("script");c[a]=function(e){clearTimeout(d);m(h).remove();delete c[a];b.success.call(void 0,e)};h.src=b.url.replace(/=\?/,"="+a);b.error&&(h.onerror=function(){clearTimeout(d);b.error.call(void 0,"","error")});m("head").append(h);0<b.timeout&&(d=setTimeout(function(){b.error.call(void 0,"","timeout")},b.timeout));return{}};
m.ajax=function(b){var d;try{var h=b||{},e;for(e in m.ajaxSettings)"undefined"==typeof h[e]&&(h[e]=m.ajaxSettings[e]);h.url||(h.url=c.location);h.contentType||(h.contentType="application/x-www-form-urlencoded");h.headers||(h.headers={});if(!("async"in h)||!1!==h.async)h.async=!0;m.isObject(h.data)&&(h.data=m.param(h.data));"get"===h.type.toLowerCase()&&h.data&&(-1===h.url.indexOf("?")?h.url+="?"+h.data:h.url+="&"+h.data);if(h.dataType)switch(h.dataType){case "script":h.dataType="text/javascript, application/javascript";
break;case "json":h.dataType="application/json";break;case "xml":h.dataType="application/xml, text/xml";break;case "html":h.dataType="text/html";break;case "text":h.dataType="text/plain";break;case "jsonp":return m.jsonP(h);default:h.dataType="text/html"}else h.dataType="text/html";if(/=\?/.test(h.url))return m.jsonP(h);null===h.crossDomain&&(h.crossDomain=/^([\w-]+:)?\/\/([^\/]+)/.test(h.url)&&RegExp.$2!=c.location.host);h.crossDomain||(h.headers=m.extend({"X-Requested-With":"XMLHttpRequest"},h.headers));
var f,s=h.context,g=/^([\w-]+:)\/\//.test(h.url)?RegExp.$1:c.location.protocol;d=new c.XMLHttpRequest;d.onreadystatechange=function(){var b=h.dataType;if(4===d.readyState){clearTimeout(f);var c,a=!1;if(200<=d.status&&300>d.status||0===d.status&&"file:"==g){if("application/json"===b&&!/^\s*$/.test(d.responseText))try{c=JSON.parse(d.responseText)}catch(e){a=e}else"application/xml, text/xml"===b?c=d.responseXML:"text/html"==b?(c=d.responseText,m.parseJS(c)):c=d.responseText;0===d.status&&0===c.length&&
(a=!0);a?h.error.call(s,d,"parsererror",a):h.success.call(s,c,"success",d)}else a=!0,h.error.call(s,d,"error");h.complete.call(s,d,a?"error":"success")}};d.open(h.type,h.url,h.async);h.withCredentials&&(d.withCredentials=!0);h.contentType&&(h.headers["Content-Type"]=h.contentType);for(var q in h.headers)"string"===typeof h.headers[q]&&d.setRequestHeader(q,h.headers[q]);if(!1===h.beforeSend.call(s,d,h))return d.abort(),!1;0<h.timeout&&(f=setTimeout(function(){d.onreadystatechange=a;d.abort();h.error.call(s,
d,"timeout")},h.timeout));d.send(h.data)}catch(k){console.log(k),h.error.call(s,d,"error",k)}return d};m.get=function(b,c){return this.ajax({url:b,success:c})};m.post=function(b,c,a,d){"function"===typeof c&&(a=c,c={});d===p&&(d="html");return this.ajax({url:b,type:"POST",data:c,dataType:d,success:a})};m.getJSON=function(b,c,a){"function"===typeof c&&(a=c,c={});return this.ajax({url:b,data:c,success:a,dataType:"json"})};m.param=function(b,c){var a=[];if(b instanceof v)b.each(function(){a.push((c?
...
function(){return(65536*(1+Math.random())|0).toString(16).substring(1)};return b()+b()+"-"+b()+"-"+b()+"-"+b()+"-"+b()+b()+b()};m.getCssMatrix=function(b){m.is$(b)&&(b=b.get(0));var a=c.WebKitCSSMatrix||c.MSCSSMatrix;if(b===p)return a?new a:{a:0,b:0,c:0,d:0,e:0,f:0};b=c.getComputedStyle(b);b=b.webkitTransform||b.transform||b[m.feat.cssPrefix+"Transform"];return a?new a(b):b?(a=b.replace(/[^0-9\-.,]/g,"").split(","),{a:+a[0],b:+a[1],c:+a[2],d:+a[3],e:+a[4],f:+a[5]}):{a:0,b:0,c:0,d:0,e:0,f:0}};m.create=
function(b,c){var a,d=new v;if(c||"<"!==b[0]){c.html&&(c.innerHTML=c.html,delete c.html);a=t.createElement(b);for(var h in c)a[h]=c[h];d[d.length++]=a}else a=t.createElement("div"),C?MSApp.execUnsafeLocalFunction(function(){a.innerHTML=selector.trim()}):a.innerHTML=b,r(a.childNodes,d);return d};m.query=function(b,c){if(!b)return new v;c=c||t;return(new v).selector(b,c)};var x={},N=1;m.event={add:s,remove:F};m.fn.bind=function(b,c){for(var a=0;a<this.length;a++)s(this[a],b,c);return this};m.fn.unbind=
function(b,c){for(var a=0;a<this.length;a++)F(this[a],b,c);return this};m.fn.one=function(b,c){return this.each(function(a,d){s(this,b,c,null,function(b,c){return function(){F(d,c,b);return b.apply(d,arguments)}})})};var Q=function(){return!0},R=function(){return!1},P={preventDefault:"isDefaultPrevented",stopImmediatePropagation:"isImmediatePropagationStopped",stopPropagation:"isPropagationStopped"};m.fn.delegate=function(b,c,a,d){for(var h=0;h<this.length;h++)D(this[h],c,d,b,a);return this};m.fn.undelegate=
function(b,c,a){for(var d=0;d<this.length;d++)F(this[d],c,a,b);return this};m.fn.on=function(b,c,a,d){m.isObject(a)||(d=a,a=null);return c===p||m.isFunction(c)?this.bind(b,c):this.delegate(c,b,a,d)};m.fn.off=function(b,c,a){return c===p||m.isFunction(c)?this.unbind(b,c):this.undelegate(c,b,a)};m.fn.trigger=function(b,c,a){"string"==typeof b&&(b=m.Event(b,a));b.data=c;for(c=0;c<this.length;c++)this[c].dispatchEvent(b);return this};m.Event=function(b,c){var a=t.createEvent("Events"),d=!0;if(c)for(var h in c)"bubbles"==
h?d=!!c[h]:a[h]=c[h];a.initEvent(b,d,!0,null,null,null,null,null,null,null,null,null,null,null,null);return a};m.bind=function(b,c,a){if(b){b.__events||(b.__events={});m.isArray(c)||(c=[c]);for(var d=0;d<c.length;d++)b.__events[c[d]]||(b.__events[c[d]]=[]),b.__events[c[d]].push(a)}};m.trigger=function(b,c,a){if(b){var d=!0;if(!b.__events)return d;m.isArray(c)||(c=[c]);m.isArray(a)||(a=[]);for(var h=0;h<c.length;h++)if(b.__events[c[h]])for(var e=b.__events[c[h]].slice(0),f=0;f<e.length;f++)m.isFunction(e[f])&&
!1===e[f].apply(b,a)&&(d=!1);return d}};m.unbind=function(b,c,a){if(b.__events){m.isArray(c)||(c=[c]);for(var d=0;d<c.length;d++)if(b.__events[c[d]])for(var h=b.__events[c[d]],e=0;e<h.length;e++)if(a==p&&delete h[e],h[e]==a){h.splice(e,1);break}}};m.proxy=function(b,c,a){return function(){return a?b.apply(c,a):b.apply(c,arguments)}};var U=function(b,c){for(var a=0;a<b.length;a++)z(b[a],c)};m.cleanUpContent=function(b,c,a){if(b){var d=b.childNodes;d&&0<d.length&&m.asap(U,{},[I.apply(d,[0]),a]);c&&
E(b,a)}};var H=[],K=[],L=[];m.asap=function(b,a,d){if(!m.isFunction(b))throw"$.asap - argument is not a valid function";H.push(b);K.push(a?a:{});L.push(d?d:[]);c.postMessage("afm-asap","*")};c.addEventListener("message",function(b){b.source==c&&"afm-asap"==b.data&&(b.stopPropagation(),0<H.length&&H.shift().apply(K.shift(),L.shift()))},!0);var M={};m.parseJS=function(b){if(b){if("string"==typeof b){var a=t.createElement("div");C?MSApp.execUnsafeLocalFunction(function(){a.innerHTML=b}):a.innerHTML=
b;b=a}var d=b.getElementsByTagName("script");b=null;for(var h=0;h<d.length;h++)if(0<d[h].src.length&&!M[d[h].src]&&!C){var e=t.createElement("script");e.type=d[h].type;e.src=d[h].src;t.getElementsByTagName("head")[0].appendChild(e);M[d[h].src]=1;e=null}else c.eval(d[h].innerHTML)}};"click keydown keyup keypress submit load resize change select error".split(" ").forEach(function(b){m.fn[b]=function(c){return c?this.bind(b,c):this.trigger(b)}});["focus","blur"].forEach(function(b){m.fn[b]=function(c){if(0!==
this.length){if(c)this.bind(b,c);else for(c=0;c<this.length;c++)try{this[c][b]()}catch(a){}return this}}});return m}(window);window.jq=af;"$"in window||(window.$=af);"function"===typeof define&&define.amd?define("appframework",[],function(){return af}):"undefined"!==typeof module&&module.exports&&(module.exports.af=af,module.exports.$=af);window.numOnly||(window.numOnly=function(c){if(void 0===c||""===c)return 0;if(isNaN(parseFloat(c)))if(c.replace)c=c.replace(/[^0-9.-]/g,"");else return 0;return parseFloat(c)})};/*
 Intel
...
c.query("#content").css("top",c.query("#header").css("height"))},toggleSideMenu:function(a,d,f){if(this.isSideMenuEnabled()&&!this.togglingSideMenu){var e=this,b=c.query("#menu"),h=c.query("#content,  #header, #navbar"),g=c.query(".afui_panel_mask");f=f||this.transitionTime;var k=this.isSideMenuOn();0===g.length&&window.innerWidth<c.ui.fixedSideMenuWidth&&(h.append('<div class="afui_panel_mask"></div>'),c(".afui_panel_mask").bind("touchend",function(){c.ui.toggleSideMenu(!1)}));if(2===a||!k&&(void 0!==
a&&!1!==a||void 0===a))this.togglingSideMenu=!0,b.show(),e.css3animate(h,{x:e.sideMenuWidth,time:f,complete:function(a){e.togglingSideMenu=!1;h.vendorCss("Transition","");d&&d(a);window.innerWidth<c.ui.fixedSideMenuWidth&&g.show()}});else if(void 0===a||void 0!==a&&!1===a)this.togglingSideMenu=!0,e.css3animate(h,{x:"0px",time:f,complete:function(a){h.vendorCss("Transition","");h.vendorCss("Transform","");e.togglingSideMenu=!1;d&&d(a);b.hide();window.innerWidth<c.ui.fixedSideMenuWidth&&g.hide()}})}},
disableSideMenu:function(){var a=c.query("#content, #header, #navbar");this.isSideMenuOn()?this.toggleSideMenu(!1,function(c){c||a.removeClass("hasMenu")}):a.removeClass("hasMenu");c.query("#menu").removeClass("tabletMenu")},enableSideMenu:function(){c.query("#content, #header, #navbar").addClass("hasMenu");c.query("#menu").addClass("tabletMenu")},isSideMenuEnabled:function(){return c.query("#content").hasClass("hasMenu")},isSideMenuOn:function(){var a=1<parseInt(c.getCssMatrix(c("#content")).e)?
