...
!b.os.opera?"3d(":"(";b.feat.cssTransformEnd=!b.os.opera?",0)":")";b.os.android&&!b.os.webkit&&(b.os.android=!1)}function f(b){return b._afmid||(b._afmid=N++)}function e(c,a,u,d){a=b(a);if(a.ns)var g=RegExp("(?:^| )"+a.ns.replace(" "," .* ?")+"(?: |$)");return(x[f(c)]||[]).filter(function(b){return b&&(!a.e||b.e==a.e)&&(!a.ns||g.test(b.ns))&&(!u||b.fn==u||"function"===typeof b.fn&&"function"===typeof u&&b.fn===u)&&(!d||b.sel==d)})}function b(b){b=(""+b).split(".");return{e:b[0],ns:b.slice(1).sort().join(" ")}}
function g(b,c,a){m.isObject(b)?m.each(b,a):b.split(/\s/).forEach(function(b){a(b,c)})}function s(c,a,u,d,e){var s=f(c),h=x[s]||(x[s]=[]);g(a,u,function(a,u){var w=e&&e(u,a),g=w||u,f=function(b){var a=g.apply(c,[b].concat(b.data));!1===a&&b.preventDefault();return a},w=m.extend(b(a),{fn:u,proxy:f,sel:d,del:w,i:h.length});h.push(w);c.addEventListener(w.e,f,!1)});c=null}function F(b,c,a,d){var s=f(b);g(c||"",a,function(c,a){e(b,c,a,d).forEach(function(c){delete x[s][c.i];b.removeEventListener(c.e,c.proxy,
!1)})})}function O(b){var c=m.extend({originalEvent:b},b);m.each(P,function(a,d){c[a]=function(){this[d]=Q;if("stopImmediatePropagation"==a||"stopPropagation"==a)if(b.cancelBubble=!0,!b[a])return;return b[a].apply(b,arguments)};c[d]=R});return c}function D(b,c,a,d,g){s(b,c,a,d,function(c){return function(a){var u,w=m(a.target).closest(d,b).get(0);if(w)return u=m.extend(O(a),{currentTarget:w,liveFired:b,delegateTarget:b,data:g}),c.apply(w,[u].concat([].slice.call(arguments,1)))}})}function E(b,c){if(c&&
...
t}else return this;return this.selector(b,c)},m=function(b,c){return new v(b,c)};m.is$=function(b){return b instanceof v};m.map=function(b,c){var a,d=[],g;if(m.isArray(b))for(g=0;g<b.length;g++)a=c.apply(b[g],[g,b[g]]),a!==p&&d.push(a);else if(m.isObject(b))for(g in b)b.hasOwnProperty(g)&&"length"!=g&&(a=c(b[g],[g,b[g]]),a!==p&&d.push(a));return af(d)};m.each=function(b,c){var a;if(m.isArray(b))for(a=0;a<b.length&&!1!==c(a,b[a]);a++);else if(m.isObject(b))for(a in b)if(b.hasOwnProperty(a)&&"length"!=
...
d.replace(l(b)," ")});d=d.trim();this[a].className=0<d.length?(d+" "+c).trim():c}return this},hasClass:function(b,c){if(0===this.length)return!1;c||(c=this[0]);return l(b).test(c.className)},append:function(b,a){if(b&&b.length!=p&&0===b.length)return this;if(m.isArray(b)||m.isObject(b))b=m(b);var d;for(d=0;d<this.length;d++)if(b.length&&"string"!=typeof b)b=m(b),n(b,this[d],a);else{var g=T.test(b)?m(b):void 0;if(g==p||0===g.length)g=t.createTextNode(b);g.nodeName!=p&&"script"==g.nodeName.toLowerCase()&&
(!g.type||"text/javascript"===g.type.toLowerCase())?c.eval(g.innerHTML):g instanceof v?n(g,this[d],a):a!=p?this[d].insertBefore(g,this[d].firstChild):this[d].appendChild(g)}return this},appendTo:function(b,c){m(b).append(this);return this},prependTo:function(b){m(b).append(this,!0);return this},prepend:function(b){return this.append(b,1)},insertBefore:function(b,c){if(0===this.length)return this;b=m(b).get(0);if(!b)return this;for(var a=0;a<this.length;a++)c?b.parentNode.insertBefore(this[a],b.nextSibling):
...
b.dataType=null,m.get(b);var a="jsonp_callback"+ ++S,d="",g=t.createElement("script");c[a]=function(e){clearTimeout(d);m(g).remove();delete c[a];b.success.call(void 0,e)};g.src=b.url.replace(/=\?/,"="+a);b.error&&(g.onerror=function(){clearTimeout(d);b.error.call(void 0,"","error")});m("head").append(g);0<b.timeout&&(d=setTimeout(function(){b.error.call(void 0,"","timeout")},b.timeout));return{}};m.ajax=function(b){var d;try{var g=b||{},e;for(e in m.ajaxSettings)"undefined"==typeof g[e]&&(g[e]=m.ajaxSettings[e]);
g.url||(g.url=c.location);g.contentType||(g.contentType="application/x-www-form-urlencoded");g.headers||(g.headers={});if(!("async"in g)||!1!==g.async)g.async=!0;if(g.dataType)switch(g.dataType){case "script":g.dataType="text/javascript, application/javascript";break;case "json":g.dataType="application/json";break;case "xml":g.dataType="application/xml, text/xml";break;case "html":g.dataType="text/html";break;case "text":g.dataType="text/plain";break;default:g.dataType="text/html";break;case "jsonp":return m.jsonP(b)}else g.dataType=
"text/html";m.isObject(g.data)&&(g.data=m.param(g.data));"get"===g.type.toLowerCase()&&g.data&&(-1===g.url.indexOf("?")?g.url+="?"+g.data:g.url+="&"+g.data);if(/=\?/.test(g.url))return m.jsonP(g);null===g.crossDomain&&(g.crossDomain=/^([\w-]+:)?\/\/([^\/]+)/.test(g.url)&&RegExp.$2!=c.location.host);g.crossDomain||(g.headers=m.extend({"X-Requested-With":"XMLHttpRequest"},g.headers));var f,s=g.context,h=/^([\w-]+:)\/\//.test(g.url)?RegExp.$1:c.location.protocol;d=new c.XMLHttpRequest;d.onreadystatechange=
function(){var b=g.dataType;if(4===d.readyState){clearTimeout(f);var c,a=!1;if(200<=d.status&&300>d.status||0===d.status&&"file:"==h){if("application/json"===b&&!/^\s*$/.test(d.responseText))try{c=JSON.parse(d.responseText)}catch(e){a=e}else"application/xml, text/xml"===b?c=d.responseXML:"text/html"==b?(c=d.responseText,m.parseJS(c)):c=d.responseText;0===d.status&&0===c.length&&(a=!0);a?g.error.call(s,d,"parsererror",a):g.success.call(s,c,"success",d)}else a=!0,g.error.call(s,d,"error");g.complete.call(s,
d,a?"error":"success")}};d.open(g.type,g.url,g.async);g.withCredentials&&(d.withCredentials=!0);g.contentType&&(g.headers["Content-Type"]=g.contentType);for(var q in g.headers)"string"===typeof g.headers[q]&&d.setRequestHeader(q,g.headers[q]);if(!1===g.beforeSend.call(s,d,g))return d.abort(),!1;0<g.timeout&&(f=setTimeout(function(){d.onreadystatechange=a;d.abort();g.error.call(s,d,"timeout")},g.timeout));d.send(g.data)}catch(k){console.log(k),g.error.call(s,d,"error",k)}return d};m.get=function(b,
c){return this.ajax({url:b,success:c})};m.post=function(b,c,a,d){"function"===typeof c&&(a=c,c={});d===p&&(d="html");return this.ajax({url:b,type:"POST",data:c,dataType:d,success:a})};m.getJSON=function(b,c,a){"function"===typeof c&&(a=c,c={});return this.ajax({url:b,data:c,success:a,dataType:"json"})};m.param=function(b,c){var a=[];if(b instanceof v)b.each(function(){a.push((c?c+"["+this.id+"]":this.id)+"="+encodeURIComponent(this.value))});else for(var d in b)if(!m.isFunction(b[d])){var g=c?c+"["+
d+"]":d,e=b[d];a.push(m.isObject(e)?m.param(e,g):g+"="+encodeURIComponent(e))}return a.join("&")};m.parseJSON=function(b){return JSON.parse(b)};m.parseXML=function(b){if(C)MSApp.execUnsafeLocalFunction(function(){return(new DOMParser).parseFromString(b,"text/xml")});else return(new DOMParser).parseFromString(b,"text/xml")};d(m,navigator.userAgent);m.__detectUA=d;m.uuid=function(){var b=function(){return(65536*(1+Math.random())|0).toString(16).substring(1)};return b()+b()+"-"+b()+"-"+b()+"-"+b()+"-"+
b()+b()+b()};m.getCssMatrix=function(b){m.is$(b)&&(b=b.get(0));var a=c.WebKitCSSMatrix||c.MSCSSMatrix;if(b===p)return a?new a:{a:0,b:0,c:0,d:0,e:0,f:0};b=c.getComputedStyle(b);b=b.webkitTransform||b.transform||b[m.feat.cssPrefix+"Transform"];return a?new a(b):b?(a=b.replace(/[^0-9\-.,]/g,"").split(","),{a:+a[0],b:+a[1],c:+a[2],d:+a[3],e:+a[4],f:+a[5]}):{a:0,b:0,c:0,d:0,e:0,f:0}};m.create=function(b,c){var a,d=new v;if(c||"<"!==b[0]){c.html&&(c.innerHTML=c.html,delete c.html);a=t.createElement(b);
for(var g in c)a[g]=c[g];d[d.length++]=a}else a=t.createElement("div"),C?MSApp.execUnsafeLocalFunction(function(){a.innerHTML=selector.trim()}):a.innerHTML=b,r(a.childNodes,d);return d};m.query=function(b,c){if(!b)return new v;c=c||t;return(new v).selector(b,c)};var x={},N=1;m.event={add:s,remove:F};m.fn.bind=function(b,c){for(var a=0;a<this.length;a++)s(this[a],b,c);return this};m.fn.unbind=function(b,c){for(var a=0;a<this.length;a++)F(this[a],b,c);return this};m.fn.one=function(b,c){return this.each(function(a,
d){s(this,b,c,null,function(b,c){return function(){F(d,c,b);return b.apply(d,arguments)}})})};var Q=function(){return!0},R=function(){return!1},P={preventDefault:"isDefaultPrevented",stopImmediatePropagation:"isImmediatePropagationStopped",stopPropagation:"isPropagationStopped"};m.fn.delegate=function(b,c,a,d){for(var g=0;g<this.length;g++)D(this[g],c,d,b,a);return this};m.fn.undelegate=function(b,c,a){for(var d=0;d<this.length;d++)F(this[d],c,a,b);return this};m.fn.on=function(b,c,a,d){m.isObject(a)||
(d=a,a=null);return c===p||m.isFunction(c)?this.bind(b,c):this.delegate(c,b,a,d)};m.fn.off=function(b,c,a){return c===p||m.isFunction(c)?this.unbind(b,c):this.undelegate(c,b,a)};m.fn.trigger=function(b,c,a){"string"==typeof b&&(b=m.Event(b,a));b.data=c;for(c=0;c<this.length;c++)this[c].dispatchEvent(b);return this};m.Event=function(b,c){var a=t.createEvent("Events"),d=!0;if(c)for(var g in c)"bubbles"==g?d=!!c[g]:a[g]=c[g];a.initEvent(b,d,!0,null,null,null,null,null,null,null,null,null,null,null,null);
return a};m.bind=function(b,c,a){if(b){b.__events||(b.__events={});m.isArray(c)||(c=[c]);for(var d=0;d<c.length;d++)b.__events[c[d]]||(b.__events[c[d]]=[]),b.__events[c[d]].push(a)}};m.trigger=function(b,c,a){if(b){var d=!0;if(!b.__events)return d;m.isArray(c)||(c=[c]);m.isArray(a)||(a=[]);for(var g=0;g<c.length;g++)if(b.__events[c[g]])for(var e=b.__events[c[g]].slice(0),f=0;f<e.length;f++)m.isFunction(e[f])&&!1===e[f].apply(b,a)&&(d=!1);return d}};m.unbind=function(b,c,a){if(b.__events){m.isArray(c)||
(c=[c]);for(var d=0;d<c.length;d++)if(b.__events[c[d]])for(var g=b.__events[c[d]],e=0;e<g.length;e++)if(a==p&&delete g[e],g[e]==a){g.splice(e,1);break}}};m.proxy=function(b,c,a){return function(){return a?b.apply(c,a):b.apply(c,arguments)}};var U=function(b,c){for(var a=0;a<b.length;a++)z(b[a],c)};m.cleanUpContent=function(b,c,a){if(b){var d=b.childNodes;d&&0<d.length&&m.asap(U,{},[I.apply(d,[0]),a]);c&&E(b,a)}};var H=[],K=[],L=[];m.asap=function(b,a,d){if(!m.isFunction(b))throw"$.asap - argument is not a valid function";
H.push(b);K.push(a?a:{});L.push(d?d:[]);c.postMessage("afm-asap","*")};c.addEventListener("message",function(b){b.source==c&&"afm-asap"==b.data&&(b.stopPropagation(),0<H.length&&H.shift().apply(K.shift(),L.shift()))},!0);var M={};m.parseJS=function(b){if(b){if("string"==typeof b){var a=t.createElement("div");C?MSApp.execUnsafeLocalFunction(function(){a.innerHTML=b}):a.innerHTML=b;b=a}var d=b.getElementsByTagName("script");b=null;for(var g=0;g<d.length;g++)if(0<d[g].src.length&&!M[d[g].src]&&!C){var e=
t.createElement("script");e.type=d[g].type;e.src=d[g].src;t.getElementsByTagName("head")[0].appendChild(e);M[d[g].src]=1;e=null}else c.eval(d[g].innerHTML)}};"click keydown keyup keypress submit load resize change select error".split(" ").forEach(function(b){m.fn[b]=function(c){return c?this.bind(b,c):this.trigger(b)}});["focus","blur"].forEach(function(b){m.fn[b]=function(c){if(0!==this.length){if(c)this.bind(b,c);else for(c=0;c<this.length;c++)try{this[c][b]()}catch(a){}return this}}});return m}(window);
...
10);if(0===c||isNaN(c))this.el.scrollTop=Math.abs(b.y),this.el.scrollLeft=Math.abs(b.x);else{var a=(this.el.scrollTop-b.y)/Math.ceil(c/10),d=(this.el.scrollLeft-b.x)/Math.ceil(c/10),e=this,f=Math.ceil(this.el.scrollTop-b.y)/a,h=Math.ceil(this.el.scrollLeft-b.x)/a,q=0,k=0;e.scrollTopInterval=window.setInterval(function(){e.el.scrollTop-=a;k++;k>=f&&(e.el.scrollTop=b.y,clearInterval(e.scrollTopInterval))},10);e.scrollLeftInterval=window.setInterval(function(){e.el.scrollLeft-=d;q++;q>=h&&(e.el.scrollLeft=
...
typeof h){a=c('<div id="af_actionsheet"><div style="width:100%"></div></div>');q=c(a.children().get(0));h.push({text:"Cancel",cssClasses:"cancel"});for(var d=0;d<h.length;d++){var f=c('<a href="javascript:;" >'+(h[d].text||"TEXT NOT ENTERED")+"</a>");f[0].onclick=h[d].handler||function(){};h[d].cssClasses&&0<h[d].cssClasses.length&&f.addClass(h[d].cssClasses);q.append(f)}}c(k).find("#af_actionsheet").remove();c(k).find("#af_action_mask").remove();actionsheetEl=c(k).append(a);a.vendorCss("Transition",
...
(function(c){c.touchLayer=function(a){c.touchLayer=new f(a);return c.touchLayer};var n=["input","select","textarea"],l=["button","radio","checkbox","range","date"],k=c.os.ios,h=c.os.blackberry,q=c.os.blackberry||c.os.fennec||c.os.android&&!c.os.chrome,r=c.os.ios&&!c.os.ios7,a=!1,d=!1,f=function(a){this.clearTouchVars();a.addEventListener("touchstart",this,!1);a.addEventListener("touchmove",this,!1);a.addEventListener("touchend",this,!1);a.addEventListener("click",this,!1);a.addEventListener("focusin",
...
c.query("#content").css("top",c.query("#header").css("height"))},toggleSideMenu:function(a,d,f){if(this.isSideMenuEnabled()&&!this.togglingSideMenu){var e=this,b=c.query("#menu"),g=c.query("#content,  #header, #navbar");f=f||this.transitionTime;var h=this.isSideMenuOn();if(2===a||!h&&(void 0!==a&&!1!==a||void 0===a))this.togglingSideMenu=!0,b.show(),e.css3animate(g,{x:e.sideMenuWidth,time:f,complete:function(a){e.togglingSideMenu=!1;g.vendorCss("Transition","");d&&d(a)}});else if(void 0===a||void 0!==
a&&!1===a)this.togglingSideMenu=!0,e.css3animate(g,{x:"0px",time:f,complete:function(a){g.vendorCss("Transition","");g.vendorCss("Transform","");e.togglingSideMenu=!1;d&&d(a);b.hide()}})}},disableSideMenu:function(){var a=c.query("#content, #header, #navbar");this.isSideMenuOn()?this.toggleSideMenu(!1,function(c){c||a.removeClass("hasMenu")}):a.removeClass("hasMenu");c.query("#menu").removeClass("tabletMenu")},enableSideMenu:function(){c.query("#content, #header, #navbar").addClass("hasMenu");c.query("#menu").addClass("tabletMenu")},
...
f.empty();var g;g=c.feat.nativeTouchScroll||!b?e.contents():c(e.get(0).childNodes[0]).contents();f.append(g);f.append("<a onclick='$.ui.hideModal();' class='closebutton modalbutton'></a>");this.modalWindow.style.display="block";this.runTransition(this.modalTransition,this.modalTransContainer,this.modalWindow,!1);b?this.scrollingDivs.modal_container.enable(this.resetScrollers):this.scrollingDivs.modal_container.disable();this.scrollToTop("modal");f.data("panel",a);f=e.get(0);b=f.getAttribute("data-load");
if("string"==typeof b&&window[b])window[b](f);e.trigger("loadpanel")}},hideModal:function(){var a=this,d=c.query("#modalContainer");d.find("#closebutton.modalbutton").remove();var f=this.scrollingDivs.hasOwnProperty(this.modalReference_.attr("id"));this.runTransition(a.modalTransition,a.modalWindow,a.modalTransContainer,!0);this.scrollingDivs.modal_container.disable();var e=c.query(d.data("panel")),b=e.data("unload");if("string"==typeof b&&window[b])window[b](e.get(0));e.trigger("unloadpanel");setTimeout(function(){c.feat.nativeTouchScroll||
!f?a.modalReference_.append(d.contents()):c(a.modalReference_.get(0).childNodes[0]).append(d.contents());d.html("",!0)},this.transitionTime)},updatePanel:function(a,d){a="#"+a.replace("#","");var f=c.query(a).get(0);if(f){var e=c.create("div",{html:d}),e=e.children(".panel")&&0<e.children(".panel").length?e.children(".panel").get(0):e.get(0);f.getAttribute("js-scrolling")&&("yes"==f.getAttribute("js-scrolling").toLowerCase()||"true"==f.getAttribute("js-scrolling").toLowerCase())?(c.cleanUpContent(f.childNodes[0],
!1,!0),c(f.childNodes[0]).html(d)):(c.cleanUpContent(f,!1,!0),c(f).html(d));e.getAttribute("data-title")&&f.setAttribute("data-title",e.getAttribute("data-title"))}},updateContentDiv:function(a,c){return this.updatePanel(a,c)},addContentDiv:function(a,d,f,e,b){a="string"!==typeof a?a:-1==a.indexOf("#")?"#"+a:a;var g=c.query(a).get(0);g?d=g:(d=c.create("div",{html:d}),d=d.children(".panel")&&0<d.children(".panel").length?d.children(".panel").get(0):d.get(0),!d.getAttribute("data-title")&&f&&d.setAttribute("data-title",
f),f=d.id?d.id:a.replace("#",""),d.id=f,d.id!=a&&d.setAttribute("data-crc",a.replace("#","")));d.className="panel";f=d.id;this.addDivAndScroll(d,e,b);return f},addDivAndScroll:function(a,d,f,e){var b=!1,g,h=a.style.overflow,h="hidden"!=h&&"visible"!=h;e=e||this.content;!c.feat.nativeTouchScroll&&h&&a.setAttribute("js-scrolling","true");if(a.getAttribute("js-scrolling")&&("yes"==a.getAttribute("js-scrolling").toLowerCase()||"true"==a.getAttribute("js-scrolling").toLowerCase()))h=b=!0;g=a.getAttribute("data-title")||
a.title;a.title="";a.setAttribute("data-title",g);a.getAttribute("scrolling")&&"no"==a.getAttribute("scrolling")&&(b=h=!1,a.removeAttribute("js-scrolling"));if(!b||c.os.desktop)e.appendChild(a),g=a,a.style["-webkit-overflow-scrolling"]="none";else{g=a.cloneNode(!1);a.title=null;a.id=null;var k=c(a);k.removeAttr("data-footer data-aside data-nav data-header selected data-load data-unload data-tab data-crc title data-title");k.replaceClass("panel","afScrollPanel");g.appendChild(a);e.appendChild(g);!1!==
this.selectBox&&this.selectBox.getOldSelects(g.id);!1!==this.passwordBox&&this.passwordBox.getOldPasswords(g.id)}h&&(this.scrollingDivs[g.id]=c(a).scroller({scrollBars:!0,verticalScroll:!0,horizontalScroll:this.horizontalScroll,vScrollCSS:"afScrollbar",refresh:d,useJsScroll:b,noParent:!b,lockBounce:this.lockPageBounce,autoEnable:!1}),f&&c.bind(this.scrollingDivs[g.id],"refresh-release",function(a){a&&f()}));g=a=null},scrollToTop:function(a,c){c=c||"300ms";a=a.replace("#","");this.scrollingDivs[a]&&
this.scrollingDivs[a].scrollToTop(c)},scrollToBottom:function(a,c){a=a.replace("#","");this.scrollingDivs[a]&&this.scrollingDivs[a].scrollToBottom(c)},parsePanelFunctions:function(a,d,f){var e=this,b=a.getAttribute("data-footer"),g=a.getAttribute("data-header");b&&"none"==b.toLowerCase()?(e.toggleNavMenu(!1),b=!1):e.toggleNavMenu(!0);b&&e.customFooter!=b?(e.customFooter=b,e.updateNavbarElements(b)):b!=e.customFooter&&(e.customFooter&&e.updateNavbarElements(e.defaultFooter),e.customFooter=!1);g&&"none"==
g.toLowerCase()?(e.toggleHeaderMenu(!1),g=!1):e.toggleHeaderMenu(!0);g&&e.customHeader!=g?(e.customHeader=g,e.updateHeaderElements(g,f)):g!=e.customHeader&&(e.customHeader&&e.updateHeaderElements(e.defaultHeader,f),e.customHeader=!1);b=c(a).find("footer");0<b.length&&(e.customFooter=a.id,b.data("parent",a.id),e.updateNavbarElements(b));b=c(a).find("header");0<b.length&&(e.customHeader=a.id,b.data("parent",a.id),e.updateHeaderElements(b,f));a.getAttribute("data-tab")&&(c.query("#navbar a").removeClass("pressed"),
c.query("#navbar #"+a.getAttribute("data-tab")).addClass("pressed"));(f=a.getAttribute("data-nav"))&&this.customMenu!=f?(this.customMenu=f,this.updateSideMenuElements(f)):f!=this.customMenu&&(this.customMenu&&this.updateSideMenuElements(this.defaultMenu),this.customMenu=!1);if(d){f=d.getAttribute("data-unload");if("string"==typeof f&&window[f])window[f](d);c(d).trigger("unloadpanel")}f=a.getAttribute("data-load");if("string"==typeof f&&window[f])window[f](a);c(a).trigger("loadpanel");this.isSideMenuOn()&&
this.toggleSideMenu(!1)},parseScriptTags:function(a){a&&c.parseJS(a)},loadContent:function(a,d,f,e,b){if(this.doingTransition)this.loadContentQueue.push([a,d,f,e,b]);else if(0!==a.length){var g=!0;b=b||document.createElement("a");if(-1==a.indexOf("#")){var h="url"+r(a),k=c.query("div.panel[data-crc='"+h+"']");0<c.query("#"+a).length?g=!1:0<k.length?(g=!1,"true"===b.getAttribute("data-refresh-ajax")||b.refresh&&!0===b.refresh||this.isAjaxApp?g=!0:a="#"+k.get(0).id):0<c.query("#"+h).length&&(g=!1,"true"===
b.getAttribute("data-refresh-ajax")||b.refresh&&!0===b.refresh||this.isAjaxApp?g=!0:a="#"+h)}-1==a.indexOf("#")&&g?this.loadAjax(a,d,f,e,b):this.loadDiv(a,d,f,e)}},loadDiv:function(a,d,f,e){var b=this,g=a.replace("#",""),h=g.indexOf("/"),l="";-1!=h&&(l=g.substr(h),g=g.substr(0,h));if(g=c.query("#"+g).get(0))if(g==this.activeDiv&&!f)this.isSideMenuOn()&&this.toggleSideMenu(!1);else{this.transitionType=e;var n=this.activeDiv;a=g;if("true"==g.getAttribute("data-modal")||"true"==g.getAttribute("modal"))return this.showModal(g.id);
n!=a&&(d?(this.clearHistory(),this.pushHistory("#"+this.firstDiv.id,g.id,e,l)):f||this.pushHistory(k,g.id,e,l),k="#"+g.id+l,this.doingTransition=!0,n.style.display="block",a.style.display="block",this.runTransition(e,n,a,f),this.parsePanelFunctions(g,n,f),this.loadContentData(g,d,f,e),setTimeout(function(){b.scrollingDivs[n.id]&&b.scrollingDivs[n.id].disable()},numOnly(b.transitionTime)+50))}else c(document).trigger("missingpanel",null,{missingTarget:a})},loadContentData:function(a,d,f,e){f?0<this.history.length&&
(f=this.history[this.history.length-1],e=f.target.indexOf("/"),f=-1!=e?f.target.substr(0,e):f.target,(f=c.query(f).get(0))?this.setBackButtonText(f.getAttribute("data-title")):this.setBackButtonText("Back")):this.activeDiv.getAttribute("data-title")?this.setBackButtonText(this.activeDiv.getAttribute("data-title")):this.setBackButtonText("Back");a.getAttribute("data-title")&&this.setTitle(a.getAttribute("data-title"));d&&(this.setBackButtonText(this.firstDiv.getAttribute("data-title")),a==this.firstDiv&&
(this.history.length=0));c("#header #menubadge").css("float","right");0===this.history.length?(this.setBackButtonVisibility(!1),this.history=[],c("#header #menubadge").css("float","left")):this.showBackButton&&this.showBackbutton&&this.setBackButtonVisibility(!0);this.activeDiv=a;this.scrollingDivs[this.activeDiv.id]&&this.scrollingDivs[this.activeDiv.id].enable(this.resetScrollers)},loadAjax:function(a,d,f,e,b){if(!("afui_ajax"==this.activeDiv.id&&a==this.ajaxUrl)){var g="url"+r(a),h=this;-1==a.indexOf("http")&&
(a=intel.xdk.webRoot+a);var k=new XMLHttpRequest;b&&"object"!==typeof b&&(b=document.createElement("a"),b.setAttribute("data-persist-ajax",!0));b=b||document.createElement("a");k.onreadystatechange=function(){if(4==k.readyState&&200==k.status){this.doingTransition=!1;var l,n=!1;l=c.query("#"+g);if(0<l.length)h.updatePanel(g,k.responseText),l.get(0).setAttribute("data-title",b.title?b.title:a);else if(b.getAttribute("data-persist-ajax")||h.isAjaxApp){var q="true"===b.getAttribute("data-pull-scroller")?
!0:!1;l=q?function(){b.refresh=!0;h.loadContent(a,d,f,e,b);b.refresh=!1}:null;var p=c(k.responseText);p.hasClass("panel")?(g=p.attr("id"),p=p.get(0).innerHTML):p=p.html();0<c("#"+g).length?h.updatePanel("#"+g,p):0<c("div.panel[data-crc='"+g+"']").length?(h.updatePanel(c("div.panel[data-crc='"+g+"']").get(0).id,p),g=c("div.panel[data-crc='"+g+"']").get(0).id):g=h.addContentDiv(g,k.responseText,b.title?b.title:a,q,l)}else h.updatePanel("afui_ajax",k.responseText),c.query("#afui_ajax").get(0).setAttribute("data-title",
b.title?b.title:a),h.loadContent("#afui_ajax",d,f,e),n=!0;l=document.createElement("div");c(l).html(k.responseText);h.parseScriptTags(l);if(n)h.showLoading&&h.hideMask();else return h.loadContent("#"+g,d,f,e),h.showLoading&&h.hideMask(),null}};this.ajaxUrl=a;var l=this.useAjaxCacheBuster?a+(a.split("?")[1]?"&":"?")+"cache="+1E16*Math.random():a;k.open("GET",l,!0);k.setRequestHeader("X-Requested-With","XMLHttpRequest");k.send();this.showLoading&&this.showMask()}},runTransition:function(a,c,f,e){this.availableTransitions[a]||
...
header.innerHTML);this.backButton=c.query("#header #backButton").css("visibility","hidden");c(document).on("click","#header #backButton",function(b){b.preventDefault();a.goBack()});this.titleBar=c.query("#header #pageTitle").get(0);this.addContentDiv("afui_ajax","");var f=c.create("div",{id:"afui_mask",className:"ui-loader",html:"<span class='ui-icon ui-icon-loading spin'></span><h1>Loading Content</h1>"}).css({"z-index":2E4,display:"none"});document.body.appendChild(f.get(0));f=c.create("div",{id:"afui_modal"}).get(0);
f.appendChild(c.create("div",{id:"modalContainer"}).get(0));this.modalTransContainer=c.create("div",{id:"modalTransContainer"}).appendTo(f).get(0);this.viewportContainer.append(f);this.scrollingDivs.modal_container=c.query("#modalContainer").scroller({scrollBars:!0,vertical:!0,vScrollCSS:"afScrollbar",noParent:!0,lockBounce:this.lockPageBounce});this.modalWindow=f;for(var e={},f=this.viewportContainer.get(0).querySelectorAll(".panel"),b=0;b<f.length;b++){var g=f[b],h=g,n,r=g.previousSibling;g.parentNode&&
"content"!=g.parentNode.id?(g.parentNode.removeChild(g),n=g.id,h.getAttribute("selected")&&(this.firstDiv=c.query("#"+n).get(0)),this.addDivAndScroll(h),c.query("#"+n).insertAfter(r)):g.parsedContent||(g.parsedContent=1,g.parentNode.removeChild(g),n=g.id,h.getAttribute("selected")&&(this.firstDiv=c.query("#"+n).get(0)),this.addDivAndScroll(h),c.query("#"+n).insertAfter(r));g.getAttribute("data-defer")&&(e[n]=g.getAttribute("data-defer"));this.firstDiv||(this.firstDiv=c.query("#"+n).get(0));g=null}var f=
null,D=!1,E=Object.keys(e).length;if(0<E){var D=!0,z=0,p;for(p in e)(function(b){c.ajax({url:intel.xdk.webRoot+e[b],success:function(d){0<d.length&&(a.updatePanel(b,d),a.parseScriptTags(c.query("#"+b).get(0)));z++;z>=E&&(D=!1,c(document).trigger("defer:loaded"))},error:function(a){console.log("Error with deferred load "+intel.xdk.webRoot+e[b]);z++;z>=E&&(D=!1,c(document).trigger("defer:loaded"))}})})(p)}if(this.firstDiv)if(this.activeDiv=this.firstDiv,this.scrollingDivs[this.activeDiv.id]&&this.scrollingDivs[this.activeDiv.id].enable(),
...
!d?a.loadContent(l,!0,!1,"none"):(k="#"+a.firstDiv.id,a.firstDiv.style.display="block",a.parsePanelFunctions(a.firstDiv),a.loadContentData(a.firstDiv),c.query("#header #backButton").css("visibility","hidden"),("true"==a.firstDiv.getAttribute("data-modal")||"true"==a.firstDiv.getAttribute("modal"))&&a.showModal(a.firstDiv.id));a.launchCompleted=!0;c.query("#afui #splashscreen").remove();setTimeout(function(){c(document).trigger("afui:ready")})},D)c(document).one("defer:loaded",n);else n();c.bind(a,
"content-loaded",function(){if(0<a.loadContentQueue.length){var b=a.loadContentQueue.splice(0,1)[0];a.loadContent(b[0],b[1],b[2],b[3],b[4])}});(window.navigator.standalone||this.isIntel)&&this.blockPageScroll();this.topClickScroll()}},topClickScroll:function(){var a=this;document.getElementById("header").addEventListener("click",function(c){15>=c.clientY&&"h1"==c.target.nodeName.toLowerCase()&&a.scrollingDivs[a.activeDiv.id].scrollToTop("100")})},blockPageScroll:function(){c.query("#afui #header").bind("touchmove",
...
f,8),c=c>>>8^f;return c^-1};c.ui=new h;c.ui.init=!0;c(window).trigger("afui:preinit");c(window).trigger("afui:init")})(af);
...
c.query("#afui #navbar footer").append("<a id='metroMenu' onclick='$.ui.toggleSideMenu()'>\u2022\u2022\u2022</a>")};c.ui.isSideMenuOn=function(){var h=0>parseInt(c.getCssMatrix(c("#navbar")).f)?!0:!1;return this.isSideMenuEnabled()&&h};c.ui.toggleSideMenu=function(h,k){if(this.isSideMenuEnabled()&&!this.togglingSideMenu){this.togglingSideMenu=!0;var a=this,d=c.query("#menu"),f=c.query("#navbar"),e=this.isSideMenuOn();if(2===h||!e&&(void 0!==h&&!1!==h||void 0===h))d.show(),a.css3animate(f,{y:"-150px",
time:c.ui.transitionTime,complete:function(b){a.togglingSideMenu=!1;k&&k(!0)}}),a.css3animate(d,{y:"0px",time:c.ui.transitionTime});else if(void 0===h||void 0!==h&&!1===h)a.css3animate(f,{y:"0",time:c.ui.transitionTime,complete:function(b){a.togglingSideMenu=!1;k&&k(!0);d.hide()}}),a.css3animate(d,{y:"150px",time:c.ui.transitionTime})}}})}if(!c)throw"This plugin requires jqUi";c.ui?n():c(document).ready(function(){n()})})(af);
