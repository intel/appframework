...
this.noTransition;c(document).ready(function(){var a=document.getElementById("afui");if(null===a){a=document.createElement("div");a.id="afui";for(var b=document.body;b&&b.firstChild;)a.appendChild(b.firstChild);c(document.body).prepend(a)}c.os.supportsTouch&&c.touchLayer(a);d()});1===c("#afui").length?d():c(document).bind("DOMNodeInserted",a);if("intel"in window)document.addEventListener("intel.xdk.device.ready",function(){f.autoBoot()});else if("complete"==document.readyState||"loaded"==document.readyState)if(f.init)f.autoBoot();
else c(window).one("afui:init",function(){f.autoBoot()});else c(document).ready(function(){if(f.init)f.autoBoot();else c(window).one("afui:init",function(){f.autoBoot()})},!1);"intel"in window||(window.intel={xdk:{}},window.intel.xdk.webRoot="");window.addEventListener("popstate",function(){if(f.useInteralRouting){var a=f.getPanelId(document.location.hash);"#"!=document.location.href.replace(document.location.origin+"/","")&&(""===a&&1===f.history.length&&(a="#"+f.firstDiv.id),""!==a&&0!==af(a).filter(".panel").length&&
a!="#"+f.activeDiv.id&&f.goBack())}},!1)};g.prototype={init:!1,transitionTime:"230ms",showLoading:!0,loadingText:"Loading Content",loadContentQueue:[],isIntel:!1,titlebar:"",navbar:"",header:"",viewportContainer:"",remotePages:{},history:[],homeDiv:"",screenWidth:"",content:"",modalWindow:"",customFooter:!1,defaultFooter:"",defaultHeader:null,customMenu:!1,defaultMenu:"",_readyFunc:null,doingTransition:!1,passwordBox:c.passwordBox?new c.passwordBox:!1,selectBox:c.selectBox?c.selectBox:!1,ajaxUrl:"",
transitionType:"slide",scrollingDivs:{},firstDiv:"",hasLaunched:!1,launchCompleted:!1,activeDiv:"",customClickHandler:"",menuAnimation:null,togglingSideMenu:!1,sideMenuWidth:"200px",trimBackButtonText:!0,useOSThemes:!0,lockPageBounce:!1,animateHeaders:!0,useAutoPressed:!0,horizontalScroll:!1,_currentHeaderID:"defaultHeader",useInteralRouting:!0,autoBoot:function(){this.hasLaunched=!0;this.autoLaunch&&this.launch()},css3animate:function(a,d){a=c(a);return a.css3Animate(d)},setSideMenuWidth:function(a){this.sideMenuWidth=
...
a.transition,this.updateHash(a.target)},clearHistory:function(){this.history=[];this.setBackButtonVisibility(!1)},pushHistory:function(a,d,f,e){this.history.push({target:a,transition:f});try{this.manageHistory&&(window.history.pushState(d,d,n+"#"+d+e),c(window).trigger("hashchange",null,{newUrl:n+"#"+d+e,oldURL:n+a}))}catch(b){}},updateHash:function(a){if(this.manageHistory){k=a=-1==a.indexOf("#")?"#"+a:a;var d=window.location.hash,f=this.getPanelId(a).substring(1);try{window.history.replaceState(f,
f,n+a),c(window).trigger("hashchange",null,{newUrl:n+a,oldUrl:n+d})}catch(e){}}},getPanelId:function(a){var c=a.indexOf("/");return-1==c?a:a.substring(0,c)},updateBadge:function(a,d,f,e){void 0===f&&(f="");a=c(a);var b=a.find("span.af-badge");0===b.length?("absolute"!=a.css("position")&&a.css("position","relative"),b=c.create("span",{className:"af-badge "+f,html:d}),a.append(b)):b.html(d);b.removeClass("tl bl br tr");b.addClass(f);void 0===e&&(e="red");c.isObject(e)?b.css(e):e&&b.css("background",
...
a&&!0!==a||void 0===a))c.query("#content").css("top","0px"),c.query("#header").hide();else if(void 0===a||void 0!==a&&!0===a)c.query("#header").show(),c.query("#content").css("top",c.query("#header").css("height"))},toggleSideMenu:function(a,d,f){if(this.isSideMenuEnabled()&&!this.togglingSideMenu){var e=this,b=c.query("#menu"),h=c.query("#content,  #header, #navbar");f=f||this.transitionTime;var g=this.isSideMenuOn();if(2===a||!g&&(void 0!==a&&!1!==a||void 0===a))this.togglingSideMenu=!0,b.show(),
e.css3animate(h,{x:e.sideMenuWidth,time:f,complete:function(a){e.togglingSideMenu=!1;h.vendorCss("Transition","");d&&d(a)}});else if(void 0===a||void 0!==a&&!1===a)this.togglingSideMenu=!0,e.css3animate(h,{x:"0px",time:f,complete:function(a){h.vendorCss("Transition","");h.vendorCss("Transform","");e.togglingSideMenu=!1;d&&d(a);b.hide()}})}},disableSideMenu:function(){var a=c.query("#content, #header, #navbar");this.isSideMenuOn()?this.toggleSideMenu(!1,function(c){c||a.removeClass("hasMenu")}):a.removeClass("hasMenu");
...
f=d.id;this.addDivAndScroll(d,e,b);return f},addDivAndScroll:function(a,d,f,e){var b=!1,h,g=a.style.overflow,g="hidden"!=g&&"visible"!=g;e=e||this.content;!c.feat.nativeTouchScroll&&g&&a.setAttribute("js-scrolling","true");if(a.getAttribute("js-scrolling")&&("yes"==a.getAttribute("js-scrolling").toLowerCase()||"true"==a.getAttribute("js-scrolling").toLowerCase()))g=b=!0;h=a.title;a.title="";a.setAttribute("data-title",h);a.getAttribute("scrolling")&&"no"==a.getAttribute("scrolling")&&(b=g=!1,a.removeAttribute("js-scrolling"));
if(!b||c.os.desktop)e.appendChild(a),h=a,a.style["-webkit-overflow-scrolling"]="none";else{h=a.cloneNode(!1);a.title=null;a.id=null;var k=c(a);k.removeAttr("data-footer data-aside data-nav data-header selected data-load data-unload data-tab data-crc title data-title");k.replaceClass("panel","afScrollPanel");h.appendChild(a);e.appendChild(h);!1!==this.selectBox&&this.selectBox.getOldSelects(h.id);!1!==this.passwordBox&&this.passwordBox.getOldPasswords(h.id)}g&&(this.scrollingDivs[h.id]=c(a).scroller({scrollBars:!0,
...
this.updateSideMenuElements(this.defaultMenu),this.customMenu=!1);if(d){f=d.getAttribute("data-unload");if("string"==typeof f&&window[f])window[f](d);c(d).trigger("unloadpanel")}f=a.getAttribute("data-load");if("string"==typeof f&&window[f])window[f](a);c(a).trigger("loadpanel");this.isSideMenuOn()&&this.toggleSideMenu(!1)},parseScriptTags:function(a){a&&c.parseJS(a)},loadContent:function(a,d,f,e,b){if(this.doingTransition)this.loadContentQueue.push([a,d,f,e,b]);else if(0!==a.length){var h=!0;b=b||
document.createElement("a");if(-1==a.indexOf("#")){var g="url"+r(a),k=c.query("div.panel[data-crc='"+g+"']");0<c.query("#"+a).length?h=!1:0<k.length?(h=!1,"true"===b.getAttribute("data-refresh-ajax")||b.refresh&&!0===b.refresh||this.isAjaxApp?h=!0:a="#"+k.get(0).id):0<c.query("#"+g).length&&(h=!1,"true"===b.getAttribute("data-refresh-ajax")||b.refresh&&!0===b.refresh||this.isAjaxApp?h=!0:a="#"+g)}-1==a.indexOf("#")&&h?this.loadAjax(a,d,f,e,b):this.loadDiv(a,d,f,e)}},loadDiv:function(a,d,f,e){var b=
this,h=a.replace("#",""),g=h.indexOf("/"),l="";-1!=g&&(l=h.substr(g),h=h.substr(0,g));if(h=c.query("#"+h).get(0))if(h==this.activeDiv&&!f)this.isSideMenuOn()&&this.toggleSideMenu(!1);else{this.transitionType=e;var n=this.activeDiv;a=h;if("true"==h.getAttribute("data-modal")||"true"==h.getAttribute("modal"))return this.showModal(h.id);n!=a&&(d?(this.clearHistory(),this.pushHistory("#"+this.firstDiv.id,h.id,e,l)):f||this.pushHistory(k,h.id,e,l),k="#"+h.id+l,this.doingTransition=!0,n.style.display="block",
a.style.display="block",this.runTransition(e,n,a,f),this.parsePanelFunctions(h,n,f),this.loadContentData(h,d,f,e),setTimeout(function(){b.scrollingDivs[n.id]&&b.scrollingDivs[n.id].disable()},numOnly(b.transitionTime)+50))}else c(document).trigger("missingpanel",null,{missingTarget:a})},loadContentData:function(a,d,f,e){f?0<this.history.length&&(f=this.history[this.history.length-1],e=f.target.indexOf("/"),f=-1!=e?f.target.substr(0,e):f.target,(f=c.query(f).get(0))?this.setBackButtonText(f.getAttribute("data-title")):
