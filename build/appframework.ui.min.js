...
this.loadDefaultHash&&setTimeout(function(){this.loadContent(e,!1,0,"none")}.bind(this));this.enableTabBar();a(document).on("click","a",function(a){c.useInternalRouting&&f(a,a.currentTarget)});a(document).on("click",function(d){for(var e=b.length,f=a(d.target),g=0;g<e;g++){var h=b[g],l=f.closest(h.sel);0<l.length&&h.cb.call(c,l.get(0),d)}});a(document).on("click",".backButton, [data-back]",function(){c.useInternalRouting&&c.goBack(c)});d=a("[data-include]");if(0===d.length)this.launchCompleted=!0,
...
typeof b){e=a("<div id='af_actionsheet'><div style='width:100%'></div></div>");var c=a(e.children().get(0));b.push({text:"Cancel",cssClasses:"cancel"});for(var d=0;d<b.length;d++){var l=a("<a href='javascript:;'>"+(b[d].text||"TEXT NOT ENTERED")+"</a>");l[0].onclick=b[d].handler||f;b[d].cssClasses&&0<b[d].cssClasses.length&&l.addClass(b[d].cssClasses);c.append(l)}}a(h).find("#af_actionsheet").remove();a(h).find("#af_action_mask").remove();a(h).append(e);e.vendorCss("Transition","all 0ms");this.el.style.overflow=
...
(function(a){function g(a,c,b,d){var e=Math.abs(a-c),f=Math.abs(b-d);return e>=f?0<a-c?"Left":"Right":0<b-d?"Up":"Down"}function h(){b.last&&750<=Date.now()-b.last&&(b.el.trigger("longTap"),b={})}var b={},f,e,c=!1,d=!1;a(document).ready(function(){var l;a(document.body).bind("touchstart",function(g){g.originalEvent&&(g=g.originalEvent);if(g.touches&&0!==g.touches.length){var n=Date.now(),k=n-(b.last||n);if(g.touches&&0!==g.touches.length){var r=g.touches[0].target;b.el=a("tagName"in r?r:r.parentNode);
f&&clearTimeout(f);b.x1=g.touches[0].pageX;b.y1=g.touches[0].pageY;b.x2=b.y2=0;0<k&&250>=k&&(b.isDoubleTap=!0);b.last=n;e=setTimeout(h,750);a.afui.useAutoPressed&&!b.el.attr("data-ignore-pressed")&&b.el.addClass("pressed");l&&a.afui.useAutoPressed&&!l.attr("data-ignore-pressed")&&l[0]!==b.el[0]&&l.removeClass("pressed");l=b.el;d=c=!1}}}).bind("touchmove",function(f){f.originalEvent&&(f=f.originalEvent);b.x2=f.touches[0].pageX;b.y2=f.touches[0].pageY;if(!d&&(5<Math.abs(b.x2-b.x1)||5<Math.abs(b.y2-
b.y1))){var h=5<Math.abs(b.x2-b.x1),k=5<Math.abs(b.y2-b.y1);d=!0;b.el.trigger("swipeStart",[f]);b.el.trigger("swipeStart"+g(b.x1,b.x2,b.y1,b.y2),[b,f]);var l=b.el.closest(".swipe, .swipe-reveal, .swipe-x, .swipe-y"),q=b.el.closest(".x-scroll, .y-scroll, .scroll");c=0!==b.el.closest(".swipe, .swipe-reveal").length;0!==q.parent(l).length?c=!1:h&&0!==b.el.closest(".swipe-x").length?c=!0:k&&0!==b.el.closest(".swipe-y").length&&(c=!0)}a.os.android&&d&&c&&f.preventDefault();clearTimeout(e)}).bind("touchend",
...
this.element.offsetWidth;this.element.classList.add(a);this.animClass=a;var d=window.getComputedStyle(this.element,null),f=d.animation-c;f||(f=d.animationDuration);f||(f=d.MozAnimationDuration);f||(f=d.webkitAnimationDuration);f=parseFloat(f);if(.01>=f||isNaN(f))this.runEnd=!0;this.endCBCache=b.bind(this);if(this.runEnd)return this.endCBCache(),this;this.element.addEventListener("webkitAnimationEnd",this.endCBCache,!1);this.element.addEventListener("animationend",this.endCBCache,!1);this.element.addEventListener("MSAnimationEnd",
...
autoHideCheck:null,selfCheckViewToClose:null,show:function(e,c,d){if(!this.isTransitioning){var g=this;h="right"===c?"right":"left";d=f[d]?d:this.defaultAnimation;var m=document.getElementById(e.replace("#",""));m&&(b=m,m.classList.contains("active")||(this.isTransitioning=!0,this.autoHideCheck=this.autoHide.bind(this),a(m).closest(".view").children().filter(":not(nav):not(aside)").off("touchstart",this.autoHideCheck),m.classList.add(h),e=a(m).show(),c="right"===h?"left":"right",0<a(m).closest(".view").find(".slide-"+
c+"-out").length&&(a(m).closest(".view").find(".slide-"+c+"-out").removeClass("slide-"+c+"-out"),a(m).closest(".view").find("aside.active, nav.active").removeClass("left right active").hide()),"reveal"!==d?e.css("zIndex","999").animation().run("slide-"+h+"-in").end(function(){this.classList.add("active");g.isTransitioning=!1}):e.animation().run("blank").end(function(){a(this).css("zIndex","999");this.classList.add("active");g.isTransitioning=!1}),m.activeAnimation=d,m.activePosition=h,m.toggled=!0,
f[d](m,!1),setTimeout(function(){a(m).closest(".view").children().filter(":not(nav):not(aside)").on("touchstart",g.autoHideCheck)}),this.selfCheckViewToClose=g.checkViewToClose.bind(this),a(m).bind("nestedviewunload",this.selfCheckViewToClose)))}},hide:function(e,c){if(!this.isTransitioning){var d=this,g=e&&document.getElementById(e.replace("#",""))||b;a(g).unbind("nestedviewunload",this.selfCheckViewToClose);if(g&&g.toggled){a(g).closest(".view").children().filter(":not(nav):not(aside)").off("touchstart",
...
d.dispatchEvent(f)},d=!1,l=null,m=0,n=0;window.navigator.msPointerEnabled?(document.addEventListener("MSPointerDown",function(a){d=!0;l=a.target;"a"===a.target.nodeName.toLowerCase()&&"javascript:;"===a.target.href.toLowerCase()&&(a.target.href="");c("touchstart",a,null,!0);g=!1;m=a.clientX;n=a.clientY;return!0},!0),document.addEventListener("MSPointerUp",function(a){if(d)return c("touchend",a,l,!0),l=null,d=!1,!0},!0),document.addEventListener("MSPointerMove",function(a){if(!(Math.abs(a.clientX-
m)<=f||Math.abs(a.clientY-n)<=f)&&d)return c("touchmove",a,l,!0),g=!0},!0)):(document.addEventListener("mousedown",function(a){d=!0;l=a.target;"a"===a.target.nodeName.toLowerCase()&&"javascript:;"===a.target.href.toLowerCase()&&(a.target.href="#");c("touchstart",a);g=!1;m=a.clientX;n=a.clientY},!0),document.addEventListener("mouseup",function(a){d&&(c("touchend",a,l),l=null,d=!1)},!0),document.addEventListener("mousemove",function(a){a.clientX===m&&a.clientY===n||!d||(c("touchmove",a,l),g=!0)},!0));
document.addEventListener("drag",b,!0);document.addEventListener("dragstart",b,!0);document.addEventListener("dragenter",b,!0);document.addEventListener("dragover",b,!0);document.addEventListener("dragleave",b,!0);document.addEventListener("dragend",b,!0);document.addEventListener("drop",b,!0);document.addEventListener("selectstart",function(a){e(a,a.target)},!0);document.addEventListener("click",function(a){a.mouseToTouch||a.target!==l||b(a);g&&(b(a),g=!1)},!0)}})(jQuery,window);
