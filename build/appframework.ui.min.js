...
loadAjax:function(c,d,b,f,g){var k=this,h=e(c),q=a(".panel[data-crc='"+h+"']"),n=g.getAttribute("data-refresh");0<q.length?n?(k.showLoading&&k.showMask("Loading Content"),a.ajax(c).then(function(c){a(c).hasClass("panel")?(c=a.create("div",{html:c}),q.empty().append(a(c.find(".panel")[0]).html())):q.empty().append(c);k.showLoading&&k.hideMask();k.loadContent("#"+q.prop("id"),d,b,f,g)})):k.loadContent("#"+q.prop("id"),d,b,f,g):(k.showLoading&&k.showMask("Loading Content"),a.ajax(c).then(function(e){var n=
a.create("div",{html:e});a(e).hasClass("panel")?(n=a(n.find(".panel")[0]),n.prop("id")||n.prop("id",h)):(n=n.attr("data-title",c),n.prop("id",h),n.addClass("panel"));a(k.activeDiv).closest(".pages").append(n);n.attr("data-crc",h);k.showLoading&&k.hideMask();k.loadContent("#"+n.prop("id"),d,b,f,g)}).fail(function(a){k.showLoading&&k.hideMask();console.log("Error with ajax request",a)}))},runTransition:function(c,d,b,e,f){c||(c="slide");-1!==c.indexOf(":back")&&(c=c.replace(":back",""),e=!0);var k=
this,g=e?d:b;d=e?b:d;b=!1;-1!==c.indexOf("-reveal")&&(c=c.replace("-reveal",""),b=!0);a(g).css("zIndex","10");a(d).css("zIndex","1");a(f).css("zIndex","1").addClass("active");var h=a(d).animation().remove(c+"-in");!b&&h?(e&&h.reverse(),h.end(function(){e?(this.classList.add("active"),a(this).trigger("panelload")):(this.classList.remove("active"),a(this).trigger("panelunload"));k.doingTransition=!1}).run(c+"-out")):e?(a(d).trigger("panelload"),a(d).addClass("activeDiv")):a(d).trigger("panelunload");
g=a(g).animation().remove(c+"-out");e&&g.reverse();g.end(function(){k.doingTransition=!1;e?(f&&a(f).css("zIndex","10"),this.classList.remove("active"),a(this).trigger("panelunload")):(this.classList.add("active"),a(this).trigger("panelload"),a(f).trigger("panelload"))}).run(c+"-in")},runViewTransition:function(c,d,b,e,f){d.addClass("active");a(e).addClass("active");"none"===c?(this.doingTransition=!1,setTimeout(function(){b.removeClass("active");d.addClass("active");a(e).addClass("active")},50)):
this.runTransition(c,b,d,f,e)},updateViewHistory:function(a,d,b,e){var f=this.views[a.prop("id")];f||(f=this.views[a.prop("id")]=[]);1<=f.length&&f[f.length-1].target===d||(this.pushHistory(d.id,d.id,b,e.replace(d.id,"").replace("#","")),this.views[a.prop("id")].push({target:d,transition:b}))},launch:function(){if(!1===this.hasLaunched||this.launchCompleted)this.hasLaunched=!0;else{if(this.isLaunching)return!0;this.isLaunching=!0;this.blockPageBounce();var c=this,d=a.create("div",{id:"afui_mask",
className:"ui-loader",html:"<span class='ui-icon ui-icon-loading spin'></span><h1>Loading Content</h1>"}).css({"z-index":2E4,display:"none"});document.body.appendChild(d.get(0));d=a(".view[data-default='true']");if(0===d.length)d=a(".view").eq(0);else throw"You need to create a view";d.addClass("active");this.views[d.prop("id")]=[];var e=window.location.hash,g=0===d.find(".panel[data-selected='true']").length?d.find(".panel").eq(0):d.find(".panel[data-selected='true']");g.addClass("active");this.activeDiv=
g.get(0);this.views[d.prop("id")].push({target:g.get(0),transition:this.transitionType});this.defaultPanel=g.get(0);this.loadContentData(g.get(0),d,!1,!0);this.updateHash(g.get(0).id);this.loadDefaultHash&&setTimeout(function(){this.loadContent(e,!1,0,"none")}.bind(this));this.enableTabBar();a(document).on("click","a",function(a){c.useInternalRouting&&f(a,a.currentTarget)});a(document).on("click",function(d){for(var e=b.length,f=a(d.target),g=0;g<e;g++){var h=b[g],m=f.closest(h.sel);0<m.length&&h.cb.call(c,
m.get(0),d)}});a(document).on("click",".backButton, [data-back]",function(){c.useInternalRouting&&c.goBack(c)});d=a("[data-include]");if(0===d.length)this.launchCompleted=!0,a(document).trigger("afui:ready");else{var h=[];d.each(function(){var c=this.getAttribute("data-include"),d=a(this);h.push(a.get(c,function(a){d.append(a)}))});a.when.apply(a,h).then(function(){this.launchCompleted=!0;a(document).trigger("afui:ready")}).fail(function(){this.launchCompleted=!0;a(document).trigger("afui:ready")})}a(document).on("click",
...
l)<=f||Math.abs(a.clientY-p)<=f)&&d)return c("touchmove",a,m,!0),g=!0},!0)):(document.addEventListener("mousedown",function(a){d=!0;m=a.target;"a"===a.target.nodeName.toLowerCase()&&"javascript:;"===a.target.href.toLowerCase()&&(a.target.href="#");c("touchstart",a);g=!1;l=a.clientX;p=a.clientY},!0),document.addEventListener("mouseup",function(a){d&&(c("touchend",a,m),m=null,d=!1)},!0),document.addEventListener("mousemove",function(a){a.clientX===l&&a.clientY===p||!d||(c("touchmove",a,m),g=!0)},!0));
