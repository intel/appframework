...
e=a.children("header");0!==e.length&&(2<=b&&!0!==d?1!==e.find(".backButton").length&&e.prepend("<a class='backButton back'>Back</a>"):e.find(".backButton").remove())},loadAjax:function(c,d,b,f,g){var k=this,h=e(c),q=a(".panel[data-crc='"+h+"']"),n=g.getAttribute("data-refresh");if(0<q.length)if(n)k.showLoading&&k.showMask("Loading Content"),a.ajax(c).then(function(a){q.html(a);k.showLoading&&k.hideMask();return k.loadContent("#"+q.prop("id"),d,b,f,g)});else return k.loadContent("#"+q.prop("id"),d,
