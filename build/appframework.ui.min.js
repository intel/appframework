...
0===d.length))throw"You need to create a view";d.addClass("active");this.views[d.prop("id")]=[];var e=window.location.hash,g=0===d.find(".panel[data-selected='true']").length?d.find(".panel").eq(0):d.find(".panel[data-selected='true']");g.addClass("active");this.activeDiv=g.get(0);this.views[d.prop("id")].push({target:g.get(0),transition:this.transitionType});this.defaultPanel=g.get(0);this.loadContentData(g.get(0),d,!1,!0);this.updateHash(g.get(0).id);this.loadDefaultHash&&setTimeout(function(){this.loadContent(e,
...
var f=function(c,b){b=b||c.currentTarget;if(b!==document){if(!1!==("function"===typeof a.afui.customClickHandler?a.afui.customClickHandler:!1)&&a.afui.customClickHandler(b.getAttribute("href"),c))return c.preventDefault();if("a"!==b.tagName.toLowerCase()&&b.parentNode)return f(c,b.parentNode);if("undefined"!==b.tagName&&"a"===b.tagName.toLowerCase()&&!(-1!==b.href.toLowerCase().indexOf("javascript:")||b.getAttribute("data-ignore"))){var e=b.href,g=location.protocol+"//"+location.hostname+":"+location.port+
location.pathname;0===e.indexOf(g)&&(e=e.substring(g.length));if("#"===e||e.indexOf("#")===e.length-1||0===e.length&&0===b.hash.length)return c.preventDefault();g=/^((http|https|file):\/\/)/;-1!==b.href.indexOf(":")&&g.test(b.href)&&c.preventDefault();g=b.getAttribute("data-transition");!g&&0<a(b).closest("footer").length&&(g="none");if(g&&-1!==g.indexOf(":dismiss"))return a.afui.dismissView(b,g);e=0<b.hash.length?b.hash:e;a.afui.loadContent(e,!1,0,g,b)}}},e=function(a,b){void 0===b&&(b=0);var e=
...
b.x1)||5<Math.abs(b.y2-b.y1))){var f=5<Math.abs(b.x2-b.x1),g=5<Math.abs(b.y2-b.y1);m=!0;b.el.trigger("swipeStart",[e]);b.el.trigger("swipeStart"+h(b.x1,b.x2,b.y1,b.y2),[b,e]);var l=b.el.closest(".swipe, .swipe-reveal, .swipe-x, .swipe-y"),p=b.el.closest(".x-scroll, .y-scroll, .scroll");d=0!==b.el.closest(".swipe, .swipe-reveal").length;0!==p.parent(l).length?d=!1:f&&0!==b.el.closest(".swipe-x").length?d=!0:g&&0!==b.el.closest(".swipe-y").length&&(d=!0)}a.os.android&&m&&d&&e.preventDefault();clearTimeout(c)}).bind("touchend",
...
b)),c=c.parentElement;d.dispatchEvent(f)},d=!1,m=null,l=0,q=0;window.navigator.msPointerEnabled?(document.addEventListener("MSPointerDown",function(a){d=!0;m=a.target;"a"===a.target.nodeName.toLowerCase()&&"javascript:;"===a.target.href.toLowerCase()&&(a.target.href="");c("touchstart",a,null,!0);h=!1;l=a.clientX;q=a.clientY;return!0},!0),document.addEventListener("MSPointerUp",function(a){if(d)return c("touchend",a,m,!0),m=null,d=!1,!0},!0),document.addEventListener("MSPointerMove",function(a){if(!(Math.abs(a.clientX-
l)<=f||Math.abs(a.clientY-q)<=f)&&d)return c("touchmove",a,m,!0),h=!0},!0)):(document.addEventListener("mousedown",function(a){d=!0;m=a.target;"a"===a.target.nodeName.toLowerCase()&&"javascript:;"===a.target.href.toLowerCase()&&(a.target.href="#");c("touchstart",a);h=!1;l=a.clientX;q=a.clientY},!0),document.addEventListener("mouseup",function(a){d&&(c("touchend",a,m),m=null,d=!1)},!0),document.addEventListener("mousemove",function(a){!(a.clientX===l&&a.clientY===q)&&d&&(c("touchmove",a,m),h=!0)},
