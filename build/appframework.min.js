...
b,c){if(a&&a.length!=h&&0===a.length)return this;if(e.isArray(a)||e.isObject(a))a=e(a);var d;b&&e(this).add(b);for(b=0;b<this.length;b++)if(a.length&&"string"!==typeof a)a=e(a),v(a,this[b],c);else{var g=X.test(a)?e(a):void 0;if(g==h||0===g.length)g=k.createTextNode(a);if(g instanceof r)for(var D=0,q=g.length;D<q;D++)d=g[D],d.nodeName!=h&&"script"===d.nodeName.toLowerCase()&&(!d.type||"text/javascript"===d.type.toLowerCase())?f.eval(d.innerHTML):v(e(d),this[b],c);else c!=h?this[b].insertBefore(g,this[b].firstChild):
...
"text/html";if(/=\?/.test(d.url))return e.jsonP(d);null===d.crossDomain&&(d.crossDomain=/^([\w-]+:)?\/\/([^\/]+)/.test(d.url)&&RegExp.$2!==f.location.host);d.crossDomain||(d.headers=e.extend({"X-Requested-With":"XMLHttpRequest"},d.headers));var h,k=d.context,q=/^([\w-]+:)\/\//.test(d.url)?RegExp.$1:f.location.protocol;b=new f.XMLHttpRequest;e.extend(b,c.promise);b.onreadystatechange=function(){var a=d.dataType;if(4===b.readyState){clearTimeout(h);var g,f=!1;if(200<=b.status&&300>b.status||0===b.status&&
"file:"===q){if("application/json"===b.getResponseHeader("content-type")||"application/json"===a&&!/^\s*$/.test(b.responseText))try{g=JSON.parse(b.responseText)}catch(m){f=m}else"application/xml, text/xml"===a?g=b.responseXML:"text/html"===a?(g=b.responseText,e.parseJS(g)):g=b.responseText;0===b.status&&0===g.length&&(f=!0);f?(d.error.call(k,b,"parsererror",f),c.reject.call(k,b,"parsererror",f)):(c.resolve.call(k,g,"succes",f),d.success.call(k,g,"success",b))}else f=!0,c.reject.call(k,b,"error"),
d.error.call(k,b,"error");d.complete.call(k,b,f?"error":"success")}};b.open(d.type,d.url,d.async);d.withCredentials&&(b.withCredentials=!0);d.contentType&&(d.headers["Content-Type"]=d.contentType);for(var m in d.headers)"string"===typeof d.headers[m]&&b.setRequestHeader(m,d.headers[m]);if(!1===d.beforeSend.call(k,b,d))return b.abort(),!1;0<d.timeout&&(h=setTimeout(function(){b.onreadystatechange=s;b.abort();d.error.call(k,b,"timeout")},d.timeout));b.send(d.data)}catch(z){c.resolve(k,[b,"error",z]),
d.error.call(k,b,"error",z)}return b};e.get=function(a,b){return this.ajax({url:a,success:b})};e.post=function(a,b,c,d){"function"===typeof b&&(c=b,b={});d===h&&(d="html");return this.ajax({url:a,type:"POST",data:b,dataType:d,success:c})};e.getJSON=function(a,b,c){"function"===typeof b&&(c=b,b={});return this.ajax({url:a,data:b,success:c,dataType:"json"})};e.param=function(a,b){var c=[];if(a instanceof r)a.each(function(){c.push((b?b+"["+this.id+"]":this.id)+"="+encodeURIComponent(this.value))});
...
b.html,delete b.html);c=k.createElement(a);for(var e in b)c[e]=b[e];d[d.length++]=c}else c=k.createElement("div"),B?MSApp.execUnsafeLocalFunction(function(){c.innerHTML=a.trim()}):c.innerHTML=a,n(c.childNodes,d);return d};e.query=function(a,b){if(!a)return new r;b=b||k;return(new r).selector(a,b)};var t={},Q=1;e.event={add:F,remove:G};e.fn.bind=function(a,b){for(var c=0,d=this.length;c<d;c++)F(this[c],a,b);return this};e.fn.unbind=function(a,b){for(var c=0,d=this.length;c<d;c++)G(this[c],a,b);return this};
