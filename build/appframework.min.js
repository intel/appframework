...
a.os.opera?"O":"";a.feat.cssTransformStart=!a.os.opera?"3d(":"(";a.feat.cssTransformEnd=!a.os.opera?",0)":")";a.os.android&&!a.os.webkit&&(a.os.android=!1);for(var c=["Webkit","Moz","ms","O"],d=0;d<c.length;d++)""===k.documentElement.style[c[d]+"Transform"]&&(a.feat.cssPrefix=c[d])}function z(a){return a._afmid||(a._afmid=Q++)}function E(a,b,c,d,e){b=r(b,e);return(w[z(a)]||[]).filter(function(a){return a&&(!b.e||a.e===b.e)&&(!b.ns||0!==a.ns.indexOf(b.ns))&&(!c||a.fn===c||"function"===typeof a.fn&&
"function"===typeof c&&a.fn===c)&&(!d||a.sel===d)})}function r(a,b){var c=(""+a).split(".");!0!==b&&c.pop();return{e:a,ns:c.join(".")}}function t(a,b,c){e.isObject(a)?e.each(a,c):a.split(/\s/).forEach(function(a){c(a,b)})}function F(a,b,c,d,g){var h=z(a),f=w[h]||(w[h]=[]);t(b,c,function(b,c){var h=g&&g(c,b),D=h||c,k=function(b){var c=D.apply(a,[b].concat(b.data));!1===c&&b.preventDefault();return c},h=e.extend(r(b),{fn:c,proxy:k,sel:d,del:h,i:f.length});f.push(h);a.addEventListener(h.e,k,!1)})}function G(a,
b,c,d){var e=z(a);t(b||"",c,function(b,c){E(a,b,c,d,!0).forEach(function(b){delete w[e][b.i];a.removeEventListener(b.e,b.proxy,!1)})})}function R(a){var b=e.extend({originalEvent:a},a);e.each(S,function(c,d){b[c]=function(){this[d]=T;if("stopImmediatePropagation"===c||"stopPropagation"===c)if(a.cancelBubble=!0,!a[c])return;return a[c].apply(a,arguments)};b[d]=U});return b}function V(a,b,c,d,g){F(a,b,c,d,function(b){return function(c){var h,f=e(c.target).closest(d,a).get(0);if(f)return h=e.extend(R(c),
{currentTarget:f,liveFired:a,delegateTarget:a,data:g}),b.apply(f,[h].concat([].slice.call(arguments,1)))}})}function J(a,b){if(b&&a.dispatchEvent){var c=e.Event("destroy",{bubbles:!1});a.dispatchEvent(c)}if((c=z(a))&&w[c]){for(var d in w[c])a.removeEventListener(w[c][d].e,w[c][d].proxy,!1);delete w[c]}}function K(a,b){if(a){var c=a.childNodes;if(c&&0<c.length)for(var d;d<c.length;d++)K(c[d],b);J(a,b)}}var h,k=f.document,A=[],L=A.slice,H={},W=1,X=/<(\w+)[^>]*>/,u={},x={},M={columncount:!0,fontweight:!0,
lineheight:!0,"column-count":!0,"font-weight":!0,"line-height":!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,"z-index":!0,zoom:!0},B="object"===typeof MSApp,s=function(a,b){this.length=0;if(a){if(a instanceof s&&b==h)return a;if(af.isFunction(a))return af(k).ready(a);if(af.isArray(a)&&a.length!=h){for(var c=0;c<a.length;c++)this[this.length++]=a[c];return this}if(af.isObject(a)&&af.isObject(b)){if(a.length==h)a.parentNode==b&&(this[this.length++]=a);else for(c=0;c<a.length;c++)a[c].parentNode==b&&
(this[this.length++]=a[c]);return this}if(af.isObject(a)&&b==h)return this[this.length++]=a,this;if(b!==h){if(b instanceof s)return b.find(a)}else b=k}else return this;return this.selector(a,b)},e=function(a,b){return new s(a,b)};e.is$=function(a){return a instanceof s};e.map=function(a,b){var c,d=[],g;if(e.isArray(a))for(g=0;g<a.length;g++)c=b.apply(a[g],[a[g],g]),c!==h&&d.push(c);else if(e.isObject(a))for(g in a)a.hasOwnProperty(g)&&"length"!==g&&(c=b(a[g],[a[g],g]),c!==h&&d.push(c));return d};
...
e.isObject=function(a){return"object"===typeof a&&null!==a};e.fn=s.prototype={namespace:"appframework",constructor:s,forEach:A.forEach,reduce:A.reduce,push:A.push,indexOf:A.indexOf,concat:A.concat,selector:function(a,b){a=a.trim();if("#"===a[0]&&-1===a.indexOf(".")&&-1===a.indexOf(",")&&-1===a.indexOf(" ")&&-1===a.indexOf(">"))b===k?n(b.getElementById(a.replace("#","")),this):n(p(a,b),this);else if("<"===a[0]&&">"===a[a.length-1]||-1!==a.indexOf("<")&&-1!==a.indexOf(">")){var c=k.createElement("div");
...
x[this[0].afmCacheId]&&x[this[0].afmCacheId][a]?x[this[0].afmCacheId][a]:!(c=this[0][a])&&a in this[0]?this[0][a]:c}for(c=0;c<this.length;c++)if(e.isObject(a))for(var d in a)e(this[c]).prop(d,a[d]);else e.isArray(b)||e.isObject(b)||e.isFunction(b)?(this[c].afmCacheId||(this[c].afmCacheId=e.uuid()),x[this[c].afmCacheId]||(x[this[c].afmCacheId]={}),x[this[c].afmCacheId][a]=b):null===b&&void 0!==b?e(this[c]).removeProp(a):(e(this[c]).removeProp(a),this[c][a]=b);return this},removeProp:function(a){for(var b=
function(b){c[d][b]&&(c[d][b]=void 0);c[d].afmCacheId&&x[c[d].afmCacheId]&&delete x[c[d].afmCacheId][a]},c=this,d=0;d<this.length;d++)a.split(/\s+/g).forEach(b);return this},remove:function(a){a=e(this).filter(a);if(a==h)return this;for(var b=0;b<a.length;b++)e.cleanUpContent(a[b],!0,!0),a[b]&&a[b].parentNode&&a[b].parentNode.removeChild(a[b]);return this},addClass:function(a){var b=function(a){f.hasClass(a,f[c])||e.push(a)};if(a==h)return this;for(var c=0;c<this.length;c++){var d=this[c].className,
...
b,c){if(a&&a.length!=h&&0===a.length)return this;if(e.isArray(a)||e.isObject(a))a=e(a);var d;b&&e(this).add(b);for(b=0;b<this.length;b++)if(a.length&&"string"!==typeof a)a=e(a),v(a,this[b],c);else{var g=X.test(a)?e(a):void 0;if(g==h||0===g.length)g=k.createTextNode(a);if(g instanceof s)for(var D=0,r=g.length;D<r;D++)d=g[D],d.nodeName!=h&&"script"===d.nodeName.toLowerCase()&&(!d.type||"text/javascript"===d.type.toLowerCase())?f.eval(d.innerHTML):v(e(d),this[b],c);else c!=h?this[b].insertBefore(g,this[b].firstChild):
...
"text/html";if(/=\?/.test(d.url))return e.jsonP(d);null===d.crossDomain&&(d.crossDomain=/^([\w-]+:)?\/\/([^\/]+)/.test(d.url)&&RegExp.$2!==f.location.host);d.crossDomain||(d.headers=e.extend({"X-Requested-With":"XMLHttpRequest"},d.headers));var h,k=d.context,r=/^([\w-]+:)\/\//.test(d.url)?RegExp.$1:f.location.protocol;b=new f.XMLHttpRequest;e.extend(b,c.promise);b.onreadystatechange=function(){var a=d.dataType;if(4===b.readyState){clearTimeout(h);var g,l=!1,t=b.getResponseHeader("content-type");if(200<=
b.status&&300>b.status||0===b.status&&"file:"===r){if("application/json"===t||"application/json"===a&&!/^\s*$/.test(b.responseText))try{g=JSON.parse(b.responseText)}catch(q){l=q}else if(-1!==t.indexOf("javascript"))try{g=b.responseText,f.eval(g)}catch(m){console.log(m)}else"application/xml, text/xml"===a?g=b.responseXML:"text/html"===a?(g=b.responseText,e.parseJS(g)):g=b.responseText;0===b.status&&0===g.length&&(l=!0);l?(d.error.call(k,b,"parsererror",l),c.reject.call(k,b,"parsererror",l)):(c.resolve.call(k,
g,"succes",b),d.success.call(k,g,"success",b))}else l=!0,c.reject.call(k,b,"error"),d.error.call(k,b,"error");d.complete.call(k,b,l?"error":"success")}};b.open(d.type,d.url,d.async);d.withCredentials&&(b.withCredentials=!0);d.contentType&&(d.headers["Content-Type"]=d.contentType);for(var l in d.headers)"string"===typeof d.headers[l]&&b.setRequestHeader(l,d.headers[l]);if(!1===d.beforeSend.call(k,b,d))return b.abort(),!1;0<d.timeout&&(h=setTimeout(function(){b.onreadystatechange=q;b.abort();d.error.call(k,
b,"timeout")},d.timeout));b.send(d.data)}catch(t){c.resolve(k,b,"error",t),d.error.call(k,b,"error",t)}return b};e.get=function(a,b){return this.ajax({url:a,success:b})};e.post=function(a,b,c,d){"function"===typeof b&&(c=b,b={});d===h&&(d="html");return this.ajax({url:a,type:"POST",data:b,dataType:d,success:c})};e.getJSON=function(a,b,c){"function"===typeof b&&(c=b,b={});return this.ajax({url:a,data:b,success:c,dataType:"json"})};e.getScript=function(a,b){if(/^([\w-]+:)?\/\/([^\/]+)/.test(a)){var c=
e.Deferred(),d=e.create("script",{async:!0,src:a}).get(0);d.onload=function(){b&&b();c.resolve.call(this,"success");e(this).remove()};d.onerror=function(){e(this).remove();c.reject.call(this,"success")};k.head.appendChild(d);return c.promise}return this.ajax({url:a,success:b,dataType:"script"})};e.param=function(a,b){var c=[];if(a instanceof s)a.each(function(){c.push((b?b+"["+this.id+"]":this.id)+"="+encodeURIComponent(this.value))});else for(var d in a)if(!e.isFunction(a[d])){var g=b?b+"["+d+"]":
d,h=a[d];c.push(e.isObject(h)?e.param(h,g):g+"="+encodeURIComponent(h))}return c.join("&")};e.parseJSON=function(a){return JSON.parse(a)};e.parseXML=function(a){if(B)MSApp.execUnsafeLocalFunction(function(){return(new DOMParser).parseFromString(a,"text/xml")});else return(new DOMParser).parseFromString(a,"text/xml")};C(e,navigator.userAgent);e.__detectUA=C;e.uuid=function(){var a=function(){return(65536*(1+Math.random())|0).toString(16).substring(1)};return a()+a()+"-"+a()+"-"+a()+"-"+a()+"-"+a()+
a()+a()};e.getCssMatrix=function(a){e.is$(a)&&(a=a.get(0));var b=f.WebKitCSSMatrix||f.MSCSSMatrix;if(a===h)return b?new b:{a:0,b:0,c:0,d:0,e:0,f:0};a=f.getComputedStyle(a);a=a.webkitTransform||a.transform||a[e.feat.cssPrefix+"Transform"];return b?new b(a):a?(b=a.replace(/[^0-9\-.,]/g,"").split(","),{a:+b[0],b:+b[1],c:+b[2],d:+b[3],e:+b[4],f:+b[5]}):{a:0,b:0,c:0,d:0,e:0,f:0}};e.create=function(a,b){var c,d=new s;if(b||"<"!==a[0]){b.html&&(b.innerHTML=b.html,delete b.html);c=k.createElement(a);for(var e in b)c[e]=
b[e];d[d.length++]=c}else c=k.createElement("div"),B?MSApp.execUnsafeLocalFunction(function(){c.innerHTML=a.trim()}):c.innerHTML=a,n(c.childNodes,d);return d};e.query=function(a,b){if(!a)return new s;b=b||k;return(new s).selector(a,b)};var w={},Q=1;e.event={add:F,remove:G};e.fn.bind=function(a,b){for(var c=0,d=this.length;c<d;c++)F(this[c],a,b);return this};e.fn.unbind=function(a,b){for(var c=0,d=this.length;c<d;c++)G(this[c],a,b);return this};e.fn.one=function(a,b){return this.each(function(c,d){F(this,
a,b,null,function(a,b){return function(){G(d,b,a);return a.apply(d,arguments)}})})};var T=function(){return!0},U=function(){return!1},S={preventDefault:"isDefaultPrevented",stopImmediatePropagation:"isImmediatePropagationStopped",stopPropagation:"isPropagationStopped"};e.fn.delegate=function(a,b,c,d){e.isFunction(c)&&(d=c,c=null);for(var g=0,h=this.length;g<h;g++)V(this[g],b,d,a,c);return this};e.fn.undelegate=function(a,b,c){for(var d=0,e=this.length;d<e;d++)G(this[d],b,c,a);return this};e.fn.on=
function(a,b,c,d){e.isFunction(c)&&(d=c,c=null);return b===h||e.isFunction(b)?this.bind(a,b):this.delegate(b,a,c,d)};e.fn.off=function(a,b,c){return b===h||e.isFunction(b)?this.unbind(a,b):this.undelegate(b,a,c)};e.fn.trigger=function(a,b,c){"string"===typeof a&&(a=e.Event(a,c));a.data=b;b=0;for(c=this.length;b<c;b++)this[b].dispatchEvent(a);return this};e.Event=function(a,b){var c=k.createEvent("Events"),d=!0;if(b)for(var e in b)"bubbles"===e?d=!!b[e]:c[e]=b[e];c.initEvent(a,d,!0,null,null,null,
null,null,null,null,null,null,null,null,null);return c};e.bind=function(a,b,c){if(a){a.__events||(a.__events={});e.isArray(b)||(b=[b]);for(var d=0;d<b.length;d++)a.__events[b[d]]||(a.__events[b[d]]=[]),a.__events[b[d]].push(c)}};e.trigger=function(a,b,c){if(a){var d=!0;if(!a.__events)return d;e.isArray(b)||(b=[b]);e.isArray(c)||(c=[]);for(var g=0;g<b.length;g++)if(a.__events[b[g]])for(var h=a.__events[b[g]].slice(0),f=0;f<h.length;f++)e.isFunction(h[f])&&!1===h[f].apply(a,c)&&(d=!1);return d}};e.unbind=
function(a,b,c){if(a.__events){e.isArray(b)||(b=[b]);for(var d=0;d<b.length;d++)if(a.__events[b[d]])for(var g=a.__events[b[d]],f=0;f<g.length;f++)if(c==h&&delete g[f],g[f]===c){g.splice(f,1);break}}};e.proxy=function(a,b,c){return function(){return c?a.apply(b,c):a.apply(b,arguments)}};var Y=function(a,b){for(var c=0;c<a.length;c++)K(a[c],b)};e.cleanUpContent=function(a,b,c){if(a){var d=a.childNodes;d&&0<d.length&&e.asap(Y,{},[L.apply(d,[0]),c]);b&&J(a,c)}};var I=[],N=[],O=[];e.asap=function(a,b,
c){if(!e.isFunction(a))throw"$.asap - argument is not a valid function";I.push(a);N.push(b?b:{});O.push(c?c:[]);f.postMessage("afm-asap","*")};f.addEventListener("message",function(a){a.source===f&&"afm-asap"===a.data&&(a.stopPropagation(),0<I.length&&I.shift().apply(N.shift(),O.shift()))},!0);var P={};e.parseJS=function(a){if(a){if("string"===typeof a){var b=k.createElement("div");B?MSApp.execUnsafeLocalFunction(function(){b.innerHTML=a}):b.innerHTML=a;a=b}var c=a.getElementsByTagName("script");
a=null;for(var d=0;d<c.length;d++)if(0<c[d].src.length&&!P[c[d].src]&&!B){var e=k.createElement("script");e.type=c[d].type;e.src=c[d].src;k.getElementsByTagName("head")[0].appendChild(e);P[c[d].src]=1;e=null}else f.eval(c[d].innerHTML)}};"click keydown keyup keypress submit load resize change select error".split(" ").forEach(function(a){e.fn[a]=function(b){return b?this.bind(a,b):this.trigger(a)}});["focus","blur"].forEach(function(a){e.fn[a]=function(b){if(0!==this.length){if(b)this.bind(a,b);else for(b=
...
f.replace(/[^0-9.-]/g,"");else return 0;return parseFloat(f)})};/*
...
*/
(function(f,v){"function"===typeof define&&define.amd?define(v):"object"===typeof exports?module.exports=v():f.ayepromise=v()})(this,function(){var f={},v=function(){var f=!1;return function(m){return function(){f||(f=!0,m.apply(null,arguments))}}},y=function(l,m){var p=f.defer(),n=function(f,l){setTimeout(function(){var m;try{m=f(l)}catch(n){p.reject(n);return}m===p.promise?p.reject(new TypeError("Cannot resolve promise with itself")):p.resolve(m)},1)};return{promise:p.promise,callFulfilled:function(f){l&&
l.call?n(l,f):p.resolve(f)},callRejected:function(f){m&&m.call?n(m,f):p.reject(f)}}};f.defer=function(){var f=0,m,p=[],n=function(r){f=1;m=r;p.forEach(function(f){f.callFulfilled(m)})},q=function(r){f=2;m=r;p.forEach(function(f){f.callRejected(m)})},C=function(r,t){var n=y(r,t);p.push(n);1===f?n.callFulfilled(m):2===f&&n.callRejected(m);return n.promise},z=function(f){var l;try{var m=f&&f.then;l=null!==f&&"object"===typeof f&&"function"===typeof m?m.bind(f):void 0}catch(p){q(p);return}if(l){f=l;l=
v();try{f(l(z),l(q))}catch(y){l(q)(y)}}else n(f)},E=v();return{resolve:E(z),reject:E(q),promise:{then:C,fail:function(f){return C(null,f)}}}};return f});(function(){$.Deferred=ayepromise.defer})(af);
