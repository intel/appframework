...
v();try{f(l(z),l(q))}catch(y){l(q)(y)}}else n(f)},E=v();return{resolve:E(z),reject:E(q),promise:{then:C,fail:function(f){return C(null,f)}}}};return f});(function(f){f.Deferred=ayepromise.defer})(af);
