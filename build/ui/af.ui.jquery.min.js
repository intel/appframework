...
c))return n.getComputedStyle(this[0],"")[c]},replaceClass:function(c,a){if(void 0==c||void 0==a)return this;var b=function(a){d=d.replace(a in k?k[a]:k[a]=RegExp("(^|\\s)"+a+"(\\s|$)")," ")},f=0;for(;f<this.length;f++)if(void 0==c)this[f].className=a;else{var d=this[f].className;c.split(/\s+/g).concat(a.split(/\s+/g)).forEach(b);d=d.trim();this[f].className=0<d.length?(d+" "+a).trim():a}return this}});l(a,navigator.userAgent);a.__detectUA=l;a.uuid=function(){var a=function(){return(65536*(1+Math.random())|
...
"scroll",[{x:-g.el.scrollLeft,y:-g.el.scrollTop}]),a.trigger(a.touchLayer,"scroll",[{x:-g.el.scrollLeft,y:-g.el.scrollTop}]))},20)};b.prototype.hideRefresh=function(c){if(!this.preventHideRefresh){var b=this,g=function(c){b.refreshContainer.style.top="-60px";b.refreshContainer.style.position="absolute";b.dY=b.cY=0;c||(b.el.style[a.feat.cssPrefix+"Transform"]="none",b.el.style[a.feat.cssPrefix+"TransitionProperty"]="none",b.el.scrollTop=0,b.logPos(b.el.scrollLeft,0),b.refreshRunning=!1,b.setRefreshContent("Pull to Refresh"),
a.trigger(b,"refresh-finish"))};!1===c||!b.afEl.css3Animate?g():b.afEl.css3Animate({y:b.el.scrollTop-b.refreshHeight+"px",x:"0%",time:"325ms",complete:g});this.refreshTriggered=!1}};b.prototype.hideScrollbars=function(){};b.prototype.scrollTo=function(a,b){this.logPos(a.x,a.y);a.x*=-1;a.y*=-1;return this._scrollTo(a,b)};b.prototype.scrollBy=function(a,b){a.x+=this.el.scrollLeft;a.y+=this.el.scrollTop;this.logPos(this.el.scrollLeft,this.el.scrollTop);return this._scrollTo(a,b)};b.prototype.scrollToBottom=
...
b},goBack:function(a){if(a=Math.min(Math.abs(~~a||1),this.history.length))a=this.history.splice(-a).shift(),this.loadContent(a.target+"",0,1,a.transition),this.transitionType=a.transition,this.updateHash(a.target)},clearHistory:function(){this.history=[];this.setBackButtonVisibility(!1)},pushHistory:function(b,f,c,e){this.history.push({target:b,transition:c});try{this.manageHistory&&(window.history.pushState(f,f,n+"#"+f+e),a(window).trigger("hashchange",null,{newUrl:n+"#"+f+e,oldUrl:n+b}))}catch(g){}},
updateHash:function(b){if(this.manageHistory){l=b=-1===b.indexOf("#")?"#"+b:b;var f=window.location.hash,c=this.getPanelId(b).substring(1);try{window.history.replaceState(c,c,n+b),a(window).trigger("hashchange",null,{newUrl:n+b,oldUrl:n+f})}catch(e){}}},getPanelId:function(a){var f=a.indexOf("/");return-1===f?a:a.substring(0,f)},updateBadge:function(b,f,c,e){void 0===c&&(c="");b=a(b);var g=b.find("span.af-badge");0===g.length?("absolute"!==b.css("position")&&b.css("position","relative"),g=a.create("span",
{className:"af-badge "+c,html:f}),b.append(g)):g.html(f);g.removeClass("tl bl br tr");g.addClass(c);void 0===e&&(e="red");a.isObject(e)?g.css(e):e&&g.css("background",e);g.data("ignore-pressed","true")},removeBadge:function(b){a(b).find("span.af-badge").remove()},toggleNavMenu:function(b){this.showNavMenu&&("none"!==a.query("#navbar").css("display")&&(void 0!==b&&!0!==b||void 0===b)?a.query("#navbar").hide():(void 0===b||void 0!==b&&!0===b)&&a.query("#navbar").show())},toggleHeaderMenu:function(b){"none"!==
a.query("#header").css("display")&&(void 0!==b&&!0!==b||void 0===b)?a.query("#header").hide():(void 0===b||void 0!==b&&!0===b)&&a.query("#header").show()},toggleAsideMenu:function(){this.toggleRightSideMenu.apply(this,arguments)},toggleRightSideMenu:function(a,f,c){if(this.isAsideMenuEnabled())return this.toggleLeftSideMenu(a,f,c,!0)},toggleLeftSideMenu:function(b,f,c,e){if(!(!this.isSideMenuEnabled()&&!this.isAsideMenuEnabled()||this.togglingSideMenu))if(e||this.isSideMenuEnabled())if(e||!(a.ui.splitview&&
window.innerWidth>=a.ui.handheldMinWidth)){var g=this,d=a.query("#menu"),h=a.query("#aside_menu"),k=a.query("#content,  #header, #navbar"),l=a.query(".afui_panel_mask");c=c||this.transitionTime;var m=this.isSideMenuOn(),n=e?"-"+numOnly(h.css("width")):numOnly(d.css("width"));0===l.length&&window.innerWidth<a.ui.handheldMinWidth&&(k.append("<div class='afui_panel_mask'></div>"),l=a.query(".afui_panel_mask"),a(".afui_panel_mask").bind("click",function(){a.ui.toggleSideMenu(!1,null,null,e)}));var q=
this.getSideMenuPosition();m&&!e&&0>q?m=!1:m&&(e&&0<q)&&(m=!1);if(2===b||!m&&(void 0!==b&&!1!==b||void 0===b))this.togglingSideMenu=!0,e?h.show():d.show(),g.css3animate(k,{x:n,time:c,complete:function(b){g.togglingSideMenu=!1;k.vendorCss("Transition","");f&&f(b);0!==l.length&&window.innerWidth<a.ui.handheldMinWidth&&l.show()}});else if(void 0===b||void 0!==b&&!1===b)this.togglingSideMenu=!0,g.css3animate(k,{x:"0px",time:c,complete:function(b){k.vendorCss("Transition","");k.vendorCss("Transform","");
g.togglingSideMenu=!1;f&&f(b);a.ui.splitview||d.hide();h.hide();0!==l.length&&window.innerWidth<a.ui.handheldMinWidth&&l.hide()}})}},toggleSideMenu:function(){this.toggleLeftSideMenu.apply(this,arguments)},disableSideMenu:function(){this.disableLeftSideMenu()},disableLeftSideMenu:function(){var b=a.query("#content, #header, #navbar");this.isSideMenuOn()?this.toggleSideMenu(!1,function(a){a||b.removeClass("hasMenu")}):b.removeClass("hasMenu")},enableLeftSideMenu:function(){a.query("#content, #header, #navbar").addClass("hasMenu")},
...
a.query("#header .backButton").css("visibility","visible"):a.query("#header .backButton").css("visibility","hidden")},showMask:function(b){b||(b=this.loadingText||"");a.query("#afui_mask>h1").html(b);a.query("#afui_mask").show()},hideMask:function(){a.query("#afui_mask").hide()},modalReference_:null,showModal:function(b,f){this.modalTransition=f||"up";var c=a.query("#modalContainer");"string"===typeof b&&(b="#"+b.replace("#",""));var e=a.query(b);this.modalReference_=e;var g=a.query("#afui_modal");
if(e.length){var d=this.scrollingDivs.hasOwnProperty(e.attr("id")),h;a.feat.nativeTouchScroll||a.os.desktop||!d?(h=e.contents(),c.append(h)):(h=a(e.get(0).childNodes[0]).contents(),c.children().eq(0).append(h));this.runTransition(this.modalTransition,this.modalTransContainer,this.modalWindow,!1);a(this.modalWindow).css("display","");a(this.modalWindow).addClass("display","flexContainer");d?this.scrollingDivs.modal_container.enable(this.resetScrollers):this.scrollingDivs.modal_container.disable();
c.addClass("panel").show();"none"===e.data("header")?g.find("#modalHeader").hide():0<h.filter("header").length?g.find("#modalHeader").append(h.filter("header")).show():g.find("#modalHeader").append(a.create("header",{}).append(a.create("h1",{html:e.data("title")}).get(0)).append(a.create("a",{className:"button icon close"}).attr("onclick","$.ui.hideModal()").get(0))).show();if("none"===e.data("footer"))g.find("#modalFooter").hide();else if(0<h.filter("footer").length){g.find("#modalFooter").append(h.filter("footer")).show();
...
"true");if(b.getAttribute("js-scrolling")&&("yes"===b.getAttribute("js-scrolling").toLowerCase()||"true"===b.getAttribute("js-scrolling").toLowerCase()))h=g=!0;d=b.getAttribute("data-title")||b.title;b.title="";b.setAttribute("data-title",d);if(a(b).hasClass("no-scroll")||b.getAttribute("scrolling")&&"no"===b.getAttribute("scrolling"))g=h=!1,b.removeAttribute("js-scrolling");g?(d=b,e.appendChild(b),!1!==this.selectBox&&this.selectBox.getOldSelects(d.id),!1!==this.passwordBox&&this.passwordBox.getOldPasswords(d.id)):
(e.appendChild(b),d=b,b.style["-webkit-overflow-scrolling"]="none");h&&(this.scrollingDivs[d.id]=a(b).scroller({scrollBars:!0,verticalScroll:!0,horizontalScroll:this.horizontalScroll,vScrollCSS:"afScrollbar",refresh:f,useJsScroll:g,lockBounce:this.lockPageBounce,autoEnable:!1}),a(b).addClass("y-scroll"),this.horizontalScroll&&a(b).addClass("x-scroll"),c&&a.bind(this.scrollingDivs[d.id],"refresh-release",function(a){a&&c()}),g&&a(b).children().eq(0).addClass("afScrollPanel"));return d.id},scrollToTop:function(a,
f){f=f||"300ms";a=a.replace("#","");this.scrollingDivs[a]&&this.scrollingDivs[a].scrollToTop(f)},scrollToBottom:function(a,f){a=a.replace("#","");this.scrollingDivs[a]&&this.scrollingDivs[a].scrollToBottom(f)},parsePanelFunctions:function(b,f,c){var e=b.getAttribute("data-footer"),d=b.getAttribute("data-header");e&&"none"===e.toLowerCase()?(this.toggleNavMenu(!1),e=!1):this.toggleNavMenu(!0);e&&this.customFooter!==e?(this.customFooter=e,this.updateNavbarElements(e)):e!==this.customFooter&&(this.customFooter&&
this.updateNavbarElements(this.defaultFooter),this.customFooter=!1);d&&"none"===d.toLowerCase()?(this.toggleHeaderMenu(!1),d=!1):this.toggleHeaderMenu(!0);d&&this.customHeader!==d?(this.customHeader=d,this.updateHeaderElements(d,c)):d!==this.customHeader&&(this.customHeader&&this.updateHeaderElements(this.defaultHeader,c),this.customHeader=!1);e=a(b).find("footer");0<e.length&&(this.customFooter=b.id,e.data("parent",b.id),this.updateNavbarElements(e));e=a(b).find("header");0<e.length&&(this.customHeader=
...
this.activeDiv.id&&b===this.ajaxUrl)){var k="url"+h(b),l=this;-1===b.indexOf("http")&&(b=intel.xdk.webRoot+b);var m=new XMLHttpRequest;g&&"object"!==typeof g&&(g=document.createElement("a"),g.setAttribute("data-persist-ajax",!0));g=g||document.createElement("a");m.onreadystatechange=function(){if(4===m.readyState&&200===m.status){this.doingTransition=!1;var h,n=!1;h=a.query("#"+k);if(0<h.length)l.updatePanel(k,m.responseText),h.get(0).setAttribute("data-title",g.title?g.title:b);else if(g.getAttribute("data-persist-ajax")||
l.isAjaxApp){var q="true"===g.getAttribute("data-pull-scroller")?!0:!1;h=q?function(){g.refresh=!0;l.loadContent(b,f,c,d,g);g.refresh=!1}:null;var r=a(m.responseText);r.hasClass("panel")?(k=r.attr("id"),r=r.get(0).innerHTML):r=r.html();0<a("#"+k).length?l.updatePanel("#"+k,r):0<a("div.panel[data-crc='"+k+"']").length?(l.updatePanel(a("div.panel[data-crc='"+k+"']").get(0).id,r),k=a("div.panel[data-crc='"+k+"']").get(0).id):k=l.addContentDiv(k,m.responseText,g.title?g.title:b,q,h)}else l.updatePanel("afui_ajax",
m.responseText),a.query("#afui_ajax").attr("data-title",g.title?g.title:b),l.loadContent("#afui_ajax",f,c,d),n=!0;h=document.createElement("div");a(h).html(m.responseText);l.parseScriptTags(h);if(n)l.showLoading&&l.hideMask();else return l.loadContent("#"+k,f,c,d),l.showLoading&&l.hideMask(),null}else 4===m.readyState&&a.ui.hideMask()};this.ajaxUrl=b;var n=this.useAjaxCacheBuster?b+(b.split("?")[1]?"&":"?")+"cache="+1E16*Math.random():b;m.open("GET",n,!0);m.setRequestHeader("X-Requested-With","XMLHttpRequest");
...
this.modalWindow=c;for(var d={},c=this.viewportContainer.get(0).querySelectorAll(".panel"),g=0;g<c.length;g++){var h=c[g],n=h,v=h.previousSibling;h.parentNode&&"content"!==h.parentNode.id?(n.getAttribute("selected")&&(this.firstDiv=h),this.addDivAndScroll(n),a.query("#content").append(h)):h.parsedContent||(h.parsedContent=1,n.getAttribute("selected")&&(this.firstDiv=h),this.addDivAndScroll(h),a(h).insertAfter(v));h.getAttribute("data-defer")&&(d[h.id]=h.getAttribute("data-defer"));this.firstDiv||
(this.firstDiv=h);h=null}var c=null,s=!1,u=Object.keys(d).length,c=function(c){a.ajax({url:intel.xdk.webRoot+d[c],success:function(d){0<d.length&&(b.updatePanel(c,d),b.parseScriptTags(a.query("#"+c).get(0)));t++;t>=u&&(s=!1,a(document).trigger("defer:loaded"))},error:function(){console.log("Error with deferred load "+intel.xdk.webRoot+d[c]);t++;t>=u&&(s=!1,a(document).trigger("defer:loaded"))}})};if(0<u){var s=!0,t=0,q;for(q in d)c(q)}if(this.firstDiv)if(this.activeDiv=this.firstDiv,this.scrollingDivs[this.activeDiv.id]&&
