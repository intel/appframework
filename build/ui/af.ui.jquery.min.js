...
this.activeDiv.id&&b===this.ajaxUrl)){var k="url"+h(b),l=this;-1===b.indexOf("http")&&(b=intel.xdk.webRoot+b);var m=new XMLHttpRequest;d&&"object"!==typeof d&&(d=document.createElement("a"),d.setAttribute("data-persist-ajax",!0));d=d||document.createElement("a");m.onreadystatechange=function(){if(4===m.readyState&&200===m.status){this.doingTransition=!1;var h,n=!1;h=a.query("#"+k);var q=[];if(0<h.length)l.updatePanel(k,m.responseText),h.get(0).setAttribute("data-title",d.title?d.title:b);else if(d.getAttribute("data-persist-ajax")||
l.isAjaxApp){var v="true"===d.getAttribute("data-pull-scroller")?!0:!1;h=v?function(){d.refresh=!0;l.loadContent(b,f,c,e,d);d.refresh=!1}:null;var r=a(m.responseText);r.hasClass("panel")?(q=r.get(0).className,k=r.attr("id"),r=r.get(0).innerHTML):(q=r.className,r=r.html());0<a("#"+k).length?l.updatePanel("#"+k,r):0<a("div.panel[data-crc='"+k+"']").length?(l.updatePanel(a("div.panel[data-crc='"+k+"']").get(0).id,r),k=a("div.panel[data-crc='"+k+"']").get(0).id):k=l.addContentDiv(k,m.responseText,d.title?
d.title:b,v,h)}else l.updatePanel("afui_ajax",m.responseText),a.query("#afui_ajax").attr("data-title",d.title?d.title:b),l.loadContent("#afui_ajax",f,c,e),n=!0;h=document.createElement("div");a(h).html(m.responseText);l.parseScriptTags(h);if(n)l.showLoading&&l.hideMask();else{if(q){n=q.split(" ");for(q=0;q<n.length;q++)"panel"!==n[q].trim()&&a("#"+k).addClass(n[q])}l.loadContent("#"+k,f,c,e);l.showLoading&&l.hideMask();return null}}else 4===m.readyState&&a.ui.hideMask()};this.ajaxUrl=b;var n=this.useAjaxCacheBuster?
b+(b.split("?")[1]?"&":"?")+"cache="+1E16*Math.random():b;m.open("GET",n,!0);m.setRequestHeader("X-Requested-With","XMLHttpRequest");m.send();this.showLoading&&this.showMask()}},runTransition:function(a,f,c,e){this.availableTransitions[a]||(a="default");"none"===f.style.display&&(f.style.display="block");"none"===c.style.display&&(c.style.display="block");this.availableTransitions[a].call(this,f,c,e)},launch:function(){if(!1===this.hasLaunched||this.launchCompleted)this.hasLaunched=!0;else{if(this.isLaunching)return!0;
this.isLaunching=!0;var b=this;this.viewportContainer=af.query("#afui");this.navbar=af.query("#navbar").get(0);this.content=af.query("#content").get(0);this.header=af.query("#header").get(0);this.menu=af.query("#menu").get(0);this.viewportContainer.on("click","a",function(a){b.useInternalRouting&&k(a,a.currentTarget)});var f=null;a.bind(a.touchLayer,"enter-edit",function(a){f=a});a.os.android&&(a.bind(a.touchLayer,"enter-edit-reshape",function(){var c=a(f),d=c.closest(b.activeDiv);if(d&&0<d.size())if(a.os.androidICS){var e=
b.scrollingDivs[b.activeDiv.id],g=e.scrollTop;e.scrollBy({x:0,y:(c.offset().top-d.offset().top+g)/2})}else if(a.os.android||a.os.blackberry)e=c.offset(),d=d.offset(),e.bottom>d.bottom&&e.height<d.height&&b.scrollingDivs[b.activeDiv.id].scrollToItem(c,"bottom")}),a.bind(a.touchLayer,"exit-edit-reshape",function(){b.activeDiv&&(b.activeDiv.id&&b.scrollingDivs.hasOwnProperty(b.activeDiv.id))&&b.scrollingDivs[b.activeDiv.id].setPaddings(0,0)}));this.navbar||(this.navbar=a.create("div",{id:"navbar"}).get(0),
...
this.modalTransContainer=a.create("div",{id:"modalTransContainer"}).appendTo(c).get(0);this.viewportContainer.append(c);this.scrollingDivs.modal_container=a.query("#modalContainer").scroller({scrollBars:!0,vertical:!0,vScrollCSS:"afScrollbar",lockBounce:this.lockPageBounce});this.modalWindow=c;for(var e={},c=this.viewportContainer.get(0).querySelectorAll(".panel"),d=0;d<c.length;d++){var h=c[d],n=h,w=h.previousSibling;h.parentNode&&"content"!==h.parentNode.id?(n.getAttribute("selected")&&(this.firstDiv=
h),this.addDivAndScroll(n),a.query("#content").append(h)):h.parsedContent||(h.parsedContent=1,n.getAttribute("selected")&&(this.firstDiv=h),this.addDivAndScroll(h),a(h).insertAfter(w));h.getAttribute("data-defer")&&(e[h.id]=h.getAttribute("data-defer"));this.firstDiv||(this.firstDiv=h);h=null}var c=null,s=!1,u=Object.keys(e).length,c=function(c){a.ajax({url:intel.xdk.webRoot+e[c],success:function(d){0<d.length&&(b.updatePanel(c,d),b.parseScriptTags(a.query("#"+c).get(0)));t++;t>=u&&(s=!1,a(document).trigger("defer:loaded"))},
error:function(){console.log("Error with deferred load "+intel.xdk.webRoot+e[c]);t++;t>=u&&(s=!1,a(document).trigger("defer:loaded"))}})};if(0<u){var s=!0,t=0,q;for(q in e)c(q)}if(this.firstDiv)if(this.activeDiv=this.firstDiv,this.scrollingDivs[this.activeDiv.id]&&this.scrollingDivs[this.activeDiv.id].enable(),q=function(){a.query("#navbar").append(a.create("footer",{id:"defaultNav"}).append(a.query("#navbar").children()));b.defaultFooter="defaultNav";b.prevFooter=a.query("#defaultNav");b.updateNavbarElements(b.prevFooter);
...
a.query("#afui #menu").addClass("tabletMenu");a.ui.splitview&&window.innerWidth>parseInt(a.ui.handheldMinWidth,10)&&(a.ui.sideMenuWidth=a("#menu").css("width")+"px");var c=b.getPanelId(m),d=null!==c&&c==="#"+b.firstDiv.id;0<c.length&&b.loadDefaultHash&&!d?b.loadContent(m,!0,!1,"none"):(l="#"+b.firstDiv.id,b.firstDiv.style.display="block",b.parsePanelFunctions(b.firstDiv),b.loadContentData(b.firstDiv),a.query("#header .backButton").css("visibility","hidden"),("true"===b.firstDiv.getAttribute("data-modal")||
"true"===b.firstDiv.getAttribute("modal"))&&b.showModal(b.firstDiv.id));b.launchCompleted=!0;a.query("#afui #splashscreen").remove();a.os.fennec?a(document).trigger("afui:ready"):setTimeout(function(){a(document).trigger("afui:ready")})},s)a(document).one("defer:loaded",q);else q();else setTimeout(function(){a(document).trigger("afui:ready")});a.bind(b,"content-loaded",function(){if(0<b.loadContentQueue.length){var a=b.loadContentQueue.splice(0,1)[0];b.loadContent(a[0],a[1],a[2],a[3],a[4])}});(window.navigator.standalone||
this.isIntel)&&this.blockPageScroll();this.enableTabBar();this.topClickScroll()}},topClickScroll:function(){var a=this;document.getElementById("header").addEventListener("click",function(d){15>=d.clientY&&"h1"===d.target.nodeName.toLowerCase()&&a.scrollingDivs[a.activeDiv.id].scrollToTop("100")})},blockPageScroll:function(){a.query("#afui #header").bind("touchmove",function(a){a.preventDefault()})},noTransition:function(a,d){d.style.display="block";a.style.display="block";this.clearAnimations(d);
this.css3animate(a,{x:"0%",y:0});this.finishTransition(a);d.style.zIndex=2;a.style.zIndex=1},finishTransition:function(b,d){b.style.display="none";this.doingTransition=!1;b&&a(b).trigger("unloadpanelcomplete");d&&a(d).trigger("loadpanelcomplete");d&&this.clearAnimations(d);b&&this.clearAnimations(b);a.trigger(this,"content-loaded")},clearAnimations:function(b){b.style[a.feat.cssPrefix+"Transform"]="none";b.style[a.feat.cssPrefix+"Transition"]="none"}};var k=function(b,d){var c=document.getElementById("afui");
if(d!==c){if("a"!==d.tagName.toLowerCase()&&d.parentNode)return k(b,d.parentNode);if("undefined"!==d.tagName&&"a"===d.tagName.toLowerCase()){if(!1!==("function"===typeof a.ui.customClickHandler?a.ui.customClickHandler:!1)&&a.ui.customClickHandler(d,b))return b.preventDefault();if(!(-1!==d.href.toLowerCase().indexOf("javascript:")||d.getAttribute("data-ignore")))if(-1===d.hash.indexOf("#")&&0<d.target.length)0!==d.href.toLowerCase().indexOf("javascript:")&&(a.ui.isIntel?(b.preventDefault(),intel.xdk.device.launchExternal(d.href)):
a.os.desktop||(b.target.target="_blank"));else{var c=d.href,e=location.protocol+"//"+location.hostname+":"+location.port+location.pathname;0===c.indexOf(e)&&(c=c.substring(e.length));if("#"===c||c.indexOf("#")===c.length-1||0===c.length&&0===d.hash.length)return b.preventDefault();e=/^((http|https|file):\/\/)/;-1!==d.href.indexOf(":")&&e.test(d.href)&&b.preventDefault();var e=d.getAttribute("data-transition"),g=d.getAttribute("data-resetHistory"),g=g&&"true"===g.toLowerCase()?!0:!1,c=0<d.hash.length?
d.hash:c;a.ui.loadContent(c,g,0,e,d)}}}},h=function(a,d){void 0===d&&(d=0);var c=0,c=0;d^=-1;for(var e=0,g=a.length;e<g;e++)c=(d^a.charCodeAt(e))&255,c="0x"+"00000000 77073096 EE0E612C 990951BA 076DC419 706AF48F E963A535 9E6495A3 0EDB8832 79DCB8A4 E0D5E91E 97D2D988 09B64C2B 7EB17CBD E7B82D07 90BF1D91 1DB71064 6AB020F2 F3B97148 84BE41DE 1ADAD47D 6DDDE4EB F4D4B551 83D385C7 136C9856 646BA8C0 FD62F97A 8A65C9EC 14015C4F 63066CD9 FA0F3D63 8D080DF5 3B6E20C8 4C69105E D56041E4 A2677172 3C03E4D1 4B04D447 D20D85F