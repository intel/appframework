...
this.scrollingDivs[this.activeDiv.id].enable(this.resetScrollers)},loadAjax:function(b,f,c,e,d){if(!("afui_ajax"===this.activeDiv.id&&b===this.ajaxUrl)){var k="url"+h(b),l=this;-1===b.indexOf("http")&&(b=intel.xdk.webRoot+b);var m=new XMLHttpRequest;d&&"object"!==typeof d&&(d=document.createElement("a"),d.setAttribute("data-persist-ajax",!0));d=d||document.createElement("a");m.onreadystatechange=function(){if(4===m.readyState&&200===m.status){this.doingTransition=!1;var h,n=!1;h=a.query("#"+k);var q=
"",t=function(a){(a=l.scrollingDivs[a])&&a.refresh&&a.hideRefresh()};if(0<h.length)t(k),l.updatePanel(k,m.responseText),h.get(0).setAttribute("data-title",d.title?d.title:b);else if(d.getAttribute("data-persist-ajax")||l.isAjaxApp){var w="true"===d.getAttribute("data-pull-scroller")?!0:!1;h=w?function(){setTimeout(function(){d.refresh=!0;l.loadContent(b,f,c,e,d);d.refresh=!1},500)}:null;var r=a(m.responseText);r.hasClass("panel")?(q=r.get(0).className,k=r.attr("id"),r=r.get(0).innerHTML):(q=r.className,
r=r.html());t(k);0<a("#"+k).length?l.updatePanel("#"+k,r):0<a("div.panel[data-crc='"+k+"']").length?(l.updatePanel(a("div.panel[data-crc='"+k+"']").get(0).id,r),k=a("div.panel[data-crc='"+k+"']").get(0).id):k=l.addContentDiv(k,m.responseText,d.title?d.title:b,w,h)}else l.updatePanel("afui_ajax",m.responseText),a.query("#afui_ajax").attr("data-title",d.title?d.title:b),l.loadContent("#afui_ajax",f,c,e),n=!0;t=document.createElement("div");a(t).html(m.responseText);l.parseScriptTags(t);if(n)l.showLoading&&
l.hideMask();else{if(q){n=q.split(" ");for(q=0;q<n.length;q++)"panel"!==n[q].trim()&&a("#"+k).addClass(n[q])}l.loadContent("#"+k,f,c,e);l.showLoading&&l.hideMask();return null}}else 4===m.readyState&&a.ui.hideMask()};this.ajaxUrl=b;var n=this.useAjaxCacheBuster?b+(b.split("?")[1]?"&":"?")+"cache="+1E16*Math.random():b;m.open("GET",n,!0);m.setRequestHeader("X-Requested-With","XMLHttpRequest");m.send();this.showLoading&&this.showMask()}},runTransition:function(a,f,c,e){this.availableTransitions[a]||
(a="default");"none"===f.style.display&&(f.style.display="block");"none"===c.style.display&&(c.style.display="block");this.availableTransitions[a].call(this,f,c,e)},launch:function(){if(!1===this.hasLaunched||this.launchCompleted)this.hasLaunched=!0;else{if(this.isLaunching)return!0;this.isLaunching=!0;var b=this;this.viewportContainer=af.query("#afui");this.navbar=af.query("#navbar").get(0);this.content=af.query("#content").get(0);this.header=af.query("#header").get(0);this.menu=af.query("#menu").get(0);
this.viewportContainer.on("click","a",function(a){b.useInternalRouting&&k(a,a.currentTarget)});var f=null;a.bind(a.touchLayer,"enter-edit",function(a){f=a});a.os.android&&(a.bind(a.touchLayer,"enter-edit-reshape",function(){var c=a(f),d=c.closest(b.activeDiv);if(d&&0<d.size())if(a.os.androidICS){var e=b.scrollingDivs[b.activeDiv.id],g=e.scrollTop;e.scrollBy({x:0,y:(c.offset().top-d.offset().top+g)/2})}else if(a.os.android||a.os.blackberry)e=c.offset(),d=d.offset(),e.bottom>d.bottom&&e.height<d.height&&
...
vertical:!0,vScrollCSS:"afScrollbar",lockBounce:this.lockPageBounce});this.modalWindow=c;for(var e={},c=this.viewportContainer.get(0).querySelectorAll(".panel"),d=0;d<c.length;d++){var h=c[d],n=h,x=h.previousSibling;h.parentNode&&"content"!==h.parentNode.id?(n.getAttribute("selected")&&(this.firstDiv=h),this.addDivAndScroll(n),a.query("#content").append(h)):h.parsedContent||(h.parsedContent=1,n.getAttribute("selected")&&(this.firstDiv=h),this.addDivAndScroll(h),a(h).insertAfter(x));h.getAttribute("data-defer")&&
(e[h.id]=h.getAttribute("data-defer"));this.firstDiv||(this.firstDiv=h);h=null}var c=null,s=!1,v=Object.keys(e).length,c=function(c){a.ajax({url:intel.xdk.webRoot+e[c],success:function(d){0<d.length&&(b.updatePanel(c,d),b.parseScriptTags(a.query("#"+c).get(0)));u++;u>=v&&(s=!1,a(document).trigger("defer:loaded"))},error:function(){console.log("Error with deferred load "+intel.xdk.webRoot+e[c]);u++;u>=v&&(s=!1,a(document).trigger("defer:loaded"))}})};if(0<v){var s=!0,u=0,q;for(q in e)c(q)}if(this.firstDiv)if(this.activeDiv=
this.firstDiv,this.scrollingDivs[this.activeDiv.id]&&this.scrollingDivs[this.activeDiv.id].enable(),q=function(){a.query("#navbar").append(a.create("footer",{id:"defaultNav"}).append(a.query("#navbar").children()));b.defaultFooter="defaultNav";b.prevFooter=a.query("#defaultNav");b.updateNavbarElements(b.prevFooter);var c=a.query("nav").get(0);c&&(b.defaultMenu=a(c),b.updateSideMenuElements(b.defaultMenu),b.prevMenu=b.defaultMenu);if(c=a.query("aside").get(0))b.defaultAside=a(c),b.updateAsideElements(b.defaultAside),
...
"px");var c=b.getPanelId(m),d=null!==c&&c==="#"+b.firstDiv.id;0<c.length&&b.loadDefaultHash&&!d?b.loadContent(m,!0,!1,"none"):(l="#"+b.firstDiv.id,b.firstDiv.style.display="block",b.parsePanelFunctions(b.firstDiv),b.loadContentData(b.firstDiv),a.query("#header .backButton").css("visibility","hidden"),("true"===b.firstDiv.getAttribute("data-modal")||"true"===b.firstDiv.getAttribute("modal"))&&b.showModal(b.firstDiv.id));b.launchCompleted=!0;a.query("#afui #splashscreen").remove();a.os.fennec?a(document).trigger("afui:ready"):
setTimeout(function(){a(document).trigger("afui:ready")})},s)a(document).one("defer:loaded",q);else q();else setTimeout(function(){a(document).trigger("afui:ready")});a.bind(b,"content-loaded",function(){if(0<b.loadContentQueue.length){var a=b.loadContentQueue.splice(0,1)[0];b.loadContent(a[0],a[1],a[2],a[3],a[4])}});(window.navigator.standalone||this.isIntel)&&this.blockPageScroll();this.enableTabBar();this.topClickScroll()}},topClickScroll:function(){var a=this;document.getElementById("header").addEventListener("click",
function(d){15>=d.clientY&&"h1"===d.target.nodeName.toLowerCase()&&a.scrollingDivs[a.activeDiv.id].scrollToTop("100")})},blockPageScroll:function(){a.query("#afui #header").bind("touchmove",function(a){a.preventDefault()})},noTransition:function(a,d){d.style.display="block";a.style.display="block";this.clearAnimations(d);this.css3animate(a,{x:"0%",y:0});this.finishTransition(a);d.style.zIndex=2;a.style.zIndex=1},finishTransition:function(b,d){b.style.display="none";this.doingTransition=!1;b&&a(b).trigger("unloadpanelcomplete");
