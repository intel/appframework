...
(function(a){var p=window.location.pathname+window.location.search,m=window.location.hash,l=m,g=function(){function b(){e.useOSThemes&&(a("#afui").removeClass("ios ios7 win8 tizen bb android light dark"),a.os.android?a("#afui").addClass("android"):a.os.ie?a("#afui").addClass("win8"):a.os.blackberry||a.os.blackberry10||a.os.playbook?(a("#afui").addClass("bb"),e.backButtonText="Back"):a.os.ios7?(a("#afui").addClass("ios7"),e.overlayStatusbar&&e.ready(function(){a(".header").addClass("overlayStatusbar")})):
