...
f.test(a.ns))&&(!b||a.fn===b||"function"===typeof a.fn&&"function"===typeof b&&a.fn===b)&&(!e||a.sel===e)})}function p(a){a=(""+a).split(".");return{e:a[0],ns:a.slice(1).sort().join(" ")}}function t(a){return RegExp("(?:^| )"+a.replace(" "," .* ?")+"(?: |$)")}function J(a,c,d){m.isObject(a)?m.each(a,d):a.split(/\s/).forEach(function(a){d(a,c)})}function y(a,d,b,e,f){var h=c(a),g=x[h]||(x[h]=[]);J(d,b,function(c,d){var b=f&&f(d,c),D=b||d,I=function(c){if(!c.ns||t(c.ns).test(h.ns)){var d=D.apply(a,
[c].concat(c.data));!1===d&&c.preventDefault();return d}},h=m.extend(p(c),{fn:d,proxy:I,sel:e,del:b,i:g.length});g.push(h);a.addEventListener(h.e,I,!1)})}function u(a,b,p,e){var f=c(a);J(b||"",p,function(c,b){d(a,c,b,e).forEach(function(c){delete x[f][c.i];a.removeEventListener(c.e,c.proxy,!1)})})}function E(a){var c=m.extend({originalEvent:a},a);m.each(R,function(d,b){c[d]=function(){this[b]=S;if("stopImmediatePropagation"===d||"stopPropagation"===d)if(a.cancelBubble=!0,!a[d])return;return a[d].apply(a,
arguments)};c[b]=T});return c}function z(a,c,d,b,p){y(a,c,d,b,function(c){return function(d){var e,D=m(d.target).closest(b,a).get(0);if(D)return e=m.extend(E(d),{currentTarget:D,liveFired:a,delegateTarget:a,data:p}),c.apply(D,[e].concat([].slice.call(arguments,1)))}})}function s(a,d){if(d&&a.dispatchEvent){var b=m.Event("destroy",{bubbles:!1});a.dispatchEvent(b)}if((b=c(a))&&x[b]){for(var p in x[b])a.removeEventListener(x[b][p].e,x[b][p].proxy,!1);delete x[b]}}function F(a,c){if(a){var d=a.childNodes;
if(d&&0<d.length)for(var b=0;b<d.length;b++)F(d[b],c);s(a,c)}}var q,r=a.document,A=[],K=A.slice,G={},U=1,V=/<(\w+)[^>]*>/,w={},B={},L={columncount:!0,fontweight:!0,lineheight:!0,"column-count":!0,"font-weight":!0,"line-height":!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,"z-index":!0,zoom:!0},C="object"===typeof MSApp,v=function(a,c){this.length=0;if(a){if(a instanceof v&&c==q)return a;if(af.isFunction(a))return af(r).ready(a);if(af.isArray(a)&&a.length!=q){for(var d=0;d<a.length;d++)this[this.length++]=
...
c[d]});return a};m.isArray=function(a){return a instanceof Array&&a.push!=q};m.isFunction=function(a){return"function"===typeof a&&!(a instanceof RegExp)};m.isObject=function(a){return"object"===typeof a&&null!==a};m.fn=v.prototype={namespace:"appframework",constructor:v,forEach:A.forEach,reduce:A.reduce,push:A.push,indexOf:A.indexOf,concat:A.concat,selector:function(a,c){a=a.trim();if("#"===a[0]&&-1===a.indexOf(".")&&-1===a.indexOf(",")&&-1===a.indexOf(" ")&&-1===a.indexOf(">"))c===r?g(c.getElementById(a.replace("#",
"")),this):g(h(a,c),this);else if("<"===a[0]&&">"===a[a.length-1]||-1!==a.indexOf("<")&&-1!==a.indexOf(">")){var d=r.createElement("div");C?MSApp.execUnsafeLocalFunction(function(){d.innerHTML=a.trim()}):d.innerHTML=a.trim();g(d.childNodes,this)}else g(h(a,c),this);return this},oldElement:void 0,sort:A.sort,slice:A.slice,length:0,setupOld:function(a){if(a==q)return m();a.oldElement=this;return a},map:function(a){var c,d=[],b;for(b=0;b<this.length;b++)c=a.apply(this[b],[b,this[b]]),c!==q&&d.push(c);
...
this;if(c===q&&!m.isObject(a)){var d;return this[0].afmCacheId&&B[this[0].afmCacheId]&&B[this[0].afmCacheId][a]?B[this[0].afmCacheId][a]:!(d=this[0][a])&&a in this[0]?this[0][a]:d}for(d=0;d<this.length;d++)if(m.isObject(a))for(var b in a)m(this[d]).prop(b,a[b]);else m.isArray(c)||m.isObject(c)||m.isFunction(c)?(this[d].afmCacheId||(this[d].afmCacheId=m.uuid()),B[this[d].afmCacheId]||(B[this[d].afmCacheId]={}),B[this[d].afmCacheId][a]=c):null===c&&void 0!==c?m(this[d]).removeProp(a):(m(this[d]).removeProp(a),
this[d][a]=c);return this},removeProp:function(a){for(var c=function(c){d[b][c]&&(d[b][c]=void 0);d[b].afmCacheId&&B[d[b].afmCacheId]&&delete B[d[b].afmCacheId][a]},d=this,b=0;b<this.length;b++)a.split(/\s+/g).forEach(c);return this},remove:function(a){a=m(this).filter(a);if(a==q)return this;for(var c=0;c<a.length;c++)m.cleanUpContent(a[c],!0,!0),a[c]&&a[c].parentNode&&a[c].parentNode.removeChild(a[c]);return this},addClass:function(a){var c=function(a){e.hasClass(a,e[d])||p.push(a)};if(a==q)return this;
...
m.proxy=function(a,c,d){return function(){return d?a.apply(c,d):a.apply(c,arguments)}};var W=function(a,c){for(var d=0;d<a.length;d++)F(a[d],c)};m.cleanUpContent=function(a,c,d){if(a){var b=a.childNodes;b&&0<b.length&&m.asap(W,{},[K.apply(b,[0]),d]);c&&s(a,d)}};var H=[],M=[],N=[];m.asap=function(c,d,b){if(!m.isFunction(c))throw"$.asap - argument is not a valid function";H.push(c);M.push(d?d:{});N.push(b?b:[]);a.postMessage("afm-asap","*")};a.addEventListener("message",function(c){c.source===a&&"afm-asap"===
c.data&&(c.stopPropagation(),0<H.length&&H.shift().apply(M.shift(),N.shift()))},!0);var O={};m.parseJS=function(c){if(c){if("string"===typeof c){var d=r.createElement("div");C?MSApp.execUnsafeLocalFunction(function(){d.innerHTML=c}):d.innerHTML=c;c=d}var b=c.getElementsByTagName("script");c=null;for(var e=0;e<b.length;e++)if(0<b[e].src.length&&!O[b[e].src]&&!C){var p=r.createElement("script");p.type=b[e].type;p.src=b[e].src;r.getElementsByTagName("head")[0].appendChild(p);O[b[e].src]=1;p=null}else a.eval(b[e].innerHTML)}};
...
this.activeDiv.id&&b===this.ajaxUrl)){var h="url"+g(b),k=this;-1===b.indexOf("http")&&(b=intel.xdk.webRoot+b);var l=new XMLHttpRequest;f&&"object"!==typeof f&&(f=document.createElement("a"),f.setAttribute("data-persist-ajax",!0));f=f||document.createElement("a");l.onreadystatechange=function(){if(4===l.readyState&&200===l.status){this.doingTransition=!1;var g,n=!1;g=a.query("#"+h);var s=[];if(0<g.length)k.updatePanel(h,l.responseText),g.get(0).setAttribute("data-title",f.title?f.title:b);else if(f.getAttribute("data-persist-ajax")||
k.isAjaxApp){var F="true"===f.getAttribute("data-pull-scroller")?!0:!1;g=F?function(){f.refresh=!0;k.loadContent(b,e,c,d,f);f.refresh=!1}:null;var q=a(l.responseText);q.hasClass("panel")?(s=q.get(0).className,h=q.attr("id"),q=q.get(0).innerHTML):(s=q.className,q=q.html());0<a("#"+h).length?k.updatePanel("#"+h,q):0<a("div.panel[data-crc='"+h+"']").length?(k.updatePanel(a("div.panel[data-crc='"+h+"']").get(0).id,q),h=a("div.panel[data-crc='"+h+"']").get(0).id):h=k.addContentDiv(h,l.responseText,f.title?
f.title:b,F,g)}else k.updatePanel("afui_ajax",l.responseText),a.query("#afui_ajax").attr("data-title",f.title?f.title:b),k.loadContent("#afui_ajax",e,c,d),n=!0;g=document.createElement("div");a(g).html(l.responseText);k.parseScriptTags(g);if(n)k.showLoading&&k.hideMask();else{if(s){n=s.split(" ");for(s=0;s<n.length;s++)"panel"!==n[s].trim()&&a("#"+h).addClass(n[s])}k.loadContent("#"+h,e,c,d);k.showLoading&&k.hideMask();return null}}else 4===l.readyState&&a.ui.hideMask()};this.ajaxUrl=b;var n=this.useAjaxCacheBuster?
b+(b.split("?")[1]?"&":"?")+"cache="+1E16*Math.random():b;l.open("GET",n,!0);l.setRequestHeader("X-Requested-With","XMLHttpRequest");l.send();this.showLoading&&this.showMask()}},runTransition:function(a,e,c,d){this.availableTransitions[a]||(a="default");"none"===e.style.display&&(e.style.display="block");"none"===c.style.display&&(c.style.display="block");this.availableTransitions[a].call(this,e,c,d)},launch:function(){if(!1===this.hasLaunched||this.launchCompleted)this.hasLaunched=!0;else{if(this.isLaunching)return!0;
this.isLaunching=!0;var b=this;this.viewportContainer=af.query("#afui");this.navbar=af.query("#navbar").get(0);this.content=af.query("#content").get(0);this.header=af.query("#header").get(0);this.menu=af.query("#menu").get(0);this.viewportContainer.on("click","a",function(a){b.useInternalRouting&&h(a,a.currentTarget)});var e=null;a.bind(a.touchLayer,"enter-edit",function(a){e=a});a.os.android&&(a.bind(a.touchLayer,"enter-edit-reshape",function(){var c=a(e),d=c.closest(b.activeDiv);if(d&&0<d.size())if(a.os.androidICS){var f=
b.scrollingDivs[b.activeDiv.id],g=f.scrollTop;f.scrollBy({x:0,y:(c.offset().top-d.offset().top+g)/2})}else if(a.os.android||a.os.blackberry)f=c.offset(),d=d.offset(),f.bottom>d.bottom&&f.height<d.height&&b.scrollingDivs[b.activeDiv.id].scrollToItem(c,"bottom")}),a.bind(a.touchLayer,"exit-edit-reshape",function(){b.activeDiv&&(b.activeDiv.id&&b.scrollingDivs.hasOwnProperty(b.activeDiv.id))&&b.scrollingDivs[b.activeDiv.id].setPaddings(0,0)}));this.navbar||(this.navbar=a.create("div",{id:"navbar"}).get(0),
this.viewportContainer.append(this.navbar));this.header||(this.header=a.create("div",{id:"header"}).get(0),this.viewportContainer.prepend(this.header));this.content||(this.content=a.create("div",{id:"content"}).get(0),a(this.content).insertAfter(this.header));this.menu||(this.menu=a.create("div",{id:"menu",html:"<div id='menu_scroller'></div>"}).get(0),this.viewportContainer.append(this.menu),this.menu.style.overflow="hidden",this.scrollingDivs.menu_scroller=a.query("#menu_scroller").scroller({scrollBars:!0,
verticalScroll:!0,vScrollCSS:"afScrollbar",useJsScroll:!a.feat.nativeTouchScroll,autoEnable:!0,lockBounce:this.lockPageBounce,hasParent:!0}),a.feat.nativeTouchScroll&&a.query("#menu_scroller").css("height","100%"),this.asideMenu=a.create("div",{id:"aside_menu",html:"<div id='aside_menu_scroller'></div>"}).get(0),this.viewportContainer.append(this.asideMenu),this.asideMenu.style.overflow="hidden",this.scrollingDivs.aside_menu_scroller=a.query("#aside_menu_scroller").scroller({scrollBars:!0,verticalScroll:!0,
vScrollCSS:"afScrollbar",useJsScroll:!a.feat.nativeTouchScroll,autoEnable:!0,lockBounce:this.lockPageBounce,hasParent:!0}),a.feat.nativeTouchScroll&&a.query("#aside_menu_scroller").css("height","100%"));a(this.header).html("<a class='backButton button'></a> <h1 id='pageTitle'></h1>"+this.header.innerHTML);this.backButton=a.query("#header .backButton").css("visibility","hidden");a(document).on("click","#header .backButton",function(a){a.preventDefault();b.goBack()});this.titlebar=a.query("#header #pageTitle").get(0);
this.addContentDiv("afui_ajax","");var c=a.create("div",{id:"afui_mask",className:"ui-loader",html:"<span class='ui-icon ui-icon-loading spin'></span><h1>Loading Content</h1>"}).css({"z-index":2E4,display:"none"});document.body.appendChild(c.get(0));c=a.create("div",{id:"afui_modal"}).get(0);a(c).hide();c.appendChild(a.create("div",{id:"modalHeader",className:"header"}).get(0));c.appendChild(a.create("div",{id:"modalContainer"}).get(0));c.appendChild(a.create("div",{id:"modalFooter",className:"footer"}).get(0));
this.modalTransContainer=a.create("div",{id:"modalTransContainer"}).appendTo(c).get(0);this.viewportContainer.append(c);this.scrollingDivs.modal_container=a.query("#modalContainer").scroller({scrollBars:!0,vertical:!0,vScrollCSS:"afScrollbar",lockBounce:this.lockPageBounce});this.modalWindow=c;for(var d={},c=this.viewportContainer.get(0).querySelectorAll(".panel"),f=0;f<c.length;f++){var g=c[f],n=g,y=g.previousSibling;g.parentNode&&"content"!==g.parentNode.id?(n.getAttribute("selected")&&(this.firstDiv=
g),this.addDivAndScroll(n),a.query("#content").append(g)):g.parsedContent||(g.parsedContent=1,n.getAttribute("selected")&&(this.firstDiv=g),this.addDivAndScroll(g),a(g).insertAfter(y));g.getAttribute("data-defer")&&(d[g.id]=g.getAttribute("data-defer"));this.firstDiv||(this.firstDiv=g);g=null}var c=null,u=!1,E=Object.keys(d).length,c=function(c){a.ajax({url:intel.xdk.webRoot+d[c],success:function(d){0<d.length&&(b.updatePanel(c,d),b.parseScriptTags(a.query("#"+c).get(0)));z++;z>=E&&(u=!1,a(document).trigger("defer:loaded"))},
error:function(){console.log("Error with deferred load "+intel.xdk.webRoot+d[c]);z++;z>=E&&(u=!1,a(document).trigger("defer:loaded"))}})};if(0<E){var u=!0,z=0,s;for(s in d)c(s)}if(this.firstDiv)if(this.activeDiv=this.firstDiv,this.scrollingDivs[this.activeDiv.id]&&this.scrollingDivs[this.activeDiv.id].enable(),s=function(){a.query("#navbar").append(a.create("footer",{id:"defaultNav"}).append(a.query("#navbar").children()));b.defaultFooter="defaultNav";b.prevFooter=a.query("#defaultNav");b.updateNavbarElements(b.prevFooter);
var c=a.query("nav").get(0);c&&(b.defaultMenu=a(c),b.updateSideMenuElements(b.defaultMenu),b.prevMenu=b.defaultMenu);if(c=a.query("aside").get(0))b.defaultAside=a(c),b.updateAsideElements(b.defaultAside),b.prevAsideMenu=b.defaultAside;b.defaultHeader="defaultHeader";a.query("#header").append(a.create("header",{id:"defaultHeader"}).append(a.query("#header").children()));b.prevHeader=a.query("#defaultHeader");a.query("#header").addClass("header");a.query("#navbar").addClass("footer");a.query("#navbar").on("click",
"footer>a:not(.button)",function(b){a.query("#navbar>footer>a").not(b.currentTarget).removeClass("pressed");a(b.currentTarget).addClass("pressed")});0<a.query("nav").length&&(c=b.splitview?" splitview":"",a.query("#afui #header").addClass("hasMenu"+c),a.query("#afui #content").addClass("hasMenu"+c),a.query("#afui #navbar").addClass("hasMenu"+c),a.query("#afui #menu").addClass("hasMenu"+c),a.query("#afui #aside_menu").addClass(c));0<a.query("aside").length&&a.query("#afui #header, #afui #content, #afui #navbar").addClass("hasAside");
a.query("#afui #menu").addClass("tabletMenu");a.ui.splitview&&window.innerWidth>parseInt(a.ui.handheldMinWidth,10)&&(a.ui.sideMenuWidth=a("#menu").css("width")+"px");var c=b.getPanelId(l),d=null!==c&&c==="#"+b.firstDiv.id;0<c.length&&b.loadDefaultHash&&!d?b.loadContent(l,!0,!1,"none"):(k="#"+b.firstDiv.id,b.firstDiv.style.display="block",b.parsePanelFunctions(b.firstDiv),b.loadContentData(b.firstDiv),a.query("#header .backButton").css("visibility","hidden"),("true"===b.firstDiv.getAttribute("data-modal")||
"true"===b.firstDiv.getAttribute("modal"))&&b.showModal(b.firstDiv.id));b.launchCompleted=!0;a.query("#afui #splashscreen").remove();a.os.fennec?a(document).trigger("afui:ready"):setTimeout(function(){a(document).trigger("afui:ready")})},u)a(document).one("defer:loaded",s);else s();else setTimeout(function(){a(document).trigger("afui:ready")});a.bind(b,"content-loaded",function(){if(0<b.loadContentQueue.length){var a=b.loadContentQueue.splice(0,1)[0];b.loadContent(a[0],a[1],a[2],a[3],a[4])}});(window.navigator.standalone||
this.isIntel)&&this.blockPageScroll();this.enableTabBar();this.topClickScroll()}},topClickScroll:function(){var a=this;document.getElementById("header").addEventListener("click",function(e){15>=e.clientY&&"h1"===e.target.nodeName.toLowerCase()&&a.scrollingDivs[a.activeDiv.id].scrollToTop("100")})},blockPageScroll:function(){a.query("#afui #header").bind("touchmove",function(a){a.preventDefault()})},noTransition:function(a,e){e.style.display="block";a.style.display="block";this.clearAnimations(e);
this.css3animate(a,{x:"0%",y:0});this.finishTransition(a);e.style.zIndex=2;a.style.zIndex=1},finishTransition:function(b,e){b.style.display="none";this.doingTransition=!1;b&&a(b).trigger("unloadpanelcomplete");e&&a(e).trigger("loadpanelcomplete");e&&this.clearAnimations(e);b&&this.clearAnimations(b);a.trigger(this,"content-loaded")},clearAnimations:function(b){b.style[a.feat.cssPrefix+"Transform"]="none";b.style[a.feat.cssPrefix+"Transition"]="none"}};var h=function(b,e){var c=document.getElementById("afui");
if(e!==c){if("a"!==e.tagName.toLowerCase()&&e.parentNode)return h(b,e.parentNode);if("undefined"!==e.tagName&&"a"===e.tagName.toLowerCase()){if(!1!==("function"===typeof a.ui.customClickHandler?a.ui.customClickHandler:!1)&&a.ui.customClickHandler(e,b))return b.preventDefault();if(!(-1!==e.href.toLowerCase().indexOf("javascript:")||e.getAttribute("data-ignore")))if(-1===e.hash.indexOf("#")&&0<e.target.length)0!==e.href.toLowerCase().indexOf("javascript:")&&(a.ui.isIntel?(b.preventDefault(),intel.xdk.device.launchExternal(e.href)):
