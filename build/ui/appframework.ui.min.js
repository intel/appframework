...
e.contentType&&(e.headers["Content-Type"]=e.contentType);for(var l in e.headers)"string"===typeof e.headers[l]&&d.setRequestHeader(l,e.headers[l]);if(!1===e.beforeSend.call(k,d,e))return d.abort(),!1;0<e.timeout&&(s=setTimeout(function(){d.onreadystatechange=b;d.abort();e.error.call(k,d,"timeout")},e.timeout));d.send(e.data)}catch(m){f.resolve(k,d,"error",m),e.error.call(k,d,"error",m)}return d};n.get=function(a,c){return this.ajax({url:a,success:c})};n.post=function(a,c,b,d){n.isFunction(c)&&(b=
c,c={});"string"===typeof b&&(d=b,b=function(){});d===q&&(d="html");return this.ajax({url:a,type:"POST",data:c,dataType:d,success:b})};n.getJSON=function(a,c,b,d){"function"===typeof c&&(b=c,c={},d=b);return this.ajax({url:a,data:c,success:b,error:d,dataType:"json"})};n.getScript=function(a,c){if(/^([\w-]+:)?\/\/([^\/]+)/.test(a)){var b=n.Deferred(),d=n.create("script",{async:!0,src:a}).get(0);d.onload=function(){c&&c();b.resolve.call(this,"success");n(this).remove()};d.onerror=function(){n(this).remove();
b.reject.call(this,"success")};r.head.appendChild(d);return b.promise}return this.ajax({url:a,success:c,dataType:"script"})};n.param=function(a,c){var b=[];if(a instanceof w)a.each(function(){b.push((c?c+"["+this.id+"]":this.id)+"="+encodeURIComponent(this.value))});else for(var d in a)if(!n.isFunction(a[d])){var e=c?c+"["+d+"]":d,f=a[d];b.push(n.isObject(f)?n.param(f,e):e+"="+encodeURIComponent(f))}return b.join("&")};n.parseJSON=function(a){return JSON.parse(a)};n.parseXML=function(a){if(B)MSApp.execUnsafeLocalFunction(function(){return(new DOMParser).parseFromString(a,
...
n.trigger=function(a,c,b){if(a){var d=!0;if(!a.__events)return d;n.isArray(c)||(c=[c]);n.isArray(b)||(b=[]);for(var e=0;e<c.length;e++)if(a.__events[c[e]])for(var f=a.__events[c[e]].slice(0),g=0;g<f.length;g++)n.isFunction(f[g])&&!1===f[g].apply(a,b)&&(d=!1);return d}};n.unbind=function(a,c,b){if(a.__events)if(c==q)delete a.__events;else{n.isArray(c)||(c=[c]);for(var d=0;d<c.length;d++)if(a.__events[c[d]])for(var e=a.__events[c[d]],f=0;f<e.length;f++)if(b==q&&delete e[f],e[f]===b){e.splice(f,1);break}}};
n.proxy=function(a,c,b){return function(){return b?a.apply(c,b):a.apply(c,arguments)}};var W=function(a,c){for(var b=0;b<a.length;b++)v(a[b],c)};n.cleanUpContent=function(a,c,b){if(a){var d=a.childNodes;d&&0<d.length&&n.asap(W,{},[K.apply(d,[0]),b]);c&&u(a,b)}};var H=[],M=[],N=[];n.asap=function(c,b,d){if(!n.isFunction(c))throw"$.asap - argument is not a valid function";H.push(c);M.push(b?b:{});N.push(d?d:[]);a.postMessage("afm-asap","*")};a.addEventListener("message",function(c){c.source===a&&"afm-asap"===
c.data&&(c.stopPropagation(),0<H.length&&H.shift().apply(M.shift(),N.shift()))},!0);var O={};n.parseJS=function(c){if(c){if("string"===typeof c){var b=r.createElement("div");B?MSApp.execUnsafeLocalFunction(function(){b.innerHTML=c}):b.innerHTML=c;c=b}var d=c.getElementsByTagName("script");c=null;for(var e=0;e<d.length;e++)if(0<d[e].src.length&&!O[d[e].src]&&!B){var f=r.createElement("script");f.type=d[e].type;f.src=d[e].src;r.getElementsByTagName("head")[0].appendChild(f);O[d[e].src]=1;f=null}else a.eval(d[e].innerHTML)}};
"click keydown keyup keypress submit load resize change select error".split(" ").forEach(function(a){n.fn[a]=function(c){return c?this.bind(a,c):this.trigger(a)}});["focus","blur"].forEach(function(a){n.fn[a]=function(c){if(0!==this.length){if(c)this.bind(a,c);else for(c=0;c<this.length;c++)try{this[c][a]()}catch(b){}return this}}});n.Deferred=function(){return{reject:function(){},resolve:function(){},promise:{then:function(){},fail:function(){}}}};return n}(window);window.jq=af;"$"in window||(window.$=
...
this,!1);this.el.removeEventListener("touchend",this,!1);this.infiniteEndCheck=!0;this.infinite&&(!this.infiniteTriggered&&this.el.scrollTop>=this.el.scrollHeight-this.el.clientHeight)&&(this.infiniteTriggered=!0,a.trigger(this,"infinite-scroll"),this.infiniteEndCheck=!0);this.touchEndFired=!0;var f=this,e=this.el.scrollTop,g=this.el.scrollLeft,k=0;clearInterval(f.nativePolling);f.nativePolling=setInterval(function(){k++;25===k&&f.initScrollProgress&&(a.trigger(f,"scroll",[{x:-f.el.scrollLeft+f.cX,
y:-f.el.scrollTop+f.cY}]),a.trigger(a.touchLayer,"scroll",[{x:-f.el.scrollLeft+f.cX,y:-f.el.scrollTop+f.cY}]));if(200<=k)clearInterval(f.nativePolling),f.initScrollProgress&&(a.trigger(f,"scroll",[{x:-f.el.scrollLeft,y:-f.el.scrollTop}]),a.trigger(a.touchLayer,"scroll",[{x:-f.el.scrollLeft,y:-f.el.scrollTop}]));else if(f.el.scrollTop!==e||f.el.scrollLeft!==g)clearInterval(f.nativePolling),a.trigger(a.touchLayer,"scrollend",[f.el]),a.trigger(f,"scrollend",[f.el]),f.initScrollProgress&&(a.trigger(f,
"scroll",[{x:-f.el.scrollLeft,y:-f.el.scrollTop}]),a.trigger(a.touchLayer,"scroll",[{x:-f.el.scrollLeft,y:-f.el.scrollTop}]))},20)};b.prototype.hideRefresh=function(c){if(!this.preventHideRefresh){var b=this,f=function(c){b.refreshContainer.style.top="-60px";b.refreshContainer.style.position="absolute";b.dY=b.cY=0;c||(b.el.style[a.feat.cssPrefix+"Transform"]="none",b.el.style[a.feat.cssPrefix+"TransitionProperty"]="none",b.el.scrollTop=0,b.logPos(b.el.scrollLeft,0),b.refreshRunning=!1,b.setRefreshContent("Pull to Refresh"),
a.trigger(b,"refresh-finish"))};!1===c||!b.afEl.css3Animate?f():b.afEl.css3Animate({y:b.el.scrollTop-b.refreshHeight+"px",x:"0%",time:"325ms",complete:f});this.refreshTriggered=!1}};b.prototype.hideScrollbars=function(){};b.prototype.scrollTo=function(a,b){this.logPos(a.x,a.y);a.x*=-1;a.y*=-1;return this._scrollTo(a,b)};b.prototype.scrollBy=function(a,b){a.x+=this.el.scrollLeft;a.y+=this.el.scrollTop;this.logPos(this.el.scrollLeft,this.el.scrollTop);return this._scrollTo(a,b)};b.prototype.scrollToBottom=
...
this.refreshCancelCB=null),this.scrollingFinishCB&&(clearTimeout(this.scrollingFinishCB),this.scrollingFinishCB=null),!(1!==b.touches.length||this.boolScrollLock)&&!(b.touches[0].target&&void 0!==b.touches[0].target.type&&"select"===b.touches[0].target.tagName.toLowerCase()))){var d={top:0,left:0,speedY:0,speedX:0,absSpeedY:0,absSpeedX:0,deltaY:0,deltaX:0,absDeltaY:0,absDeltaX:0,y:0,x:0,duration:0};this.elementInfo={};var f=this.getViewportSize();this.elementInfo.bottomMargin=f.h;this.elementInfo.maxTop=
...
!1):0>d.top&&(this.preventPullToRefresh=!0,this.refresh&&(this.refreshContainer.style.overflow="hidden"));this.saveEventInfo(b);if(!1===this.isScrolling&&(this.isScrolling=!0,this.onScrollStart))this.onScrollStart();b=this.getCSSMatrix(this.el);this.lastScrollInfo.top=numOnly(b.f);this.lastScrollInfo.left=numOnly(b.e);this.recalculateDeltaY(this.lastScrollInfo);this.recalculateDeltaX(this.lastScrollInfo);this.checkYboundary(this.lastScrollInfo);this.elementInfo.hasHorScroll&&this.checkXboundary(this.lastScrollInfo);
b=0<this.lastScrollInfo.y&&0<this.lastScrollInfo.deltaY;var f=this.lastScrollInfo.y<-this.elementInfo.maxTop&&0>this.lastScrollInfo.deltaY,e;if(b||f)d=b?this.lastScrollInfo.y:-this.lastScrollInfo.y-this.elementInfo.maxTop,d=(this.container.clientHeight-d)/this.container.clientHeight,0.5>d&&(d=0.5),e=0,b&&0<this.lastScrollInfo.top||f&&this.lastScrollInfo.top<-this.elementInfo.maxTop?e=this.lastScrollInfo.top:f&&(e=-this.elementInfo.maxTop),f=this.lastScrollInfo.deltaY*d,1>Math.abs(this.lastScrollInfo.deltaY*
d)&&(f=b?1:-1),this.lastScrollInfo.y=e+f;if(this.elementInfo.hasHorScroll&&(b=0<this.lastScrollInfo.x&&0<this.lastScrollInfo.deltaX,f=this.lastScrollInfo.x<-this.elementInfo.maxLeft&&0>this.lastScrollInfo.deltaX,b||f))d=b?this.lastScrollInfo.x:-this.lastScrollInfo.x-this.elementInfo.maxLeft,d=(this.container.clientWidth-d)/this.container.clientWidth,0.5>d&&(d=0.5),e=0,b&&0<this.lastScrollInfo.left||f&&this.lastScrollInfo.left<-this.elementInfo.maxLeft?e=this.lastScrollInfo.left:f&&(e=-this.elementInfo.maxLeft),
f=this.lastScrollInfo.deltaX*d,1>Math.abs(this.lastScrollInfo.deltaX*d)&&(f=b?1:-1),this.lastScrollInfo.x=e+f;this.lockBounce&&!this.refresh&&(0<this.lastScrollInfo.x?this.lastScrollInfo.x=0:-1*this.lastScrollInfo.x>this.elementInfo.maxLeft&&(this.lastScrollInfo.x=-1*this.elementInfo.maxLeft),0<this.lastScrollInfo.y?this.lastScrollInfo.y=0:-1*this.lastScrollInfo.y>this.elementInfo.maxTop&&(this.lastScrollInfo.y=-1*this.elementInfo.maxTop));this.scrollerMoveCSS(this.lastScrollInfo,0);this.setVScrollBar(this.lastScrollInfo,
...
this.el.clientHeight-this.container.clientHeight&&(this.infiniteTriggered=!0,a.trigger(this,"infinite-scroll"))}};h.prototype.calculateMovement=function(a,b){var f={top:0,left:0,speedY:0,speedX:0,absSpeedY:0,absSpeedX:0,deltaY:0,deltaX:0,absDeltaY:0,absDeltaX:0,y:0,x:0,duration:0},e=b?this.firstEventInfo:this.lastEventInfo,g=b?a.pageX:a.touches[0].pageX,k=b?a.pageY:a.touches[0].pageY,h=b?a.time:a.timeStamp;f.deltaY=this.elementInfo.hasVertScroll?k-e.pageY:0;f.deltaX=this.elementInfo.hasHorScroll?
g-e.pageX:0;f.time=h;f.duration=h-e.time;return f};h.prototype.calculateTarget=function(a){a.y=this.lastScrollInfo.y+a.deltaY;a.x=this.lastScrollInfo.x+a.deltaX;0<Math.abs(a.deltaY)&&(a.y+=(0<a.deltaY?1:-1)*this.elementInfo.divHeight*this.androidPerfHack);0<Math.abs(a.deltaX)&&(a.x+=(0<a.deltaX?1:-1)*this.elementInfo.divWidth*this.androidPerfHack)};h.prototype.checkYboundary=function(a){var b=this.container.clientHeight/2,f=this.elementInfo.maxTop+b;if(a.y>b)a.y=b;else if(-a.y>f)a.y=-f;else return;
this.recalculateDeltaY(a)};h.prototype.checkXboundary=function(a){var b=this.container.clientWidth/2,f=this.elementInfo.maxLeft+b;if(a.x>b)a.x=b;else if(-a.x>f)a.x=-f;else return;this.recalculateDeltaX(a)};h.prototype.recalculateDeltaY=function(a){var b=Math.abs(a.deltaY);a.deltaY=a.y-a.top;var f=Math.abs(a.deltaY);a.duration=a.duration*f/b};h.prototype.recalculateDeltaX=function(a){var b=Math.abs(a.deltaX);a.deltaX=a.x-a.left;var f=Math.abs(a.deltaX);a.duration=a.duration*f/b};h.prototype.hideRefresh=
function(b){var d=this;if(!this.preventHideRefresh){var f=function(){d.setRefreshContent("Pull to Refresh");a.trigger(d,"refresh-finish")};this.scrollerMoveCSS({x:0,y:0},325);!1===b||!d.afEl.css3Animate?f():d.afEl.css3Animate({time:"325ms",complete:f});this.refreshTriggered=!1}};h.prototype.setMomentum=function(a){a.speedY=this.divide(a.deltaY,a.duration);a.speedX=this.divide(a.deltaX,a.duration);a.absSpeedY=Math.abs(a.speedY);a.absSpeedX=Math.abs(a.speedX);a.absDeltaY=Math.abs(a.deltaY);a.absDeltaX=
...
this.checkXboundary(b);d=!this.preventPullToRefresh&&(b.top>this.refreshHeight||b.y>this.refreshHeight);this.fireRefreshRelease(d,0<b.top);if(this.refresh&&d)b.y=this.refreshHeight,b.duration=325;else if(0<=b.y)b.y=0,0<=b.top&&(b.duration=325);else if(-b.y>this.elementInfo.maxTop||0===this.elementInfo.maxTop)b.y=-this.elementInfo.maxTop,-b.top>this.elementInfo.maxTop&&(b.duration=325);if(this.elementInfo.hasHorScroll)if(0<=b.x)b.x=0,0<=b.left&&this.refresh&&(b.duration=325);else if(-b.x>this.elementInfo.maxLeft||
...
"Perspective"]=1E3,this.vscrollBar.style[a.feat.cssPrefix+"BackfaceVisibility"]="hidden");this.hscrollBar&&(this.hscrollBar.style[a.feat.cssPrefix+"Perspective"]=1E3,this.hscrollBar.style[a.feat.cssPrefix+"BackfaceVisibility"]="hidden")}};h.prototype.scrollerMoveCSS=function(b,d,f){d||(d=0);f||(f="linear");d=numOnly(d);var e=this;this.el&&this.el.style&&(this.eventsActive&&(this.androidFormsMode?(this.el.style.marginTop=Math.round(b.y)+"px",this.el.style.marginLeft=Math.round(b.x)+"px"):(d={x:b.x,
y:b.y,duration:d,easing:"easeOutSine"},e.initScrollProgress&&(d.update=function(b){a.trigger(e,"scroll",[b]);a.trigger(a.touchLayer,"scroll",[b])}),a(this.el).animateCss(d).start())),this.logPos(b.x,b.y))};h.prototype.logPos=function(a,b){var f;f=this.elementInfo?{h:this.elementInfo.bottomMargin,w:this.elementInfo.rightMargin}:this.getViewportSize();this.loggedPcentX=this.divide(a,this.el.clientWidth-f.w);this.loggedPcentY=this.divide(b,this.el.clientHeight-f.h);this.scrollTop=b;this.scrollLeft=a};
h.prototype.scrollbarMoveCSS=function(b,d,f,e){f||(f=0);b&&b.style&&(this.androidFormsMode?(b.style.marginTop=Math.round(d.y)+"px",b.style.marginLeft=Math.round(d.x)+"px"):a(b).animateCss({x:d.x,y:d.y,duration:f,easing:"easeOutSine"}).start())};h.prototype.scrollTo=function(a,b){b||(b=0);this.scrollerMoveCSS(a,b)};h.prototype.scrollBy=function(a,b){var f=this.getCSSMatrix(this.el),e=numOnly(f.f),f=numOnly(f.e);this.scrollTo({y:e-a.y,x:f-a.x},b)};h.prototype.scrollToBottom=function(a){this.scrollTo({y:-1*
(this.el.clientHeight-this.container.clientHeight),x:0},a)};h.prototype.scrollToTop=function(a){this.scrollTo({x:0,y:0},a)};return function(c,d){var f;if(!l&&a.touchLayer&&a.isObject(a.touchLayer))p();else if(!a.touchLayer||!a.isObject(a.touchLayer))a.touchLayer={};if(f="string"===typeof c||c instanceof String?document.getElementById(c):c){var g=a(f);d.hasParent&&(g=g.parent());g.hasClass("x-scroll")&&(d.horizontalScroll=!0);g.hasClass("y-scroll")&&(d.verticalScroll=!0);return a.os.desktop?new e(f,
d):d.useJsScroll?new h(f,d):new b(f,d)}window.alert("Could not find element for scroller "+c)}}()})(af);
...
this.fireReshapeEvent("orientationchange"):this.previewReshapeEvent("orientationchange");a.os.android&&a.os.chrome&&(this.layer.style.height="100%")},onResize:function(){this.ignoreNextResize_?this.ignoreNextResize_=!1:this.launchFixUI()&&this.reshapeAction()},onClick:function(b){var c=b.target&&void 0!==b.target.tagName?b.target.tagName.toLowerCase():"";if(-1!==p.indexOf(c)&&(!this.isFocused_||b.target!==this.focusedElement)){c=b.target&&void 0!==b.target.type?b.target.type.toLowerCase():"";if(-1===
...
b},goBack:function(a){if(a=Math.min(Math.abs(~~a||1),this.history.length))a=this.history.splice(-a).shift(),this.loadContent(a.target+"",0,1,a.transition),this.transitionType=a.transition,this.updateHash(a.target)},clearHistory:function(){this.history=[];this.setBackButtonVisibility(!1)},pushHistory:function(b,e,c,d){this.history.push({target:b,transition:c});try{this.manageHistory&&(window.history.pushState(e,e,p+"#"+e+d),a(window).trigger("hashchange",null,{newUrl:p+"#"+e+d,oldUrl:p+b}))}catch(f){}},
updateHash:function(b){if(this.manageHistory){l=b=-1===b.indexOf("#")?"#"+b:b;var e=window.location.hash,c=this.getPanelId(b).substring(1);try{window.history.replaceState(c,c,p+b),a(window).trigger("hashchange",null,{newUrl:p+b,oldUrl:p+e})}catch(d){}}},getPanelId:function(a){var e=a.indexOf("/");return-1===e?a:a.substring(0,e)},updateBadge:function(b,e,c,d){void 0===c&&(c="");b=a(b);var f=b.find("span.af-badge");0===f.length?("absolute"!==b.css("position")&&b.css("position","relative"),f=a.create("span",
...
window.innerWidth>=a.ui.handheldMinWidth)){var f=this,g=a.query("#menu"),h=a.query("#aside_menu"),k=a.query("#content,  #header, #navbar"),l=a.query(".afui_panel_mask");c=c||this.transitionTime;var m=this.isSideMenuOn(),p=d?"-"+numOnly(h.css("width")):numOnly(g.css("width"));0===l.length&&window.innerWidth<a.ui.handheldMinWidth&&(k.append("<div class='afui_panel_mask'></div>"),l=a.query(".afui_panel_mask"),a(".afui_panel_mask").bind("click",function(){a.ui.toggleSideMenu(!1,null,null,d)}));var u=
this.getSideMenuPosition();m&&!d&&0>u?m=!1:m&&(d&&0<u)&&(m=!1);if(2===b||!m&&(void 0!==b&&!1!==b||void 0===b))this.togglingSideMenu=!0,d?h.show():g.show(),f.css3animate(k,{x:p,time:c,complete:function(b){f.togglingSideMenu=!1;k.vendorCss("Transition","");e&&e(b);0!==l.length&&window.innerWidth<a.ui.handheldMinWidth&&l.show()}});else if(void 0===b||void 0!==b&&!1===b)this.togglingSideMenu=!0,f.css3animate(k,{x:"0px",time:c,complete:function(b){k.vendorCss("Transition","");k.vendorCss("Transform","");
...
t)a(document).one("defer:loaded",u);else u();else setTimeout(function(){a(document).trigger("afui:ready")});a.bind(b,"content-loaded",function(){if(0<b.loadContentQueue.length){var a=b.loadContentQueue.splice(0,1)[0];b.loadContent(a[0],a[1],a[2],a[3],a[4])}});(window.navigator.standalone||this.isIntel)&&this.blockPageScroll();this.enableTabBar();this.topClickScroll()}},topClickScroll:function(){var a=this;document.getElementById("header").addEventListener("click",function(e){15>=e.clientY&&"h1"===
...
(function(a){var p=function(){a.ui.isIntel=!0;setTimeout(function(){document.getElementById("afui").style.height="100%";document.body.style.height="100%";document.documentElement.style.minHeight=window.innerHeight},30);document.removeEventListener("intel.xdk.device.ready",p)};document.addEventListener("intel.xdk.device.ready",p);a.feat.nativeTouchScroll&&document.addEventListener("orientationchange",function(){if(a.ui.scrollingDivs[a.ui.activeDiv.id]){var m=a.ui.scrollingDivs[a.ui.activeDiv.id];m&&
...
(function(a){a.availableTransitions.pop=function(p,m,l){var g=this;l?(m.style.zIndex=1,p.style.zIndex=2,g.clearAnimations(m),g.css3animate(p,{x:"0%",time:a.transitionTime,opacity:0.1,scale:0.2,origin:"50% 50%",complete:function(a){a?g.finishTransition(p):(g.css3animate(p,{x:"-100%",opacity:1,complete:function(){g.finishTransition(p)}}),m.style.zIndex=2,p.style.zIndex=1)}})):(p.style.zIndex=1,m.style.zIndex=2,g.css3animate(m,{x:"0%",scale:0.2,origin:"50% 50%",opacity:0.1,time:"0ms",complete:function(){g.css3animate(m,
