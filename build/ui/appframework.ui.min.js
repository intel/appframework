...
(b=c,c={});d===q&&(d="html");return this.ajax({url:a,type:"POST",data:c,dataType:d,success:b})};n.getJSON=function(a,c,b,d){"function"===typeof c&&(b=c,c={},d=b);return this.ajax({url:a,data:c,success:b,error:d,dataType:"json"})};n.getScript=function(a,c){if(/^([\w-]+:)?\/\/([^\/]+)/.test(a)){var b=n.Deferred(),d=n.create("script",{async:!0,src:a}).get(0);d.onload=function(){c&&c();b.resolve.call(this,"success");n(this).remove()};d.onerror=function(){n(this).remove();b.reject.call(this,"success")};
r.head.appendChild(d);return b.promise}return this.ajax({url:a,success:c,dataType:"script"})};n.param=function(a,c){var b=[];if(a instanceof w)a.each(function(){b.push((c?c+"["+this.id+"]":this.id)+"="+encodeURIComponent(this.value))});else for(var d in a)if(!n.isFunction(a[d])){var e=c?c+"["+d+"]":d,f=a[d];b.push(n.isObject(f)?n.param(f,e):e+"="+encodeURIComponent(f))}return b.join("&")};n.parseJSON=function(a){return JSON.parse(a)};n.parseXML=function(a){if(B)MSApp.execUnsafeLocalFunction(function(){return(new DOMParser).parseFromString(a,
