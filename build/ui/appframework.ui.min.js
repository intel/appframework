...
if(!1===this.isScrolling&&(this.isScrolling=!0,this.onScrollStart))this.onScrollStart();b=this.getCSSMatrix(this.el);this.lastScrollInfo.top=numOnly(b.f);this.lastScrollInfo.left=numOnly(b.e);this.recalculateDeltaY(this.lastScrollInfo);this.recalculateDeltaX(this.lastScrollInfo);this.checkYboundary(this.lastScrollInfo);this.elementInfo.hasHorScroll&&this.checkXboundary(this.lastScrollInfo);b=0<this.lastScrollInfo.y&&0<this.lastScrollInfo.deltaY;var f=this.lastScrollInfo.y<-this.elementInfo.maxTop&&
0>this.lastScrollInfo.deltaY,e;if(b||f)d=b?this.lastScrollInfo.y:-this.lastScrollInfo.y-this.elementInfo.maxTop,d=(this.container.clientHeight-d)/this.container.clientHeight,0.5>d&&(d=0.5),e=0,b&&0<this.lastScrollInfo.top||f&&this.lastScrollInfo.top<-this.elementInfo.maxTop?e=this.lastScrollInfo.top:f&&(e=-this.elementInfo.maxTop),f=this.lastScrollInfo.deltaY*d,1>Math.abs(this.lastScrollInfo.deltaY*d)&&(f=b?1:-1),this.lastScrollInfo.y=e+f;if(this.elementInfo.hasHorScroll&&(b=0<this.lastScrollInfo.x&&
0<this.lastScrollInfo.deltaX,f=this.lastScrollInfo.x<-this.elementInfo.maxLeft&&0>this.lastScrollInfo.deltaX,b||f))d=b?this.lastScrollInfo.x:-this.lastScrollInfo.x-this.elementInfo.maxLeft,d=(this.container.clientWidth-d)/this.container.clientWidth,0.5>d&&(d=0.5),e=0,b&&0<this.lastScrollInfo.left||f&&this.lastScrollInfo.left<-this.elementInfo.maxLeft?e=this.lastScrollInfo.left:f&&(e=-this.elementInfo.maxLeft),f=this.lastScrollInfo.deltaX*d,1>Math.abs(this.lastScrollInfo.deltaX*d)&&(f=b?1:-1),this.lastScrollInfo.x=
e+f;this.lockBounce&&!this.refresh&&(0<this.lastScrollInfo.x?this.lastScrollInfo.x=0:-1*this.lastScrollInfo.x>this.elementInfo.maxLeft&&(this.lastScrollInfo.x=-1*this.elementInfo.maxLeft),0<this.lastScrollInfo.y?this.lastScrollInfo.y=0:-1*this.lastScrollInfo.y>this.elementInfo.maxTop&&(this.lastScrollInfo.y=-1*this.elementInfo.maxTop));this.scrollerMoveCSS(this.lastScrollInfo,0);this.setVScrollBar(this.lastScrollInfo,0,0);this.setHScrollBar(this.lastScrollInfo,0,0);this.refresh&&!this.preventPullToRefresh&&
...
"infinite-scroll"))}};h.prototype.calculateMovement=function(a,b){var f={top:0,left:0,speedY:0,speedX:0,absSpeedY:0,absSpeedX:0,deltaY:0,deltaX:0,absDeltaY:0,absDeltaX:0,y:0,x:0,duration:0},e=b?this.firstEventInfo:this.lastEventInfo,g=b?a.pageX:a.touches[0].pageX,k=b?a.pageY:a.touches[0].pageY,h=b?a.time:a.timeStamp;f.deltaY=this.elementInfo.hasVertScroll?k-e.pageY:0;f.deltaX=this.elementInfo.hasHorScroll?g-e.pageX:0;f.time=h;f.duration=h-e.time;return f};h.prototype.calculateTarget=function(a){a.y=
