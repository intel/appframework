...
!1),_updateViewportOrientation(window.orientation))};_updateViewportContent=function(a){var b;b=document.getElementsByTagName("head");if(b.length>0){b=b[0];for(var c=document.getElementsByTagName("meta"),d=0;d<c.length;d++)if(c[d].name=="viewport")try{b.removeChild(c[d])}catch(f){}c=document.createElement("meta");c.setAttribute("name","viewport");c.setAttribute("id","viewport");c.setAttribute("content",a);b.appendChild(c)}};_updateViewportOrientation=function(a){_updateViewportContent("width="+(a==
0||a==180?_viewport.portraitWidth:_viewport.landscapeWidth)+",maximum-scale=10.0,user-scalable=no")};(function(a,b){a.os={};a.os.webkit=b.match(/WebKit\/([\d.]+)/)?!0:!1;a.os.android=b.match(/(Android)\s+([\d.]+)/)?!0:!1;a.os.ipad=b.match(/(iPad).*OS\s([\d_]+)/)?!0:!1;a.os.iphone=!a.os.ipad&&b.match(/(iPhone\sOS)\s([\d_]+)/)?!0:!1;a.os.webos=b.match(/(webOS|hpwOS)[\s\/]([\d.]+)/)?!0:!1;a.os.touchpad=a.os.webos&&b.match(/TouchPad/)?!0:!1;a.os.ios=a.os.ipad||a.os.iphone})(d,navigator.userAgent);return d}();
"$"in window||(window.$=jq);
