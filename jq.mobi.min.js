...
1){for(var c in a)this[c]=a[c];return this}else t.call(arguments,1).forEach(function(b){for(var c in b)a[c]=b[c]});return a};d.isArray=function(a){return Array.isArray(a)};d.isFunction=function(a){return typeof a==="function"};d.isObject=function(a){return typeof a==="object"};d.fn=k.prototype={constructor:k,forEach:i.forEach,reduce:i.reduce,push:i.push,indexOf:i.indexOf,concat:i.concat,selector:function(a,c){var b;try{if(a[0]==="#"&&a.indexOf(" ")===-1&&a.indexOf(">")===-1)b=c==g?c.getElementById(a.replace("#",
"")):[].slice.call(c.querySelectorAll(a));else if(a[0]==="<"&&a[a.length-1]===">"){var e=g.createElement("div");e.innerHTML=a;b=[].slice.call(e.childNodes)}else b=[].slice.call(c.querySelectorAll(a))}catch(d){}return b},oldElement:f,slice:i.slice,setupOld:function(a){if(a==f)return d();a.oldElement=this;return a},map:function(a){return d.map(this,function(c,b){return a.call(c,b,c)})},each:function(a){this.forEach(function(c,b){a.call(c,b,c)});return this},ready:function(a){(g.readyState==="complete"||
...
this[b];e.parentNode&&d(a,e.parentNode).indexOf(e)==-1&&c.push(e)}return this.setupOld(d(m(c)))},data:function(a,c){return this.attr("data-"+a,c)},end:function(){return this.oldElement!=f?this.oldElement:d()},clone:function(a){if(this.length==0)return f;return this[0].cloneNode(a)},size:function(){return this.length}};var s={type:"GET",beforeSend:l,success:l,error:l,complete:l,context:f,timeout:0};d.jsonP=function(a){var c="jsonp_callback"+ ++v,b="",e=g.createElement("script");j[c]=function(f){clearTimeout(b);
