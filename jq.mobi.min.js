...
return this[0].nodeType==this[0].DOCUMENT_NODE?this[0].documentElement.offsetheight:(a=this.css("height").replace("px",""))?a:this.offset().height},width:function(){if(this.length===0)return this;if(val==f)return this.css("width",val);if(this[0]==this[0].window)return g.innerWidth;if(this[0].nodeType==this[0].DOCUMENT_NODE)return this[0].documentElement.offsetwidth;else{var a=this.css("width").replace("px","");return a?a:this.offset().width}},parent:function(a,c){if(this.length==0)return this;for(var b=
[],d=0;d<this.length;d++)for(var f=this[d];f.parentNode&&f.parentNode!=h;){b.push(f.parentNode);if(f.parentNode)f=f.parentNode;if(!c)break}return this.setupOld(e(q(b)).filter(a))},parents:function(a){return this.parent(a,!0)},children:function(a){if(this.length==0)return this;for(var c=[],b=0;b<this.length;b++)c=c.concat(z(this[b].firstChild));return this.setupOld(e(c).filter(a))},siblings:function(a){if(this.length==0)return this;for(var c=[],b=0;b<this.length;b++)this[b].parentNode&&(c=c.concat(z(this[b].parentNode.firstChild,
this[b])));return this.setupOld(e(c).filter(a))},closest:function(a,c){if(this.length==0)return this;var b=this[0],d=e(a,c);if(d.length==0)return e();for(;b&&d.indexOf(b)==-1;)b=b!==c&&b!==h&&b.parentNode;return e(b)},filter:function(a){if(this.length==0)return this;if(a==f)return this;for(var c=[],b=0;b<this.length;b++){var d=this[b];d.parentNode&&e(a,d.parentNode).indexOf(d)>=0&&c.push(d)}return this.setupOld(e(q(c)))},not:function(a){if(this.length==0)return this;for(var c=[],b=0;b<this.length;b++){var d=
