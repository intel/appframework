...
"")):[].slice.call(c.querySelectorAll(a));else if(a[0]==="<"&&a[a.length-1]===">"){var e=g.createElement("div");e.innerHTML=a.trim();b=[].slice.call(e.childNodes)}else b=[].slice.call(c.querySelectorAll(a))}catch(d){}return b},oldElement:f,slice:i.slice,setupOld:function(a){if(a==f)return d();a.oldElement=this;return a},map:function(a){return d.map(this,function(c,b){return a.call(c,b,c)})},each:function(a){this.forEach(function(c,b){a.call(c,b,c)});return this},ready:function(a){(g.readyState===
...
this[b];e.parentNode&&d(a,e.parentNode).indexOf(e)==-1&&c.push(e)}return this.setupOld(d(m(c)))},data:function(a,c){return this.attr("data-"+a,c)},end:function(){return this.oldElement!=f?this.oldElement:d()},clone:function(a){if(this.length==0)return f;for(var c=[],b=0;b<this.length;b++)c.push(this[b].cloneNode(a));return d(c)},size:function(){return this.length}};var s={type:"GET",beforeSend:l,success:l,error:l,complete:l,context:f,timeout:0};d.jsonP=function(a){var c="jsonp_callback"+ ++v,b="",
e=g.createElement("script");j[c]=function(f){clearTimeout(b);d(e).remove();delete j[c];a.success.call(void 0,f)};e.src=a.url.replace(/=\?/,"="+c);d("head").append(e);a.timeout>0&&(b=setTimeout(function(){a.error.call(void 0,"","timeout")},a.timeout));return{}};d.ajax=function(a){var c;try{c=new j.XMLHttpRequest;var b=a||{},e;for(e in s)b[e]||(b[e]=s[e]);if(!b.url)b.url=j.location;if(!b.contentType)b.contentType="application/x-www-form-urlencoded";if(!b.headers)b.headers={};b.headers=d.extend({"X-Requested-With":"XMLHttpRequest"},
