var jq=function(){function n(a){return a in l?l[a]:l[a]=RegExp("(^|\\s)"+a+"(\\s|$)")}function j(a,b){return b===void 0?d(a):d(a).filter(b)}function f(){}var g=[],m=g.slice,l=[],k=[],p=1,q=1,d=function(a,b){return new i(a,b)},i=function(a,b){this.length=0;if(a)if(a instanceof i)return a;else if(typeof a=="function")return d(document).ready(a);else if(typeof a=="object")return this[this.length++]=a,this;else if(b!==void 0){if(b instanceof i)return d(b).find(a)}else b=document;else return this;if(dom=
...
!1)break;return a};d.extend=function(a){if(a==null||typeof a==="undefined")a=this;if(arguments.length==1){for(key in a)this[key]=a[key];return this}else m.call(arguments,1).forEach(function(b){for(key in b)a[key]=b[key]});return a};d.isArray=function(a){return Array.isArray(a)};d.isFunction=function(a){return typeof a=="function"};d.fn=i.prototype={constructor:i,forEach:g.forEach,reduce:g.reduce,push:g.push,indexOf:g.indexOf,concat:g.concat,selector:function(a,b){var c;try{if(a[0]=="#"&&a.indexOf(" ")==
...
(c?" ":"")+e.join(" ")}return this},removeClass:function(a){for(var b=0;b<this.length;b++){if(a===void 0){this[b].className="";break}var c=this[b].className;a.split(/\s+/g).forEach(function(a){c=c.replace(n(a),"")});c.length>0?this[b].className=c.trim():c=""}return this},hasClass:function(a,b){if(this.length==0)return!1;b||(b=this[0]);return n(a).test(b.className)},bind:function(a,b){if(!(a==""||a==null)){for(var c=0;c<this.length;c++)(function(c){var d=c._eventID?c._eventID:p++;c._eventID=d;a.split(/\s+/g).forEach(function(a){var f=
function(a){a.originalEvent=a;var d=b.call(c,a);d===!1&&a.preventDefault();return d};k[d+"_"+a]=f;c.addEventListener(a,f,!1)})})(this[c]);return this}},unbind:function(a){if(!(a==""||a==null)){for(var b=0;b<this.length;b++)(function(b){var d=b._eventID;a.split(/s+g/).forEach(function(a){if(k[d+"_"+a]){var f=k[d+"_"+a];delete k[d+"_"+a];b.removeEventListener(a,f,!1)}})})(this[b]);return this}},trigger:function(a,b){if(this.length==0)return this;if(typeof a=="string"){var c=a,a=document.createEvent("Event");
...
b){var c=this[0],e=d(b||document,a);for(e.length||(c=null);c&&e.indexOf(c)<0;)c=c!==b&&c!==document&&c.parentNode;return d(c)},parents:function(a){for(var b=[],c=this;c.length>0;)c=d.map(c,function(a){if((a=a.parentNode)&&a!==document&&b.indexOf(a)<0)return b.push(a),a});return j(b,a)},parent:function(a){return j(uniq(this.pluck("parentNode")),a)},children:function(a){return j(this.map(function(){return m.call(this.children)}),a)},siblings:function(a){return j(this.map(function(a,c){return m.call(c.parentNode.children).filter(function(a){return a!==
c})}),a)}};"filter,find,closest,parents,parent,children,siblings".split(",").forEach(function(a){var b=d.fn[a];d.fn[a]=function(){var a=b.apply(this,arguments);a.prevObject=this;return a}});var o={type:"GET",beforeSend:f,success:f,error:f,complete:f,context:null,timeout:0};d.jsonP=function(a){var b="jsonp_callback"+ ++q,c="",e=document.createElement("script");abort=function(){d(e).remove();window[b]&&(window[b]=f)};window[b]=function(h){clearTimeout(c);d(e).remove();delete window[b];a.success.call(void 0,
h)};e.src=a.url.replace(/=\?/,"="+b);d("head").append(e);a.timeout>0&&(c=setTimeout(function(){xhr.abort();a.error.call(void 0,xhr,"timeout")},a.timeout));return{}};d.ajax=function(a){try{var b=new window.XMLHttpRequest;settings=a||{};for(key in o)settings[key]||(settings[key]=o[key]);if(!settings.url)settings.url=window.location;if(!settings.contentType)settings.contentType="application/x-www-form-urlencoded";if(!settings.headers)settings.headers={};settings.headers=d.extend({"X-Requested-With":"XMLHttpRequest"},
...
b.match(/(iPhone\sOS)\s([\d_]+)/)?!0:!1;a.os.webos=b.match(/(webOS|hpwOS)[\s\/]([\d.]+)/)?!0:!1;a.os.touchpad=a.os.webos&&b.match(/TouchPad/)?!0:!1;a.os.ios=a.os.ipad||a.os.iphone;a.os.blackberry=b.match(/BlackBerry/)||b.match(/PlayBook/)?!0:!1;a.os.opera=b.match(/Opera/)?!0:!1;a.os.fennec=b.match(/fennec/)?!0:!1})(d,navigator.userAgent);if(typeof String.prototype.trim!=="function")String.prototype.trim=function(){return this.replace(/^\s+|\s+$/,"")};return d}();"$"in window||(window.$=jq);
