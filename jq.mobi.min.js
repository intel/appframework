...
a.os.android||a.os.blackberry||a.os.opera||a.os.fennec||a.os.supportsTouch);a.feat={};a.feat.nativeTouchScroll=a.os.ios?!c.match(/OS\s[1-4]/):!1}function r(a){return a._jqmid||(a._jqmid=J++)}function K(a,c,b,d){c=B(c);if(c.ns)var e=RegExp("(?:^| )"+c.ns.replace(" "," .* ?")+"(?: |$)");return(j[r(a)]||[]).filter(function(a){return a&&(!c.e||a.e==c.e)&&(!c.ns||e.test(a.ns))&&(!b||a.fn==b||typeof a.fn==="function"&&typeof b==="function"&&""+a.fn===""+b)&&(!d||a.sel==d)})}function B(a){a=(""+a).split(".");
return{e:a[0],ns:a.slice(1).sort().join(" ")}}function C(a,c,b){e.isObject(a)?e.each(a,b):a.split(/\s/).forEach(function(a){b(a,c)})}function s(a,c,b,d,i){var f=r(a),g=j[f]||(j[f]=[]);C(c,b,function(b,c){var f=i&&i(c,b),l=f||c,h=function(b){var c=l.apply(a,[b].concat(b.data));c===!1&&b.preventDefault();return c},f=e.extend(B(b),{fn:c,proxy:h,sel:d,del:f,i:g.length});g.push(f);a.addEventListener(f.e,h,!1)})}function t(a,c,b,d){var e=r(a);C(c||"",b,function(b,c){K(a,b,c,d).forEach(function(b){delete j[e][b.i];
a.removeEventListener(b.e,b.proxy,!1)})})}function L(a){var c=e.extend({originalEvent:a},a);e.each(M,function(b,d){c[b]=function(){this[d]=N;return a[b].apply(a,arguments)};c[d]=O});return c}function D(a,c){if(c&&a.dispatchEvent){var b=e.Event("destroy",{bubbles:!1});a.dispatchEvent(b)}if((b=r(a))&&j[b]){for(var d in j[b])a.removeEventListener(j[b][d].e,j[b][d].proxy,!1);delete j[b]}}function E(a,c){if(a){var b=a.childNodes;if(b&&b.length>0)for(var d in b)E(b[d],c);D(a,c)}}var f,h=g.document,n=[],
F=n.slice,v=[],P=1,Q=/^\s*<(\w+)[^>]*>/,k={},o={},m=function(a,c){this.length=0;if(a)if(a instanceof m&&c==f)return a;else if(e.isFunction(a))return e(h).ready(a);else if(e.isArray(a)&&a.length!=f){for(var b=0;b<a.length;b++)this[this.length++]=a[b];return this}else if(e.isObject(a)&&e.isObject(c)){if(a.length==f)a.parentNode==c&&(this[this.length++]=a);else for(b=0;b<a.length;b++)a[b].parentNode==c&&(this[this.length++]=a[b]);return this}else if(e.isObject(a)&&c==f)return this[this.length++]=a,this;
else if(c!==f){if(c instanceof m)return c.find(a)}else c=h;else return this;if(b=this.selector(a,c))if(e.isArray(b))for(var d=0;d<b.length;d++)this[this.length++]=b[d];else this[this.length++]=b;return this},e=function(a,c){return new m(a,c)};e.is$=function(a){return a instanceof m};e.map=function(a,c){var b,d=[],i;if(e.isArray(a))for(i=0;i<a.length;i++)b=c(a[i],i),b!==f&&d.push(b);else if(e.isObject(a))for(i in a)a.hasOwnProperty(i)&&(b=c(a[i],i),b!==f&&d.push(b));return e([d])};e.each=function(a,
c){var b;if(e.isArray(a))for(b=0;b<a.length;b++){if(c(b,a[b])===!1)break}else if(e.isObject(a))for(b in a)if(a.hasOwnProperty(b)&&c(b,a[b])===!1)break;return a};e.extend=function(a){a==f&&(a=this);if(arguments.length===1){for(var c in a)this[c]=a[c];return this}else F.call(arguments,1).forEach(function(b){for(var c in b)a[c]=b[c]});return a};e.isArray=function(a){return a instanceof Array&&a.push!=f};e.isFunction=function(a){return typeof a==="function"};e.isObject=function(a){return typeof a==="object"};
e.fn=m.prototype={constructor:m,forEach:n.forEach,reduce:n.reduce,push:n.push,indexOf:n.indexOf,concat:n.concat,selector:function(a,c){var b,a=a.trim();a[0]==="#"&&a.indexOf(" ")===-1&&a.indexOf(">")===-1?b=c==h?c.getElementById(a.replace("#","")):[].slice.call(z(a,c)):a[0]==="<"&&a[a.length-1]===">"?(b=h.createElement("div"),b.innerHTML=a.trim(),b=[].slice.call(b.childNodes)):b=[].slice.call(z(a,c));return b},oldElement:f,slice:n.slice,setupOld:function(a){if(a==f)return e();a.oldElement=this;return a},
map:function(a){return e.map(this,function(c,b){return a.call(c,b,c)})},each:function(a){this.forEach(function(c,b){a.call(c,b,c)});return this},ready:function(a){(h.readyState==="complete"||h.readyState==="loaded")&&a();h.addEventListener("DOMContentLoaded",a,!1);return this},find:function(a){if(this.length===0)return f;for(var c=[],b,d=0;d<this.length;d++){b=e(a,this[d]);for(var i=0;i<b.length;i++)c.push(b[i])}return e(q(c))},html:function(a,c){if(this.length===0)return f;if(a===f)return this[0].innerHTML;
...
c;return this},empty:function(){for(var a=0;a<this.length;a++)e.cleanUpContent(this[a],!1,!0),this[a].innerHTML="";return this},hide:function(){if(this.length===0)return this;for(var a=0;a<this.length;a++)if(this.css("display",null,this[a])!="none")this[a].setAttribute("jqmOldStyle",this.css("display",null,this[a])),this[a].style.display="none";return this},show:function(){if(this.length===0)return this;for(var a=0;a<this.length;a++)if(this.css("display",null,this[a])=="none")this[a].style.display=
...
val:function(a){if(this.length===0)return f;if(a==f)return this[0].value;for(var c=0;c<this.length;c++)this[c].value=a;return this},attr:function(a,c){if(this.length===0)return f;if(c===f&&!e.isObject(a))return this[0].jqmCacheId&&k[this[0].jqmCacheId][a]?this[0].jqmCacheId&&k[this[0].jqmCacheId][a]:this[0].getAttribute(a);for(var b=0;b<this.length;b++)if(e.isObject(a))for(var d in a)e(this[b]).attr(d,a[d]);else if(e.isArray(c)||e.isObject(c)||e.isFunction(c)){if(!this[b].jqmCacheId)this[b].jqmCacheId=
